! function(t, e, n) {
        ...
        return e = e || Error,
            function() {
                ...
                for (n = o + a.replace(/\{\d+\}/g, function(t) {
                        var e = +t.slice(1, -1);
                        return e + 2 < s.length ? pt(s[e + 2]) : t
                    }), n = n + "\nhttp://errors.angularjs.org/1.3.15/" + (t ? t + "/" : "") + i, r = 2; r < arguments.length; r++) n = n + (2 == r ? "?" : "&") + "p" + (r - 2) + "=" + encodeURIComponent(pt(arguments[r]));
                return new e(n)
            }
    }
    ...
    function i(t) {
        ...
        var e = t.length;
        return !(t.nodeType !== $r || !e) || (b(t) || pr(t) || 0 === e || "number" == typeof e && e > 0 && e - 1 in t)
    }
    ...
    function R(t, e, n, r) {
        if (T(t) || E(t)) throw lr("cpws", "Can't copy! Making copies of Window or Scope instances is not supported.");
        if (e) {
            ...
            if (pr(t)) {
                ...
                for (var u in t) t.hasOwnProperty(u) && (a = R(t[u], null, n, r), $(t[u]) && (n.push(t[u]), r.push(a)), e[u] = a);
                c(e, l)
            }
        } else if (e = t, t)
            if (pr(t)) e = R(t, [], n, r);
    ...
    function L(t, e) {
        ...
        if (a == s && "object" == a) {
            if (!pr(t)) {
                if (x(t)) return !!x(e) && L(t.getTime(), e.getTime());
                if (C(t)) return !!C(e) && t.toString() == e.toString();
                if (E(t) || E(e) || T(t) || T(e) || pr(e) || x(e) || C(e)) return !1;
                o = {};
                for (i in t)
                    if ("$" !== i.charAt(0) && !k(t[i])) {
                ...
                for (i in e)
                    if (!o.hasOwnProperty(i) && "$" !== i.charAt(0) && e[i] !== n && !k(e[i])) return !1;
                return !0
            }
            if (!pr(e)) return !1;
    ...
    function V(t, r) {
        var i = r;
        return "string" == typeof t && "$" === t.charAt(0) && "$" === t.charAt(1) ? i = n : T(r) ? i = "$WINDOW" : r && e === r ? i = "$DOCUMENT" : E(r) && (i = "$SCOPE"), i
    }

    function U(t, e) {
        return "undefined" == typeof t ? n : (w(e) || (e = e ? 2 : null), JSON.stringify(t, V, e))
    }
    ...
    function W(t) {
        ...
        var e = er("<div>").append(t).html();
        try {
            return t[0].nodeType === br ? Xn(e) : e.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(t, e) {
                return "<" + Xn(e)
            })
        } catch (t) {
            return Xn(e)
    ...
    function J(t, e) {
        var n, r, i = gr.length;
        for (t = er(t), r = 0; r < i; ++r)
            if (n = gr[r] + e, b(n = t.attr(n))) return n;
        return null
    }
    ...
    function Z(n, r, i) {
        ...
        return t && l.test(t.name) && (i.debugInfoEnabled = !0, t.name = t.name.replace(l, "")), t && !u.test(t.name) ? s() : (t.name = t.name.replace(u, ""), ur.resumeBootstrap = function(t) {
            return o(t, function(t) {
                r.push(t)
            }), s()
        }, void(k(ur.resumeDeferredBootstrap) && ur.resumeDeferredBootstrap()))
    }
    ...
    function rt() {
        ...
        yr || (nr = t.jQuery, nr && nr.fn.on ? (er = nr, f(nr.fn, {
            scope: Lr.scope,
            isolateScope: Lr.isolateScope,
            controller: Lr.controller,
            injector: Lr.injector,
            inheritedData: Lr.inheritedData
    ...
    function ot(t, e, n) {
        return n && pr(t) && (t = t[t.length - 1]), it(k(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), t
    }
            ...
            return function(r, o, a) {
                ...
                return s(r, "module"), o && t.hasOwnProperty(r) && (t[r] = null), e(t, r, function() {
                    function t(t, n, r, i) {
                        return i || (i = e),
                            function() {
                                return i[r || "push"]([t, n, arguments]), u
                            }
                    }
    ...
    function dt(e) {
        ...
        try {
            ...
            rr("ngLocale", []).provider("$locale", ge)
        }
        rr("ng", ["ngLocale"], ["$provide", function(t) {
            t.provider({
                ...
                ngInclude: uo
            }).directive(Oi).directive(oo), t.provider({
                $anchorScroll: Wt,
                $animate: Gr,
                $browser: Gt,
                $cacheFactory: Xt,
    ...
    function yt(t, e) {
        var n, r, i, a, s = e.createDocumentFragment(),
            l = [];
        if (gt(t)) l.push(e.createTextNode(t));
        else {
            for (n = n || s.appendChild(e.createElement("div")), r = (Ir.exec(t) || ["", ""])[1].toLowerCase(), i = Pr[r] || Pr._default, n.innerHTML = i[1] + t.replace(Rr, "<$1></$2>") + i[2], a = i[0]; a--;) n = n.lastChild;
            l = F(l, n.childNodes), n = s.firstChild, n.textContent = ""
        }
        return s.textContent = "", s.innerHTML = "", o(l, function(t) {
            s.appendChild(t)
        }), s
    }
    ...
    function $t(t, n) {
        n = n || e;
        var r;
        return (r = Nr.exec(t)) ? [n.createElement(r[1])] : (r = yt(t, n)) ? r.childNodes : []
    }

    function bt(t) {
        if (t instanceof bt) return t;
        var e;
        if (b(t) && (t = dr(t), e = !0), !(this instanceof bt)) {
    ...
    function kt(t, e, n, r) {
        if (y(r)) throw Mr("offargs", "jqLite#off() does not support the `selector` argument");
        var i = Tt(t),
            a = i && i.events,
            s = i && i.handle;
        if (s)
            if (e) o(e.split(" "), function(e) {
                ...
                for (e in a) "$destroy" !== e && _r(t, e, s), delete a[e]
    }
    ...
    function Ct(t, e) {
        ...
        if (i) {
            ...
            i.handle && (i.events.$destroy && i.handle({}, "$destroy"), kt(t)), delete Tr[r], t.ng339 = n
        }
    }
    ...
    function Tt(t, e) {
        var r = t.ng339,
            i = r && Tr[r];
        return e && !i && (t.ng339 = r = ht(), i = Tr[r] = {
            events: {},
            data: {},
            handle: n
        }), i
    ...
    function Ut(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e) throw b(n) && n || (n = t.name || Vt(t)), zr("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                    i = t.toString().replace(Wr, ""), a = i.match(Vr), o(a[1].split(Ur), function(t) {
    ...
    function Bt(t, e) {
        function r(t) {
            return function(e, n) {
                return $(e) ? void o(e, l(t)) : t(e, n)
            }
        }

        function i(t, e) {
            if (at(t, "service"), (k(e) || pr(e)) && (e = E.instantiate(e)), !e.$get) throw zr("pget", "Provider '{0}' must define $get factory method.", t);
            return T[t + w] = e
        }
        ...
        function a(t, e) {
            return function() {
                ...
                if (v(n)) throw zr("undef", "Provider '{0}' must return a value from $get factory method.", t);
                return n
            }
        }
        ...
        function d(t) {
            ...
            return o(t, function(t) {
                ...
                if (!C.get(t)) {
                    C.put(t, !0);
                    try {
                        b(t) ? (e = rr(t), n = n.concat(d(e.requires)).concat(e._runBlocks), r(e._invokeQueue), r(e._configBlocks)) : k(t) ? n.push(E.invoke(t)) : pr(t) ? n.push(E.invoke(t)) : ot(t, "module")
                    } catch (e) {
        ...
        function m(t, n) {
            function r(e, r) {
                if (t.hasOwnProperty(e)) {
                    if (t[e] === y) throw zr("cdep", "Circular dependency found: {0}", e + " <- " + x.join(" <- "));
                    return t[e]
                }
                try {
                    return x.unshift(e), t[e] = y, t[e] = n(e, r)
                } catch (n) {
                    throw t[e] === y && delete t[e], n
                } finally {
                    x.shift()
                }
            }
            ...
            function i(t, n, i, o) {
                ...
                for (s = 0, a = c.length; s < a; s++) {
                    if (l = c[s], "string" != typeof l) throw zr("itkn", "Incorrect injection token! Expected service name as string, got {0}", l);
                    u.push(i && i.hasOwnProperty(l) ? i[l] : r(l, o))
                }
                return pr(t) && (t = t[a]), t.apply(n, u)
            }
        ...
        var y = {},
            ...
            E = T.$injector = m(T, function(t, e) {
                throw ur.isString(e) && x.push(e), zr("unpr", "Unknown provider: {0}", x.join(" <- "))
            }),
            S = {},
            _ = S.$injector = m(S, function(t, e) {
                var r = E.get(t + w, e);
                return _.invoke(r.$get, r, n, t)
            });
    ...
    function Yt(t, e, r, i) {
        ...
        function f() {
            _ = c(), _ = v(_) ? null : _, L(_, I) && (_ = I), I = _
        }

        function p() {
            D === m.url() && A === _ || (D = m.url(), A = _, o(N, function(t) {
                t(m.url(), _)
            }))
        }
        ...
        m.addPollFn = function(t) {
            return v(E) && l(100, w), S.push(t), t
        };
        var _, A, D = y.href,
            O = e.find("base"),
            M = null;
        f(), A = _, m.url = function(e, n, r) {
            if (v(r) && (r = null), y !== t.location && (y = t.location), $ !== t.history && ($ = t.history), e) {
                var o = A === r;
                if (D === e && (!i.history || o)) return m;
                var a = D && we(D) === we(e);
                return D = e, A = r, !i.history || a && o ? (a || (M = e), n ? y.replace(e) : a ? y.hash = s(e) : y.href = e) : ($[n ? "replaceState" : "pushState"](r, "", e), f(), A = _), m
            }
            return M || y.href.replace(/%27/g, "'")
        }, m.state = function() {
            return _
        };
        var N = [],
        ...
        m.onUrlChange = function(e) {
            return j || (i.history && er(t).on("popstate", u), er(t).on("hashchange", u), j = !0), N.push(e), e
        ...
        m.cookies = function(t, e) {
            ...
            if (!t) {
                if (g.cookie !== P)
                    for (P = g.cookie, o = P.split("; "), R = {}, s = 0; s < o.length; s++) a = o[s], l = a.indexOf("="), l > 0 && (t = d(a.substring(0, l)), R[t] === n && (R[t] = d(a.substring(l + 1))));
                return R
            }
            e === n ? g.cookie = encodeURIComponent(t) + "=;path=" + F + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(e) && (i = (g.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + ";path=" + F).length + 1, i > 4096 && r.warn("Cookie '" + t + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"))
            ...
            return !!k[t] && (delete k[t], x(t), a(h), !0)
        }
    }
            ...
            function t(t, n) {
                ...
                return e[t] = {
                    put: function(t, e) {
                        ...
                        if (!v(e)) return t in l || a++, l[t] = e, a > u && this.remove(d.key), e
                    },
                    get: function(t) {
                        if (u < Number.MAX_VALUE) {
                            var e = c[t];
                    ...
                    destroy: function() {
                        l = null, s = null, c = null, delete e[t]
                    },
                    info: function() {
                        return f({}, s, {
                            size: a
    ...
    function Jt(t, r) {
        ...
        this.directive = function e(n, r) {
            return at(n, "directive"), b(n) ? (it(r, "directiveFactory"), a.hasOwnProperty(n) || (a[n] = [], t.factory(n + s, ["$injector", "$exceptionHandler", function(t, e) {
                var r = [];
                return o(a[n], function(o, a) {
                    try {
                        ...
                        k(s) ? s = {
                            compile: g(s)
                        } : !s.compile && s.link && (s.compile = g(s.link)), s.priority = s.priority || 0, s.index = a, s.name = s.name || n, s.require = s.require || s.controller && s.name, s.restrict = s.restrict || "EA", $(s.scope) && (s.$$isolateBindings = i(s.scope, s.name)), r.push(s)
                    } catch (t) {
                        e(t)
                    }
                }), r
            }])), a[n].push(r)) : o(n, l(e)), this
        ...
        this.debugInfoEnabled = function(t) {
        ...
        }, this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(t, r, i, l, g, y, C, T, S, _, A) {
            function D(t, e) {
                try {
                    t.addClass(e)
                } catch (t) {}
            ...
            function O(t, e, n, r, i) {
                ...
                return function(e, n, r) {
                    ...
                    var u;
                    if (u = "html" !== s ? er(Q(s, er("<div>").append(t).html())) : n ? Lr.clone.call(t) : t, o)
                        for (var c in o) u.data("$" + c + "Controller", o[c].instance);
                    return O.$$addScopeInfo(u, e), n && n(u, e), a && a(e, u, u, i), u
                }
            }
            ...
            function N(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    var a, s, l, u, c, f, p, d, g;
                    if (h) {
                        var v = r.length;
                        for (g = new Array(v), c = 0; c < m.length; c += 3) p = m[c], g[p] = r[p]
                    } else g = r;
                    for (c = 0, f = m.length; c < f;) l = g[m[c++]], a = m[c++], s = m[c++], a ? (a.scope ? (u = t.$new(), O.$$addScopeInfo(er(l), u)) : u = t, d = a.transcludeOnThisElement ? R(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? R(t, e) : null, a(s, u, l, i, d)) : s && s(t, l.childNodes, n, o)
                }
                for (var l, u, c, f, p, d, h, m = [], g = 0; g < t.length; g++) l = new at, u = P(t[g], [], l, 0 === g ? i : n, o), c = u.length ? V(u, t[g], l, e, r, null, [], [], a) : null, c && c.scope && O.$$addScopeClass(l.$$element), p = c && c.terminal || !(f = t[g].childNodes) || !f.length ? null : N(f, c ? (c.transcludeOnThisElement || !c.templateOnThisElement) && c.transclude : e), (c || p) && (m.push(g, c, p), d = !0, h = h || c), a = null;
                return d ? s : null
            }
            ...
            function P(t, e, n, r, i) {
                ...
                switch (s) {
                    case $r:
                        B(e, Qt(j(t)), "E", r, i);
                        for (var f, p, d, h, m, g, v = t.attributes, y = 0, w = v && v.length; y < w; y++) {
                            var x = !1,
                                k = !1;
                            f = v[y], p = f.name, m = dr(f.value), h = Qt(p), (g = ft.test(h)) && (p = p.replace(Kr, "").substr(8).replace(/_(.)/g, function(t, e) {
                                return e.toUpperCase()
                            }));
                            var C = h.replace(/(Start|End)$/, "");
                            z(C) && h === C + "Start" && (x = p, k = p.substr(0, p.length - 5) + "end", p = p.substr(0, p.length - 6)), d = Qt(p.toLowerCase()), l[d] = p, !g && n.hasOwnProperty(d) || (n[d] = m, Rt(t, d) && (n[d] = !0)), tt(t, e, m, d, g), B(e, d, "A", r, i, x, k)
                        }
                        if (a = t.className, $(a) && (a = a.animVal), b(a) && "" !== a)
                            for (; o = c.exec(a);) d = Qt(o[2]), B(e, d, "C", r, i) && (n[d] = dr(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case br:
                        J(e, t.nodeValue);
                        break;
                    case wr:
                        try {
                            o = u.exec(t.nodeValue), o && (d = Qt(o[1]), B(e, d, "M", r, i) && (n[d] = dr(o[2])))
                        } catch (t) {}
                }
                return e.sort(X), e
            }
            ...
            function V(t, a, s, l, u, c, f, p, d) {
                function h(t, e, n, r) {
                    t && (n && (t = H(t, n, r)), t.require = T.require, t.directiveName = S, (j === T || T.$$isolateScope) && (t = rt(t, {
                        isolateScope: !0
                    })), f.push(t)), e && (n && (e = H(e, n, r)), e.require = T.require, e.directiveName = S, (j === T || T.$$isolateScope) && (e = rt(e, {
                        isolateScope: !0
                    })), p.push(e))
                }
                ...
                function m(t, e, n, r) {
                    var i, a, s = "data",
                        ...
                        u = n;
                    if (b(e)) {
                        if (a = e.match(v), e = e.substring(a[0].length), a[3] && (a[1] ? a[3] = null : a[1] = a[3]), "^" === a[1] ? s = "inheritedData" : "^^" === a[1] && (s = "inheritedData", u = n.parent()), "?" === a[2] && (l = !0), i = null, r && "data" === s && (i = r[e]) && (i = i.instance), i = i || u[s]("$" + e + "Controller"), !i && !l) throw Xr("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", e, t);
                        return i || null
                    }
                ...
                function w(t, e, i, l, u) {
                    function c(t, e, r) {
                        var i;
                        return E(t) || (r = e, e = t, t = n), z && (i = w), r || (r = z ? k.parent() : k), u(t, e, i, r, A)
                    }
                    var d, h, v, $, b, w, x, k, T;
                    if (a === i ? (T = s, k = s.$$element) : (k = er(i), T = new at(k, s)), j && (b = e.$new(!0)), u && (x = c, x.$$boundTransclude = u), N && (C = {}, w = {}, o(N, function(t) {
                            var n, r = {
                                $scope: t === j || t.$$isolateScope ? b : e,
                                $element: k,
                                $attrs: T,
                                $transclude: x
                            };
                            $ = t.controller, "@" == $ && ($ = T[t.name]), n = y($, r, !0, t.controllerAs), w[t.name] = n, z || k.data("$" + t.name + "Controller", n.instance), C[t.name] = n
                        })), j) {
                        O.$$addScopeInfo(k, b, !0, !(I && (I === j || I === j.$$originalDirective))), O.$$addScopeClass(k, !0);
                        var S = C && C[j.name],
                            _ = b;
                        S && S.identifier && j.bindToController === !0 && (_ = S.instance), o(b.$$isolateBindings = j.$$isolateBindings, function(t, n) {
                            var i, o, a, s, l = t.attrName,
                                u = t.optional,
                                c = t.mode;
                            switch (c) {
                                case "@":
                                    T.$observe(l, function(t) {
                                        _[n] = t
                                    }), T.$$observers[l].$$scope = e, T[l] && (_[n] = r(T[l])(e));
                                    break;
                                case "=":
                                    if (u && !T[l]) return;
                                    o = g(T[l]), s = o.literal ? L : function(t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function() {
                                        throw i = _[n] = o(e), Xr("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", T[l], j.name)
                                    }, i = _[n] = o(e);
                                    var f = function(t) {
                                        return s(t, _[n]) || (s(t, i) ? a(e, t = _[n]) : _[n] = t), i = t
                                    };
                                    f.$stateful = !0;
                                    var p;
                                    p = t.collection ? e.$watchCollection(T[l], f) : e.$watch(g(T[l], f), null, o.literal), b.$on("$destroy", p);
                                    break;
                                case "&":
                                    o = g(T[l]), _[n] = function(t) {
                                        return o(e, t)
                                    }
                            }
                        })
                    ...
                    for (C && (o(C, function(t) {
                            t()
                        }), C = null), d = 0, h = f.length; d < h; d++) v = f[d], ot(v, v.isolateScope ? b : e, k, T, v.require && m(v.directiveName, v.require, k, w), x);
                    var A = e;
                    for (j && (j.template || null === j.templateUrl) && (A = b), t && t(A, i.childNodes, n, u), d = p.length - 1; d >= 0; d--) v = p[d], ot(v, v.isolateScope ? b : e, k, T, v.require && m(v.directiveName, v.require, k, w), x)
                }
                d = d || {};
                for (var x, C, T, S, _, A, D, M = -Number.MAX_VALUE, N = d.controllerDirectives, j = d.newIsolateScopeDirective, I = d.templateDirective, R = d.nonTlbTranscludeDirective, V = !1, B = !1, z = d.hasElementTranscludeDirective, X = s.$$element = er(a), J = c, Z = l, tt = 0, nt = t.length; tt < nt; tt++) {
                    T = t[tt];
                    var it = T.$$start,
                        st = T.$$end;
                    if (it && (X = F(a, it, st)), _ = n, M > T.priority) break;
                    if ((D = T.scope) && (T.templateUrl || ($(D) ? (K("new/isolated scope", j || x, T, X), j = T) : K("new/isolated scope", j, T, X)), x = x || T), S = T.name, !T.templateUrl && T.controller && (D = T.controller, N = N || {}, K("'" + S + "' controller", N[S], T, X), N[S] = T), (D = T.transclude) && (V = !0, T.$$tlb || (K("transclusion", R, T, X), R = T), "element" == D ? (z = !0, M = T.priority, _ = X, X = s.$$element = er(e.createComment(" " + S + ": " + s[S] + " ")), a = X[0], et(u, q(_), a), Z = O(_, l, M, J && J.name, {
                            nonTlbTranscludeDirective: R
                        })) : (_ = er(wt(a)).contents(), X.empty(), Z = O(_, l))), T.template)
                        if (B = !0, K("template", I, T, X), I = T, D = k(T.template) ? T.template(X, s) : T.template, D = ct(D), T.replace) {
                            if (J = T, _ = gt(D) ? [] : te(Q(T.templateNamespace, dr(D))), a = _[0], 1 != _.length || a.nodeType !== $r) throw Xr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", S, "");
                            et(u, X, a);
                            var lt = {
                                    $attr: {}
                                },
                            ...
                            j && U(ut), t = t.concat(ut).concat(ft), Y(s, lt), nt = t.length
                        } else X.html(D);
                    if (T.templateUrl) B = !0, K("template", I, T, X), I = T, T.replace && (J = T), w = G(t.splice(tt, t.length - tt), X, s, u, V && Z, f, p, {
                        ...
                        A = T.compile(X, s, Z), k(A) ? h(null, A, it, st) : A && h(A.pre, A.post, it, st)
                    } catch (t) {
                        i(t, W(X))
                    }
                    T.terminal && (w.terminal = !0, M = Math.max(M, T.priority))
                }
                return w.scope = x && x.scope === !0, w.transcludeOnThisElement = V, w.elementTranscludeOnThisElement = z, w.templateOnThisElement = B, w.transclude = Z, d.hasElementTranscludeDirective = z, w
            }
            ...
            function B(e, r, o, l, u, c, f) {
                if (r === u) return null;
                var p = null;
                if (a.hasOwnProperty(r))
                    for (var h, m = t.get(r + s), g = 0, v = m.length; g < v; g++) try {
                        h = m[g], (l === n || l > h.priority) && h.restrict.indexOf(o) != -1 && (c && (h = d(h, {
                            $$start: c,
                            $$end: f
                        })), e.push(h), p = h)
                    } catch (t) {
            ...
            function G(t, e, n, r, i, a, s, u) {
                var c, f, p = [],
                    ...
                    v = k(m.templateUrl) ? m.templateUrl(e, n) : m.templateUrl,
                    y = m.templateNamespace;
                return e.empty(), l(S.getTrustedResourceUrl(v)).then(function(l) {
                        var d, b, w, x;
                        if (l = ct(l), m.replace) {
                            if (w = gt(l) ? [] : te(Q(y, dr(l))), d = w[0], 1 != w.length || d.nodeType !== $r) throw Xr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", m.name, v);
                            b = {
                                $attr: {}
                            }, et(r, e, d);
                            var k = P(d, [], b);
                            $(m.scope) && U(k), t = k.concat(t), Y(n, b)
                        } else d = h, e.html(l);
                        for (t.unshift(g), c = V(t, d, n, i, e, m, a, s, u), o(r, function(t, n) {
                                t == d && (r[n] = e[0])
                            ...
                            if (!C.$$destroyed) {
                                if (T !== h) {
                                    var A = T.className;
                                    u.hasElementTranscludeDirective && m.replace || (_ = wt(d)), et(E, er(T), _), D(er(_), A)
                                }
                                x = c.transcludeOnThisElement ? R(C, c.transclude, S) : S, c(f, C, _, r, x)
                            }
                        }
                        p = null
                    }),
                    function(t, e, n, r, i) {
                        var o = i;
                        e.$$destroyed || (p ? p.push(e, n, r, o) : (c.transcludeOnThisElement && (o = R(e, c.transclude, i)), c(f, e, n, r, o)))
                    }
            }
            ...
            function K(t, e, n, r) {
                if (e) throw Xr("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, W(r))
            }
            ...
            function tt(t, e, n, i, o) {
                ...
                var s = r(n, !0, a, o);
                if (s) {
                    if ("multiple" === i && "select" === j(t)) throw Xr("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", W(t));
                    e.push({
                        priority: 100,
                        compile: function() {
                            return {
                                pre: function(t, e, l) {
                                    ...
                                    var c = l[i];
                                    c !== n && (s = c && r(c, !0, a, o), n = c), s && (l[i] = s(t), (u[i] || (u[i] = [])).$$inter = !0, (l.$$observers && l.$$observers[i].$$scope || t).$watch(s, function(t, e) {
                                        "class" === i && t != e ? l.$updateClass(t, e) : l.$set(i, t)
                                    }))
                                }
                            }
                        }
            ...
            function et(t, n, r) {
                ...
                if (t)
                    for (i = 0, o = t.length; i < o; i++)
                        if (t[i] == a) {
                            t[i++] = r;
                            for (var u = i, c = u + s - 1, f = t.length; u < f; u++, c++) c < f ? t[u] = t[c] : delete t[u];
                            t.length -= s - 1, t.context === a && (t.context = r);
                            break
                        }
                l && l.replaceChild(r, a);
                var p = e.createDocumentFragment();
                p.appendChild(a), er(r).data(er(a).data()), nr ? (fr = !0, nr.cleanData([a])) : delete er.cache[a[er.expando]];
            ...
            at.prototype = {
                ...
                $set: function(t, e, r, a) {
                    var s, l = this.$$element[0],
                        ...
                        c = Pt(l, t),
                        f = t;
                    if (u ? (this.$$element.prop(t, e), a = u) : c && (this[c] = e, f = c), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = nt(t, "-"))), s = j(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t) this[t] = e = A(e, "src" === t);
                    else if ("img" === s && "srcset" === t) {
                        for (var p = "", d = dr(e), h = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, m = /\s/.test(d) ? h : /(,)/, g = d.split(m), v = Math.floor(g.length / 2), y = 0; y < v; y++) {
                            var $ = 2 * y;
                            p += A(dr(g[$]), !0), p += " " + dr(g[$ + 1])
                        }
                        var b = dr(g[2 * y]).split(/\s/);
                        p += A(dr(b[0]), !0), 2 === b.length && (p += " " + dr(b[1])), this[t] = e = p
                    }
            ...
            var st = r.startSymbol(),
                lt = r.endSymbol(),
                ct = "{{" == st || "}}" == lt ? m : function(t) {
                    return t.replace(/\{\{/g, st).replace(/}}/g, lt)
                },
                ft = /^ngAttr[A-Z]/;
            return O.$$addBindingInfo = x ? function(t, e) {
                var n = t.data("$binding") || [];
                pr(e) ? n = n.concat(e) : n.push(e), t.data("$binding", n)
            } : h, O.$$addBindingClass = x ? function(t) {
                D(t, "ng-binding")
            } : h, O.$$addScopeInfo = x ? function(t, e, n, r) {
                var i = n ? r ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope";
                t.data(i, e)
            } : h, O.$$addScopeClass = x ? function(t, e) {
    ...
    function ee() {
        ...
        this.register = function(e, n) {
            ...
            return function(r, l, u, c) {
                var p, d, h, m;
                if (u = u === !0, c && b(c) && (m = c), b(r)) {
                    if (d = r.match(i), !d) throw Jr("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
                    h = d[1], m = m || d[3], r = t.hasOwnProperty(h) ? t[h] : st(l.$scope, h, !0) || (e ? st(a, h, !0) : n), ot(r, h, !0)
                }
                if (u) {
                    var g = (pr(r) ? r[r.length - 1] : r).prototype;
                    return p = Object.create(g || null), m && s(l, m, p, h || r.name), f(function() {
                        return o.invoke(r, p, l, h), p
                    }, {
                        instance: p,
                        identifier: m
                    })
                }
                return p = o.instantiate(r, l, h), m && s(l, m, p, h || r.name), p
            }
        }]
    }
    ...
    function ce() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, l, u, c, p, d) {
            function h(e) {
                function i(t) {
                    var e = f({}, t);
                    return t.data ? e.data = le(t.data, t.headers, t.status, l.transformResponse) : e.data = t.data, ue(t.status) ? e : p.reject(e)
                }
                ...
                function s(e) {
                    ...
                    t: for (n in o) {
                        r = Xn(n);
                        for (i in s)
                            if (Xn(i) === r) continue t;
                        s[n] = o[n]
                    }
                    return a(s)
                }
                if (!ur.isObject(e)) throw r("$http")("badreq", "Http request configuration must be an object.  Received: {0}", e);
                var l = f({
                    method: "get",
                    transformRequest: t.transformRequest,
                    transformResponse: t.transformResponse
                }, e);
                l.headers = s(e), l.method = Jn(l.method);
                var u = function(e) {
                        var r = e.headers,
                            a = le(e.data, se(r), n, e.transformRequest);
            ...
            function w(r, i) {
                function o(t, n, r, i) {
                    ...
                    d && (ue(t) ? d.put(x, [t, n, ae(r), i]) : d.remove(x)), e ? c.$applyAsync(o) : (o(), c.$$phase || c.$apply())
                }

                function s(t, e, n, i) {
                    e = Math.max(e, 0), (ue(e) ? g.resolve : g.reject)({
                        data: t,
                        status: e,
                        headers: se(n),
                        config: r,
                ...
                var d, m, g = p.defer(),
                    ...
                    w = r.headers,
                    x = C(r.url, r.params);
                if (h.pendingRequests.push(r), b.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (d = $(r.cache) ? r.cache : $(t.cache) ? t.cache : T), d && (m = d.get(x), y(m) ? O(m) ? m.then(u, u) : pr(m) ? s(m[1], m[0], P(m[2]), m[3]) : s(m, 200, {}, "OK") : d.put(x, b)), v(m)) {
                    var k = on(r.url) ? l.cookies()[r.xsrfCookieName || t.xsrfCookieName] : n;
            ...
            function C(t, e) {
                ...
                return s(e, function(t, e) {
                    null === t || v(t) || (pr(t) || (t = [t]), o(t, function(t) {
                        $(t) && (t = x(t) ? t.toISOString() : U(t)), n.push(K(e) + "=" + K(t))
                    }))
            ...
            return o(i, function(t) {
                E.unshift(b(t) ? d.get(t) : d.invoke(t))
    ...
    function de(t, e, r, i, a) {
        function s(t, e, n) {
            ...
            return r.type = "text/javascript", r.src = t, r.async = !0, o = function(t) {
                _r(r, "load", o), _r(r, "error", o), a.body.removeChild(r), r = null;
                var s = -1,
                    l = "unknown";
                t && ("load" !== t.type || i[e].called || (t = {
                    type: "error"
                }), l = t.type, s = "error" === t.type ? 404 : 200), n && n(s, l)
            }, Sr(r, "load", o), Sr(r, "error", o), a.body.appendChild(r), o
        }
        return function(a, l, u, c, f, p, d, m) {
            function g() {
                b && b(), w && w.abort()
            }

            function v(e, i, o, a, s) {
                k !== n && r.cancel(k), b = w = null, e(i, o, a, s), t.$$completeOutstandingRequest(h)
            }
            if (t.$$incOutstandingRequestCount(), l = l || t.url(), "jsonp" == Xn(a)) {
                var $ = "_" + (i.counter++).toString(36);
                i[$] = function(t) {
                    i[$].data = t, i[$].called = !0
                };
                var b = s(l.replace("JSON_CALLBACK", "angular.callbacks." + $), $, function(t, e) {
                    v(c, t, i[$].data, "", e), i[$] = h
                })
            } else {
                var w = e();
                w.open(a, l, !0), o(f, function(t, e) {
                    y(t) && w.setRequestHeader(e, t)
                }), w.onload = function() {
                    var t = w.statusText || "",
                        e = "response" in w ? w.response : w.responseText,
                        n = 1223 === w.status ? 204 : w.status;
                    0 === n && (n = e ? 200 : "file" == rn(l).protocol ? 404 : 0), v(c, n, e, w.getAllResponseHeaders(), t)
                };
                var x = function() {
                    v(c, -1, null, null, "")
                };
    ...
    function he() {
        ...
        this.startSymbol = function(e) {
            ...
            function a(o, a, p, d) {
                function h(n) {
                    return n.replace(u, t).replace(c, e)
                }

                function m(t) {
                    try {
                        return t = A(t), d && !y(t) ? t : D(t)
                    } catch (t) {
                        var e = ri("interr", "Can't interpolate: {0}\n{1}", o, t.toString());
                        r(e)
                    }
                }
                d = !!d;
                for (var g, $, b, w = 0, x = [], C = [], T = o.length, E = [], S = []; w < T;) {
                    if ((g = o.indexOf(t, w)) == -1 || ($ = o.indexOf(e, g + s)) == -1) {
                        w !== T && E.push(h(o.substring(w)));
                        break
                    }
                    w !== g && E.push(h(o.substring(w, g))), b = o.substring(g + s, $), x.push(b), C.push(n(b, m)), w = $ + l, S.push(E.length), E.push("")
                }
                if (p && E.length > 1) throw ri("noconcat", "Error while interpolating: {0}\nStrict Contextual Escaping disallows interpolations that concatenate multiple expressions when a trusted value is required.  See http://docs.angularjs.org/api/ng.$sce", o);
                if (!a || x.length) {
                    var _ = function(t) {
                    ...
                    return f(function(t) {
                        ...
                        try {
                            ...
                            var a = ri("interr", "Can't interpolate: {0}\n{1}", o, t.toString());
                            r(a)
                        }
                    }, {
                        exp: o,
        ...
        this.$get = ["$rootScope", "$window", "$q", "$$q", function(t, e, n, r) {
            function i(i, a, s, l) {
                var u = e.setInterval,
                    ...
                    d = (p ? r : n).defer(),
                    h = d.promise;
                return s = y(s) ? s : 0, h.then(null, null, i), h.$$intervalId = u(function() {
                    d.notify(f++), s > 0 && f >= s && (d.resolve(f), c(h.$$intervalId), delete o[h.$$intervalId]), p || t.$apply()
    ...
    function ye(t, e) {
        var n = rn(t);
        e.$$protocol = n.protocol, e.$$host = n.hostname, e.$$port = p(n.port) || oi[n.protocol] || null
    }
    ...
    function Te(t, e) {
        ...
        ye(t, this), this.$$parse = function(t) {
            ...
            var a, s, l;
            return (a = be(t, i)) !== n ? (s = a, l = (a = be(e, a)) !== n ? r + (be("/", a) || a) : t + s) : (a = be(r, i)) !== n ? l = r + a : r == i + "/" && (l = r), l && this.$$parse(l), !!l
        }
    }
    ...
    function Ee(t, e) {
        ...
        ye(t, this), this.$$parse = function(r) {
            ...
            "#" === a.charAt(0) ? (o = be(e, a), v(o) && (o = a)) : o = this.$$html5 ? a : "", $e(o, this), this.$$path = i(this.$$path, o, t), this.$$compose()
        }, this.$$compose = function() {
            var n = G(this.$$search),
    ...
    function Se(t, e) {
        ...
        this.$$parseLinkUrl = function(r, i) {
            ...
            var o, a;
            return t == we(r) ? o = r : (a = be(n, r)) ? o = t + e + a : n === r + "/" && (o = n), o && this.$$parse(o), !!o
        }, this.$$compose = function() {
            var n = G(this.$$search),
                r = this.$$hash ? "#" + X(this.$$hash) : "";
    ...
    function De() {
        ...
        this.hashPrefix = function(e) {
            ...
            return D(t) ? (e.enabled = t, this) : $(t) ? (D(t.enabled) && (e.enabled = t.enabled), D(t.requireBase) && (e.requireBase = t.requireBase), D(t.rewriteLinks) && (e.rewriteLinks = t.rewriteLinks), this) : e
            ...
            var u, c, f, p = r.baseHref(),
                d = r.url();
            if (e.enabled) {
                if (!p && e.requireBase) throw ai("nobase", "$location in HTML5 mode requires a <base> tag to be present!");
                f = Ce(d) + (p || "/"), c = i.history ? Te : Se
            } else f = we(d), c = Ee;
            u = new c(f, "#" + t), u.$$parseLinkUrl(d, d), u.$$state = r.state();
            ...
            o.on("click", function(t) {
                if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                    ...
                    $(s) && "[object SVGAnimatedString]" === s.toString() && (s = rn(s.animVal).href), h.test(s) || !s || i.attr("target") || t.isDefaultPrevented() || u.$$parseLinkUrl(s, l) && (t.preventDefault(), u.absUrl() != r.url() && (n.$apply(), a.angular["ff-684208-preventDefault"] = !0))
                }
            }), xe(u.absUrl()) != xe(d) && r.url(u.absUrl(), !0);
            var m = !0;
            return r.onUrlChange(function(t, e) {
                n.$evalAsync(function() {
                    var r, i = u.absUrl(),
                        o = u.$$state;
                    u.$$parse(t), u.$$state = e, r = n.$broadcast("$locationChangeStart", t, i, e, o).defaultPrevented, u.absUrl() === t && (r ? (u.$$parse(i), u.$$state = o, s(i, !1, o)) : (m = !1, l(i, o)))
                }), n.$$phase || n.$digest()
            }), n.$watch(function() {
                var t = xe(r.url()),
                    e = xe(u.absUrl()),
                    o = r.state(),
                    a = u.$$replace,
                    c = t !== e || u.$$html5 && i.history && o !== u.$$state;
                (m || c) && (m = !1, n.$evalAsync(function() {
                    var e = u.absUrl(),
                        r = n.$broadcast("$locationChangeStart", e, t, u.$$state, o).defaultPrevented;
                    u.absUrl() === e && (r ? (u.$$parse(t), u.$$state = o) : (c && s(e, a, o === u.$$state ? null : u.$$state), l(t, o)))
                })), u.$$replace = !1
            }), u
        }]
    }
    ...
    function je(t, e) {
        if (t) {
            if (t.constructor === t) throw li("isecfn", "Referencing Function in Angular expressions is disallowed! Expression: {0}", e);
            if (t === ui || t === ci || t === fi) throw li("isecff", "Referencing call, apply or bind in Angular expressions is disallowed! Expression: {0}", e)
        }
    }
    ...
    function Re(t, e, n, r, i) {
        ...
        return o = Me(a.shift(), i), Ne(t[o], i), t[o] = r, r
    }
    ...
    function Le(t, e, r, i, o, a, s) {
        Me(t, a), Me(e, a), Me(r, a), Me(i, a), Me(o, a);
        var l = function(t) {
                return Ne(t, a)
            },
            u = s || Pe(t) ? l : m,
        ...
        return function(a, s) {
            ...
            return null == l ? l : (l = u(l[t]), e ? null == l ? n : (l = c(l[e]), r ? null == l ? n : (l = f(l[r]), i ? null == l ? n : (l = p(l[i]), o ? null == l ? n : l = d(l[o]) : l) : l) : l) : l)
        }
    }
    ...
    function qe(t, e, r) {
        ...
        var l = t.split("."),
            u = l.length;
        if (e.csp) s = u < 6 ? Le(l[0], l[1], l[2], l[3], l[4], r, i) : function(t, e) {
            var o, a = 0;
            do o = Le(l[a++], l[a++], l[a++], l[a++], l[a++], r, i)(t, e), e = n, t = o; while (a < u);
            return o
        };
        else {
            var c = "";
    ...
    function He(t) {
        return k(t.valueOf) ? t.valueOf() : $i.call(t)
    }
        ...
        this.$get = ["$filter", "$sniffer", function(n, r) {
            ...
            function l(t, e, n, r) {
                ...
                if (1 === o.length) {
                    ...
                    return o = o[0], t.$watch(function(t) {
                        var e = o(t);
                        return s(e, l) || (i = r(t), l = e && He(e)), i
                    }, e, n)
                }
                for (var u = [], c = 0, f = o.length; c < f; c++) u[c] = s;
                return t.$watch(function(t) {
                    for (var e = !1, n = 0, a = o.length; n < a; n++) {
                        var l = o[n](t);
                        (e || (e = !s(l, u[n]))) && (u[n] = l && He(l))
                    }
                    return e && (i = r(t)), i
                }, e, n)
            }
            ...
            function u(t, e, n, r) {
                ...
                return i = t.$watch(function(t) {
                    ...
                    o = t, k(e) && e.apply(this, arguments), y(t) && r.$$postDigest(function() {
                        y(o) && i()
                    })
                }, n)
            }
            ...
            function p(t, e) {
                ...
                return t.$$watchDelegate && t.$$watchDelegate !== l ? i.$$watchDelegate = t.$$watchDelegate : e.$stateful || (i.$$watchDelegate = l, i.inputs = [t]), i
            }
            var d = {
                    csp: r.csp,
                    expensiveChecks: !1
                    ...
                    case "string":
                        ...
                        if (s = y[v], !s) {
                            ...
                            var $ = a ? m : d,
                                b = new mi($),
                                w = new gi(b, n, $);
                            s = w.parse(r), s.constant ? s.$$watchDelegate = f : g ? (s = i(s), s.$$watchDelegate = s.literal ? c : u) : s.inputs && (s.$$watchDelegate = l), y[v] = s
                        }
                        return p(s, o);
                    case "function":
                        return p(r, o);
    ...
    function We(t, e) {
        ...
        a.prototype = {
            then: function(t, e, n) {
                var r = new c;
                return this.$$state.pending = this.$$state.pending || [], this.$$state.pending.push([r, t, e, n]), this.$$state.status > 0 && u(this.$$state), r.promise
            },
            "catch": function(t) {
            ...
            $$resolve: function(t) {
                ...
                try {
                    ($(t) || k(t)) && (n = t && t.then), k(n) ? (this.promise.$$state.status = -1, n.call(t, r[0], r[1], this.notify)) : (this.promise.$$state.value = t, this.promise.$$state.status = 1, u(this.promise.$$state))
                } catch (t) {
                    r[1](t), e(t)
                }
            },
        ...
        var h = function(t) {
            ...
            y = function t(e) {
                ...
                if (!k(e)) throw p("norslvr", "Expected resolverFn, got '{0}'", e);
                if (!(this instanceof t)) return new t(e);
                var i = new c;
                return e(n, r), i.promise
            };
        return y.defer = d, y.reject = h, y.when = v, y.all = f, y
    }
        ...
        this.digestTtl = function(t) {
            ...
            d.prototype = {
                ...
                $watch: function(t, e, n) {
                    ...
                    return a = null, k(e) || (s.fn = h), o || (o = i.$$watchers = []), o.unshift(s),
                        function() {
                            I(o, s), a = null
                        }
                },
                $watchGroup: function(t, e) {
                    ...
                    return 1 === t.length ? this.$watch(t[0], function(t, n, o) {
                        ...
                        var o = s.$watch(t, function(t, o) {
                            i[e] = t, r[e] = o, l || (l = !0, s.$evalAsync(n))
                        });
                        a.push(o)
                    }), function() {
                        ...
                        if (!v(o)) {
                            if ($(o))
                                if (i(o)) {
                                    ...
                                    for (var u = 0; u < e; u++) l = a[u], s = o[u], r = l !== l && s !== s, r || l === s || (f++, a[u] = s)
                                } else {
                                    a !== h && (a = h = {}, g = 0, f++), e = 0;
                                    for (n in o) o.hasOwnProperty(n) && (e++, s = o[n], l = a[n], n in a ? (r = l !== l && s !== s, r || l === s || (f++, a[n] = s)) : (g++, a[n] = s, f++));
                                    if (g > e) {
                                        f++;
                        ...
                        t: do {
                            if (o = d.$$watchers)
                                for (u = o.length; u--;) try {
                                    if (t = o[u])
                                        if ((r = t.get(d)) === (i = t.last) || (t.eq ? L(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                            if (t === a) {
                                                c = !1;
                                                break t
                                            }
                                        } else c = !0, a = t, t.last = t.eq ? R(r, null) : r, t.fn(r, i === b ? r : i, d), y < 5 && (h = 4 - y, x[h] || (x[h] = []), x[h].push({
                            ...
                            if (!(p = d.$$childHead || d !== $ && d.$$nextSibling))
                                for (; d !== $ && !(p = d.$$nextSibling);) d = d.$parent
                        } while (d = p);
                ...
                $emit: function(t) {
                    var e, n, r, i = [],
                        ...
                        u = F([s], arguments, 1);
                    do {
                        for (e = o.$$listeners[t] || i, s.currentScope = o, n = 0, r = e.length; n < r; n++)
                            if (e[n]) try {
                                e[n].apply(null, u)
                            } catch (t) {
                                l(t)
                ...
                $broadcast: function(t) {
                    ...
                    for (var o, a, s, u = F([i], arguments, 1); n = r;) {
                        for (i.currentScope = n, o = n.$$listeners[t] || [], a = 0, s = o.length; a < s; a++)
                            if (o[a]) try {
                                o[a].apply(null, u)
                            } catch (t) {
                                l(t)
    ...
    function Je() {
        ...
        this.resourceUrlWhitelist = function(e) {
            ...
            var f = a(),
                p = {};
            return p[wi.HTML] = a(f), p[wi.CSS] = a(f), p[wi.URL] = a(f), p[wi.JS] = a(f), p[wi.RESOURCE_URL] = a(p[wi.URL]), {
                trustAs: s,
                getTrusted: u,
                valueOf: l
            }
    ...
    function Qe() {
        ...
        this.enabled = function(e) {
            ...
            if (t && tr < 8) throw bi("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
            var r = P(wi);
    ...
    function Ze() {
        this.$get = ["$window", "$document", function(t, e) {
            var n, r, i = {},
                o = p((/android (\d+)/.exec(Xn((t.navigator || {}).userAgent)) || [])[1]),
            ...
            if (u) {
                ...
                n || (n = "WebkitOpacity" in u && "webkit"), c = !!("transition" in u || n + "Transition" in u), f = !!("animation" in u || n + "Animation" in u), !o || c && f || (c = b(s.body.style.webkitTransition), f = b(s.body.style.webkitAnimation))
            }
            return {
                history: !(!t.history || !t.history.pushState || o < 4 || a),
                hasEvent: function(t) {
                    if ("input" === t && tr <= 11) return !1;
                    if (v(i[t])) {
    ...
    function tn() {
        this.$get = ["$templateCache", "$http", "$q", function(t, e, n) {
            function r(i, o) {
                ...
                return e.get(i, l)["finally"](function() {
                    r.totalPendingRequests--
                }).then(function(t) {
                    return t.data
                }, a)
        ...
        this.$get = ["$rootScope", "$browser", "$location", function(t, e, n) {
            ...
            return r.findBindings = function(t, e, n) {
                ...
                return o(r, function(t) {
                    var r = ur.element(t).data("$binding");
                    r && o(r, function(r) {
                        if (n) {
    ...
    function sn(t) {
        ...
        }], e("currency", fn), e("date", Cn), e("filter", ln), e("json", Tn), e("limitTo", En), e("lowercase", _i), e("number", pn), e("orderBy", Sn), e("uppercase", Ai)
    }
    ...
    function un(t, e, n) {
        var r, i = $(t) && "$" in t;
        return e === !0 ? e = L : k(e) || (e = function(t, e) {
            return !$(t) && !$(e) && (t = Xn("" + t), e = Xn("" + e), t.indexOf(e) !== -1)
        }), r = function(r) {
    ...
    function cn(t, e, n, r, i) {
        ...
        switch (o) {
            case "object":
                ...
                if (r) {
                    for (s in t)
                        if ("$" !== s.charAt(0) && cn(t[s], e, n, !0)) return !0;
                    return !i && cn(t, e, n, !1)
                }
                if ("object" === a) {
                    for (s in e) {
    ...
    function dn(t, e, n, r, i) {
        ...
        if (a.indexOf("e") !== -1) {
            var c = a.match(/([\d\.]+)e(-?)(\d+)/);
            c && "-" == c[2] && c[3] > i + 1 ? t = 0 : (s = a, u = !0)
        }
        if (u) i > 0 && t < 1 && (s = t.toFixed(i), t = parseFloat(s));
        else {
            var f = (a.split(Ci)[1] || "").length;
            ...
            var h, m = 0,
                ...
                y = e.gSize;
            if (d.length >= g + y)
                for (m = d.length - g, h = 0; h < m; h++)(m - h) % y === 0 && 0 !== h && (s += n), s += d.charAt(h);
    ...
    function mn(t, e, n, r) {
        return n = n || 0,
            function(i) {
                var o = i["get" + t]();
                return (n > 0 || o > -n) && (o += n), 0 === o && n == -12 && (o = 12), hn(o, e, r)
            }
    }
    ...
    function vn(t) {
        var e = -1 * t.getTimezoneOffset(),
            n = e >= 0 ? "+" : "";
        return n += hn(Math[e > 0 ? "floor" : "ceil"](e / 60), 2) + hn(Math.abs(e % 60), 2)
    }
    ...
    function Cn(t) {
        ...
        return function(n, r, i) {
            var a, s, l = "",
                u = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, b(n) && (n = Si.test(n) ? p(n) : e(n)), w(n) && (n = new Date(n)), !x(n)) return n;
            for (; r;) s = Ei.exec(r), s ? (u = F(u, s, 1), r = u.pop()) : (u.push(r), r = null);
            return i && "UTC" === i && (n = new Date(n.getTime()), n.setMinutes(n.getMinutes() + n.getTimezoneOffset())), o(u, function(e) {
                a = Ti[e], l += a ? a(n, t.DATETIME_FORMATS) : e.replace(/(^'|'$)/g, "").replace(/''/g, "'")
            }), l
        }
    }
    ...
    function En() {
        return function(t, e) {
            return w(t) && (t = t.toString()), pr(t) || b(t) ? (e = Math.abs(Number(e)) === 1 / 0 ? Number(e) : p(e), e ? e > 0 ? t.slice(0, e) : t.slice(e) : b(t) ? "" : []) : t
        }
    }
    ...
    function Sn(t) {
        return function(e, n, r) {
            ...
            function u(t, e) {
                var n = typeof t,
                    r = typeof e;
                return n === r && "object" === n && (t = l(t), e = l(e)), n === r ? ("string" === n && (t = t.toLowerCase(), e = e.toLowerCase()), t === e ? 0 : t < e ? -1 : 1) : n < r ? -1 : 1
            }
            return i(e) ? (n = pr(n) ? n : [n], 0 === n.length && (n = ["+"]), n = n.map(function(e) {
                var n = !1,
                    r = e || m;
                if (b(e)) {
                    if ("+" != e.charAt(0) && "-" != e.charAt(0) || (n = "-" == e.charAt(0), e = e.substring(1)), "" === e) return a(u, n);
                    if (r = t(e), r.constant) {
                        var i = r();
    ...
    function Dn(t, e, r, i, a) {
        var s = this,
            l = [],
            u = s.$$parentForm = t.parent().controller("form") || Mi;
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, u.$addControl(s), s.$rollbackViewValue = function() {
            o(l, function(t) {
                t.$rollbackViewValue()
            })
            ...
            at(t.$name, "input"), l.push(t), t.$name && (s[t.$name] = t)
            ...
            i.removeClass(t, mo), i.addClass(t, go), s.$dirty = !0, s.$pristine = !1, u.$setDirty()
        }, s.$setPristine = function() {
            i.setClass(t, mo, go + " " + Ni), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(l, function(t) {
                t.$setPristine()
            })
            ...
            i.addClass(t, Ni), s.$submitted = !0, u.$setSubmitted()
        }
    }
    ...
    function Nn(t, e, n, r, i, o) {
        ...
        var l = function(t) {
            if (u && (o.defer.cancel(u), u = null), !s) {
                var i = e.val(),
                    l = t && t.type;
                "password" === a || n.ngTrim && "false" === n.ngTrim || (i = dr(i)), (r.$viewValue !== i || "" === i && r.$$hasNativeValidators) && r.$setViewValue(i, l)
            }
        };
        ...
        e.on("change", l), r.$render = function() {
        ...
        if (b(t)) {
            ...
            if (n) {
                var r = +n[1],
                    ...
                    u = yn(r),
                    c = 7 * (i - 1);
                return e && (o = e.getHours(), a = e.getMinutes(), s = e.getSeconds(), l = e.getMilliseconds()), new Date(r, 0, u.getDate() + c, o, a, s, l)
            }
        }
        return NaN
    }
    ...
    function Pn(t, e, r, i) {
        var o = e[0],
            a = i.$$hasNativeValidators = $(o.validity);
    ...
    function Ln(t, e, r, i, o, a) {
        if (Pn(t, e, r, i), Nn(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function(t) {
                return i.$isEmpty(t) ? null : qi.test(t) ? parseFloat(t) : n
            ...
            i.$validators.min = function(t) {
                ...
                y(t) && !w(t) && (t = parseFloat(t, 10)), s = w(t) && !isNaN(t) ? t : n, i.$validate()
            })
        }
        if (y(r.max) || r.ngMax) {
            var l;
            i.$validators.max = function(t) {
                ...
                y(t) && !w(t) && (t = parseFloat(t, 10)), l = w(t) && !isNaN(t) ? t : n, i.$validate()
            })
        }
    }
    ...
    function Un(t, e, n, r, i, o, a, s) {
        var l = Vn(s, t, "ngTrueValue", n.ngTrueValue, !0),
            u = Vn(s, t, "ngFalseValue", n.ngFalseValue, !1),
            c = function(t) {
        ...
        return t = "ngClass" + t, ["$animate", function(n) {
            ...
            return {
                ...
                link: function(a, s, l) {
                    ...
                    var h;
                    a.$watch(l[t], d, !0), l.$observe("class", function() {
                        d(a.$eval(l[t]))
    ...
    function Wn(t) {
        function e(t, e, l) {
            e === n ? r("$pending", t, l) : i("$pending", t, l), D(e) ? e ? (f(s.$error, t, l), c(s.$$success, t, l)) : (c(s.$error, t, l), f(s.$$success, t, l)) : (f(s.$error, t, l), f(s.$$success, t, l)), s.$pending ? (o($o, !0), s.$valid = s.$invalid = n, a("", null)) : (o($o, !1), s.$valid = zn(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
            var u;
            u = s.$pending && s.$pending[t] ? n : !s.$error[t] && (!!s.$$success[t] || null), a(t, u), p.$setValidity(t, u, s)
        }
        ...
        function o(t, e) {
            e && !u[t] ? (d.addClass(l, t), u[t] = !0) : !e && u[t] && (d.removeClass(l, t), u[t] = !1)
        }

        function a(t, e) {
            t = t ? "-" + nt(t, "-") : "", o(po + t, e === !0), o(ho + t, e === !1)
        }
        var s = t.ctrl,
            l = t.$element,
            u = {},
            ...
            p = t.parentForm,
            d = t.$animate;
        u[ho] = !(u[po] = l.hasClass(po)), s.$setValidity = e
    }
    ...
    "i" !== "I".toLowerCase() && (Xn = Qn, Jn = Zn);
    var tr, er, nr, rr, ir = [].slice,
        or = [].splice,
        ar = [].push,
        sr = Object.prototype.toString,
        lr = r("ng"),
        ur = t.angular || (t.angular = {}),
        cr = 0;
    tr = e.documentMode, h.$inject = [], m.$inject = [];
    var fr, pr = Array.isArray,
        dr = function(t) {
            return b(t) ? t.trim() : t
        },
        hr = function(t) {
        ...
        mr = function() {
            if (y(mr.isActive_)) return mr.isActive_;
    ...
    o({
        ...
        inheritedData: Mt,
        scope: function(t) {
            return er.data(t, "$scope") || Mt(t.parentNode || t, ["$isolateScope", "$scope"])
        },
        ...
        attr: function(t, e, r) {
            var i = Xn(e);
            if (Fr[i]) {
                if (!y(r)) return t[e] || (t.attributes.getNamedItem(e) || h).specified ? i : n;
        ...
        bt.prototype[e] = function(e, r) {
            ...
            if (t !== Nt && (2 == t.length && t !== St && t !== Ot ? e : r) === n) {
                if ($(e)) {
                    for (i = 0; i < a; i++)
                        if (t === Et) t(this[i], e);
                        else
                ...
                for (var s = t.$dv, l = s === n ? Math.min(a, 1) : a, u = 0; u < l; u++) {
                    var c = t(this[u], e, r);
                    s = s ? s + c : c
                }
                return s
        ...
        on: function t(e, n, r, i) {
            if (y(i)) throw Mr("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
            if (vt(e)) {
                var o = Tt(e, !0),
                    a = o.events,
                    s = o.handle;
                ...
                for (var l = n.indexOf(" ") >= 0 ? n.split(" ") : [n], u = l.length; u--;) {
                    ...
                    }) : "$destroy" !== n && Sr(e, n, s), c = a[n]), c.push(r)
                }
            }
        },
        off: kt,
        ...
        bt.prototype[e] = function(e, n, r) {
            for (var i, o = 0, a = this.length; o < a; o++) v(i) ? (i = t(this[o], e, n, r), y(i) && (i = er(i))) : Dt(i, t(this[o], e, n, r));
            return y(i) ? i : this
            ...
            this.$$selectors = {}, this.register = function(e, n) {
                ...
                return {
                    ...
                    enter: function(t, e, n, r) {
                        return l(t, r), n ? n.after(t) : e.prepend(t), s()
                    },
                    leave: function(t, e) {
                    ...
                    $$addClassImmediately: function(t, e, n) {
                        return t = er(t), e = b(e) ? e : pr(e) ? e.join(" ") : "", o(t, function(t) {
                            At(t, e)
                        }), l(t, n), s()
                    },
                    ...
                    setClass: function(t, e, n, o) {
                        ...
                        t = er(t);
                        var c = t.data(l);
                        c ? o && c.options && (c.options = ur.extend(c.options || {}, o)) : (c = {
                            classes: {},
                            options: o
                        }, u = !0);
                        var f = c.classes;
                        return e = pr(e) ? e : e.split(" "), n = pr(n) ? n : n.split(" "), a(f, e, !0), a(f, n, !1), u && (c.promise = r(function(e) {
                            var n = t.data(l);
                            if (t.removeData(l), n) {
                                var r = i(t, n.classes);
                            ...
                            e()
                        }), t.data(l, c)), c.promise
                    },
                    $$setClassImmediately: function(t, e, n, r) {
                        return e && this.$$addClassImmediately(t, e), n && this.$$removeClassImmediately(t, n), l(t, r), s()
                    },
                    enabled: h,
                    cancel: h
                }
            ...
            search: function(t, e) {
                switch (arguments.length) {
                    case 0:
                        return this.$$search;
                    case 1:
                        if (b(t) || w(t)) t = t.toString(), this.$$search = Y(t);
                        else {
                            if (!$(t)) throw ai("isrcharg", "The first argument of the `$location#search()` call must be a string or an object.");
    ...
    o([Se, Ee, Te], function(t) {
        t.prototype = Object.create(si), t.prototype.state = function(e) {
            if (!arguments.length) return this.$$state;
            if (t !== Te || !this.$$html5) throw ai("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
    ...
    gi.ZERO = f(function() {
        ...
        filter: function(t) {
            ...
            return f(function(o, a) {
                ...
                if (r) {
                    r[0] = s;
                    for (var l = e.length; l--;) r[l + 1] = e[l](o, a);
                    return i.apply(n, r)
                }
                return i(s)
            }, {
        ...
        functionCall: function(t, e) {
            ...
            var i = this.text,
                o = r.length ? [] : null;
            return function(a, s) {
                var l = e ? e(a, s) : y(e) ? n : a,
                    u = t(a, s, l) || h;
                if (o)
                    for (var c = r.length; c--;) o[c] = Ne(r[c](a, s), i);
                Ne(l, i), je(u, i);
                var f = u.apply ? u.apply(l, o) : u(o[0], o[1], o[2], o[3], o[4]);
    ...
    var Ci = ".",
        ...
        Ei = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/,
        Si = /^\-?\d+$/;
    Cn.$inject = ["$locale"];
    var _i = g(Xn),
        Ai = g(Jn);
    ...
    var ji = function(t) {
                        ...
                        return {
                            pre: function(t, r, i, a) {
                                ...
                                o && (Re(t, null, a.$name, a, a.$name), i.$observe(o, function(e) {
                                    a.$name !== e && (Re(t, null, a.$name, n, a.$name), l.$$renameControl(a, e), Re(t, null, a.$name, a, a.$name))
                                })), r.on("$destroy", function() {
                                    l.$removeControl(a), o && Re(t, null, i[o], n, a.$name), f(a, Mi)
                                })
                            }
                        }
                    }
        ...
        Fi = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
        qi = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        Hi = /^(\d{4})-(\d{2})-(\d{2})$/,
        Vi = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,
        Ui = /^(\d{4})-W(\d\d)$/,
        Bi = /^(\d{4})-(\d\d)$/,
        ...
        Yi = ["$browser", "$sniffer", "$filter", "$parse", function(t, e, n, r) {
            return {
                restrict: "E",
                require: ["?ngModel"],
                link: {
                    pre: function(i, o, a, s) {
                        s[0] && (zi[Xn(a.type)] || zi.text)(i, o, a, s[0], e, t, n, r)
                    }
                }
            }
        }],
    ...
    var so = ["$animate", function(t) {
            return {
                ...
                link: function(n, r, i, o, a) {
                    ...
                    n.$watch(i.ngIf, function(n) {
                        n ? l || a(function(n, o) {
                            l = o, n[n.length++] = e.createComment(" end ngIf: " + i.ngIf + " "), s = {
                                clone: n
                            }, t.enter(n, r.parent(), r)
                        }) : (u && (u.remove(), u = null), l && (l.$destroy(), l = null), s && (u = lt(s.clone), t.leave(u).then(function() {
                            u = null
                        }), s = null))
                    })
                }
        ...
        lo = ["$templateRequest", "$anchorScroll", "$animate", "$sce", function(t, e, n, r) {
            return {
                restrict: "ECA",
                priority: 400,
                terminal: !0,
                        ...
                        i.$watch(r.parseAsResourceUrl(a), function(r) {
                            ...
                            r ? (t(r, !0).then(function(t) {
                                if (u === m) {
                                    var e = i.$new();
                                    c.template = t;
                                    var l = f(e, function(t) {
                                        g(), n.enter(t, null, o).then(a)
                                    });
                                    p = e, h = l, p.$emit("$includeContentLoaded", r), i.$eval(s)
                                }
                            }, function() {
                                u === m && (g(), i.$emit("$includeContentError", r))
        ...
        $o = "ng-pending",
        bo = new r("ngModel"),
        wo = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(t, e, r, i, a, s, l, u, c, f) {
            ...
            this.$$setOptions = function(t) {
                ...
                } else if (!d.assign) throw bo("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, W(i))
            }, this.$render = h, this.$isEmpty = function(t) {
                return v(t) || "" === t || null === t || t !== t
            };
            var C = i.inheritedData("$formController") || Mi,
                T = 0;
            Wn({
                ctrl: this,
                $element: i,
                ...
                x.$dirty = !0, x.$pristine = !1, s.removeClass(i, mo), s.addClass(i, go), C.$setDirty()
            }, this.$setUntouched = function() {
                x.$touched = !1, x.$untouched = !0, s.setClass(i, vo, yo)
            }, this.$setTouched = function() {
                x.$touched = !0, x.$untouched = !1, s.setClass(i, yo, vo)
            }, this.$rollbackViewValue = function() {
                l.cancel(b), x.$viewValue = x.$$lastCommittedViewValue, x.$render()
                ...
                function s() {
                    ...
                    o(x.$asyncValidators, function(o, a) {
                        var s = o(t, e);
                        if (!O(s)) throw bo("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
                ...
                var t = x.$viewValue;
                l.cancel(b), (x.$$lastCommittedViewValue !== t || "" === t && x.$$hasNativeValidators) && (x.$$lastCommittedViewValue = t, x.$pristine && this.$setDirty(), this.$$parseAndValidate())
                ...
                var n, r = 0,
                    i = x.$options;
                i && y(i.debounce) && (n = i.debounce, w(n) ? r = n : w(n[e]) ? r = n[e] : w(n["default"]) && (r = n["default"])), l.cancel(b), r ? b = l(function() {
                    x.$commitViewValue()
                }, r) : u.$$phase ? x.$commitViewValue() : t.$apply(function() {
                    x.$commitViewValue()
                })
            }, t.$watch(function() {
                var e = g(t);
        ...
        xo = ["$rootScope", function(t) {
            return {
                ...
                priority: 1,
                compile: function(e) {
                    return e.addClass(mo).addClass(vo).addClass(po), {
            ...
            return {
                ...
                link: function(i, a, s) {
                    ...
                    o(s, function(t, e) {
                        ...
                        var n = parseFloat(e),
                            r = isNaN(n);
                        r || n in d || (n = t.pluralCat(n - p)), n === u || r && isNaN(u) || (y(), y = i.$watch(h[n], l), u = n)
                    })
                }
            }
        }],
        So = ["$parse", "$animate", function(t, a) {
            var s = "$$NG_REMOVED",
                l = r("ngRepeat"),
            ...
            return {
                ...
                compile: function(r, p) {
                    ...
                    if (!m) throw l("iexp", "Expected expression in form of '_item_ in _collection_[ track by _id_]' but got '{0}'.", d);
                    var g = m[1],
                        v = m[2],
                        y = m[3],
                        $ = m[4];
                    ...
                    return $ ? x = t($) : (C = function(t, e) {
                        ...
                        function(t, e, r, p, m) {
                            ...
                            t.$watchCollection(v, function(r) {
                                var p, v, $, x, E, S, _, A, D, O, M, N, j = e[0],
                                    I = ut();
                                if (y && (t[y] = r), i(r)) D = r, A = k || C;
                                else {
                                    A = k || T, D = [];
                                    for (var R in r) r.hasOwnProperty(R) && "$" != R.charAt(0) && D.push(R);
                                    D.sort()
                                }
                                for (x = D.length, M = new Array(x), p = 0; p < x; p++)
                                    if (E = r === D ? p : D[p], S = r[E], _ = A(E, S, p), g[_]) O = g[_], delete g[_], I[_] = O, M[p] = O;
                                    else {
                                        if (I[_]) throw o(M, function(t) {
                                            t && t.scope && (g[t.id] = t)
                                        }), l("dupes", "Duplicates in a repeater are not allowed. Use 'track by' expression to specify unique keys. Repeater: {0}, Duplicate key: {1}, Duplicate value: {2}", d, _, S);
                                        M[p] = {
                                            id: _,
                                            scope: n,
                                            clone: n
                                ...
                                for (var P in g) {
                                    if (O = g[P], N = lt(O.clone), a.leave(N), N[0].parentNode)
                                        for (p = 0, v = N.length; p < v; p++) N[p][s] = !0;
                                    O.scope.$destroy()
                                }
                                for (p = 0; p < x; p++)
                                    if (E = r === D ? p : D[p], S = r[E], O = M[p], O.scope) {
                                        $ = j;
                                        do $ = $.nextSibling; while ($ && $[s]);
                                        c(O) != $ && a.move(lt(O.clone), null, er(j)), j = f(O), u(O.scope, p, b, S, w, E, x)
                                    } else m(function(t, e) {
                                        O.scope = e;
                                        var n = h.cloneNode(!1);
                                        t[t.length++] = n, a.enter(t, null, er(j)), j = n, O.clone = t, I[O.id] = O, u(O.scope, p, b, S, w, E, x)
                                    });
                                g = I
                            })
                        }
            ...
            return {
                ...
                link: function(n, r, i, a) {
                    ...
                    n.$watch(s, function(n) {
                        ...
                        u.length = 0, f.length = 0, (l = a.cases["!" + n] || a.cases["?"]) && o(l, function(n) {
            ...
            return {
                ...
                controller: ["$element", "$scope", "$attrs", function(t, e, n) {
                    ...
                    o.databound = n.ngModel, o.init = function(t, e, n) {
                        ...
                        at(e, '"option value"'), a[e] = !0, l.$viewValue == e && (t.val(e), i.parent() && i.remove()), n && n[0].hasAttribute("selected") && (n[0].selected = !0)
                    }, o.removeOption = function(t) {
                        this.hasOption(t) && (delete a[t], l.$viewValue === t && this.renderUnknownOption(t))
                ...
                link: function(s, l, u, c) {
                    ...
                    function d(e, s, l) {
                        function u(t, n, r) {
                            return L[S] = r, D && (L[D] = n), t(e, L)
                        }

                        function c() {
                            e.$apply(function() {
                                var t, n = N(e) || [];
                                if ($) t = [], o(s.val(), function(e) {
                        ...
                        function p() {
                            ...
                            if (n && pr(n)) {
                                ...
                                for (var r = 0, i = n.length; r < i; r++) t[r] = u(E, r, n[r]);
                                return t
                            }
                            if (n) {
                                t = {};
                                for (var o in n) n.hasOwnProperty(o) && (t[o] = u(E, o, n[o]))
                            }
                            return t
                        }
                        ...
                        function d(t) {
                            ...
                            if ($)
                                if (I && pr(t)) {
                                    e = new Ht([]);
                                    for (var n = 0; n < t.length; n++) e.put(u(I, null, t[n]), !0)
                                } else e = new Ht(t);
                            else I && (t = u(I, null, t));
                            return function(n, r) {
                                var i;
                                return i = I ? I : A ? A : M, $ ? y(e.remove(u(i, n, r))) : t === u(i, n, r)
                            }
                        }
                        ...
                        function v() {
                            x = !1;
                            var t, n, r, i, c, f, p, h, v, b, T, S, _, A, M, j, F, q = {
                                    "": []
                                },
                                H = [""],
                                V = l.$viewValue,
                                ...
                                z = d(V),
                                Y = !1;
                            for (R = {}, S = 0; b = B.length, S < b; S++) p = S, D && (p = B[S], "$" === p.charAt(0)) || (h = U[p], t = u(O, p, h) || "", (n = q[t]) || (n = q[t] = [], H.push(t)), _ = z(p, h), Y = Y || _, j = u(E, p, h), j = y(j) ? j : "", F = I ? I(e, L) : D ? B[S] : S, I && (R[F] = p), n.push({
                                id: F,
                                label: j,
                                selected: _
                            }));
                            for ($ || (w || null === V ? q[""].unshift({
                                    id: "",
                                    label: "",
                                    selected: !Y
                                }) : Y || q[""].unshift({
                                    ...
                                    label: "",
                                    selected: !0
                                })), T = 0, v = H.length; T < v; T++) {
                                for (t = H[T], n = q[t], P.length <= T ? (i = {
                                        element: C.clone().attr("label", t),
                                        label: n.label
                                    }, c = [i], P.push(c), s.append(i.element)) : (c = P[T], i = c[0], i.label != t && i.element.attr("label", i.label = t)), A = null, S = 0, b = n.length; S < b; S++) r = n[S], (f = c[S + 1]) ? (A = f.element, f.label !== r.label && (g(W, f.label, !1), g(W, r.label, !0), A.text(f.label = r.label), A.prop("label", f.label)), f.id !== r.id && A.val(f.id = r.id), A[0].selected !== r.selected && (A.prop("selected", f.selected = r.selected), tr && A.prop("selected", f.selected))) : ("" === r.id && w ? M = w : (M = k.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), c.push(f = {
                                    element: M,
                                    label: r.label,
                                    id: r.id,
                                    selected: r.selected
                                }), g(W, r.label, !0), A ? A.after(M) : i.element.append(M), A = M);
                                for (S++; c.length > S;) r = c.pop(), g(W, r.label, !1), r.element.remove()
                            }
                            for (; P.length > T;) {
                                for (n = P.pop(), S = 1; S < n.length; ++S) g(W, n[S].label, !1);
                                n[0].element.remove()
                            }
                            o(W, function(t, e) {
                        ...
                        var T;
                        if (!(T = b.match(i))) throw Lo("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, W(s));
                        var E = r(T[2] || T[1]),
                            S = T[4] || T[6],
                            _ = / as /.test(T[0]) && T[1],
                            A = _ ? r(_) : null,
                            ...
                            L = {};
                        w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), s.empty(), s.on("change", c), l.$render = v, e.$watchCollection(N, h), e.$watchCollection(p, h), $ && e.$watchCollection(function() {
                            return l.$modelValue
                        }, h)
                    }
                    if (c[1]) {
                        for (var h, m = c[0], g = c[1], $ = u.multiple, b = u.ngOptions, w = !1, x = !1, k = er(e.createElement("option")), C = er(e.createElement("optgroup")), T = k.clone(), E = 0, S = l.children(), _ = S.length; E < _; E++)
                            if ("" === S[E].value) {
                                h = w = S.eq(E);
                                break
                            }
    ...
    return t.angular.bootstrap ? void console.log("WARNING: Tried to load angular more than once.") : (rt(), dt(ur), void er(e).ready(function() {
        Q(e, Z)
    }))
}(window, document), !window.angular.$$csp() && window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>'), angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.transition", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-popup.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/tooltip/tooltip-template-popup.html", "template/popover/popover-template.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.collapse", []).directive("collapse", ["$animate", function(t) {
        return {
            link: function(e, n, r) {
                function i() {
        ...
        return {
            ...
            link: function(t, e, n, r) {
                ...
                var s = r[0],
                    l = r[1];
                l.$render = function() {
                    e.toggleClass(s.activeClass, angular.equals(l.$modelValue, i()))
                }, e.bind(s.toggleEvent, function() {
                    t.$apply(function() {
                        l.$setViewValue(e.hasClass(s.activeClass) ? o() : i()), l.$render()
                    })
                })
            }
        }
        ...
        function r(t) {
            if (angular.isUndefined(c[t].index)) return c[t];
            var e;
            c.length;
            for (e = 0; e < c.length; ++e)
                if (c[e].index == t) return c[e]
        }
        ...
        u.currentSlide = null;
        var p = !1;
        u.select = t.select = function(e, r) {
            function o() {
                p || (angular.extend(e, {
                    direction: r,
                    active: !0
                ...
                })), u.currentSlide = e, f = a, i())
            }
            var a = u.indexOfSlide(e);
            void 0 === r && (r = a > u.getCurrentIndex() ? "next" : "prev"), e && e !== u.currentSlide && o()
        }, t.$on("$destroy", function() {
            p = !0
        }), u.getCurrentIndex = function() {
            return u.currentSlide && angular.isDefined(u.currentSlide.index) ? +u.currentSlide.index : f
        }, u.indexOfSlide = function(t) {
            return angular.isDefined(t.index) ? +t.index : c.indexOf(t)
        }, t.next = function() {
            var e = (u.getCurrentIndex() + 1) % c.length;
            if (!t.$currentTransition) return u.select(r(e), "next")
        }, t.prev = function() {
            var e = u.getCurrentIndex() - 1 < 0 ? c.length - 1 : u.getCurrentIndex() - 1;
            if (!t.$currentTransition) return u.select(r(e), "prev")
        }, t.isActive = function(t) {
            return u.currentSlide === t
        }, t.$watch("interval", i), t.$on("$destroy", o), t.play = function() {
            l || (l = !0, i())
        }, t.pause = function() {
            t.noPause || (l = !1, o())
        }, u.addSlide = function(e, n) {
            e.$element = n, c.push(e), 1 === c.length || e.active ? (u.select(c[c.length - 1]), 1 == c.length && t.play()) : e.active = !1
        }, u.removeSlide = function(t) {
            angular.isDefined(t.index) && c.sort(function(t, e) {
                return +t.index > +e.index
            });
            var e = c.indexOf(t);
            c.splice(e, 1), c.length > 0 && t.active ? e >= c.length ? u.select(c[e - 1]) : u.select(c[e]) : f > e && f--
        }
        ...
        return {
            beforeAddClass: function(e, n, r) {
                if ("active" == n && e.parent() && !e.parent().scope().noTransition) {
                    var i = !1,
                        o = e.isolateScope().direction,
                        a = "next" == o ? "left" : "right";
                    return e.addClass(o), t.addClass(e, a).then(function() {
                            i || e.removeClass(a + " " + o), r()
                        }),
                        function() {
                            i = !0
                        }
            ...
            beforeRemoveClass: function(e, n, r) {
                if ("active" == n && e.parent() && !e.parent().scope().noTransition) {
                    var i = !1,
                        o = e.isolateScope().direction,
                        a = "next" == o ? "left" : "right";
        ...
        function n(t) {
            var n = [],
                r = t.split("");
            return angular.forEach(o, function(e, i) {
                var o = t.indexOf(i);
                if (o > -1) {
                    t = t.split(""), r[o] = "(" + e.regex + ")", t[o] = "$";
                    for (var a = o + 1, s = o + i.length; a < s; a++) r[a] = "", t[a] = "$";
                    t = t.join(""), n.push({
                        index: o,
                        apply: e.apply
                    })
        ...
        function r(t, e, n) {
            return !(n < 1) && (1 === e && n > 28 ? 29 === n && (t % 4 === 0 && t % 100 !== 0 || t % 400 === 0) : 3 !== e && 5 !== e && 8 !== e && 10 !== e || n < 31)
        }
        var i = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
        this.parsers = {};
        var o = {
        ...
        this.parse = function(e, o, a) {
            if (!angular.isString(e) || !o) return e;
            o = t.DATETIME_FORMATS[o] || o, o = o.replace(i, "\\$&"), this.parsers[o] || (this.parsers[o] = n(o));
            ...
            if (c && c.length) {
                ...
                for (var d = 1, h = c.length; d < h; d++) {
                    var m = u[d - 1];
                    m.apply && m.apply.call(f, c[d])
                }
                return r(f.year, f.month, f.date) && (p = new Date(f.year, f.month, f.date, f.hours, f.minutes, f.seconds, f.milliseconds || 0)), p
            }
        }
        ...
        var i = function(e) {
            for (var n = t[0], i = e.offsetParent || n; i && i !== n && r(i);) i = i.offsetParent;
            return i || n
        };
        return {
            position: function(e) {
            ...
            offset: function(n) {
                ...
                return {
                    ...
                    top: r.top + (e.pageYOffset || t[0].documentElement.scrollTop),
                    left: r.left + (e.pageXOffset || t[0].documentElement.scrollLeft)
                }
            },
    ...
    }).controller("DatepickerController", ["$scope", "$attrs", "$parse", "$interpolate", "$timeout", "$log", "dateFilter", "datepickerConfig", function(t, e, n, r, i, o, a, s) {
        var l = this,
            u = {
        ...
        this.modes = ["day", "month", "year"], angular.forEach(["formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange", "shortcutPropagation"], function(n, i) {
            l[n] = angular.isDefined(e[n]) ? i < 8 ? r(e[n])(t.$parent) : t.$parent.$eval(e[n]) : s[n]
        }), angular.forEach(["minDate", "maxDate"], function(r) {
            e[r] ? t.$parent.$watch(n(e[r]), function(t) {
                l[r] = t ? new Date(t) : null, l.refreshView()
            ...
            t && (u.$isEmpty(u.$modelValue) || u.$invalid) && (l.activeDate = t, l.refreshView())
        })) : this.activeDate = new Date, t.isActive = function(e) {
            return 0 === l.compare(e.date, l.activeDate) && (t.activeDateId = e.uid, !0)
        }, this.init = function(t) {
            u = t, u.$render = function() {
                l.render()
            }
        }, this.render = function() {
            if (u.$viewValue) {
                var t = new Date(u.$viewValue),
                    e = !isNaN(t);
                e ? this.activeDate = t : o.error('Datepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.'), u.$setValidity("date", e)
            }
            this.refreshView()
        }, this.refreshView = function() {
            if (this.element) {
                this._refreshView();
                var t = u.$viewValue ? new Date(u.$viewValue) : null;
                u.$setValidity("date-disabled", !t || this.element && !this.isDisabled(t))
            }
            ...
            if (t.datepickerMode === l.minMode) {
                ...
                n.setFullYear(e.getFullYear(), e.getMonth(), e.getDate()), u.$setViewValue(n), u.$render()
            ...
            e = e || 1, t.datepickerMode === l.maxMode && 1 === e || t.datepickerMode === l.minMode && e === -1 || (t.datepickerMode = l.modes[l.modes.indexOf(t.datepickerMode) + e])
        }, t.keys = {
            13: "enter",
            32: "space",
            33: "pageup",
        ...
        t.$on("datepicker.focus", c), t.keydown = function(e) {
            ...
            if (n && !e.shiftKey && !e.altKey)
                if (e.preventDefault(), l.shortcutPropagation || e.stopPropagation(), "enter" === n || "space" === n) {
                    ...
                    t.select(l.activeDate), c()
                } else !e.ctrlKey || "up" !== n && "down" !== n ? (l.handleKeyDown(n, e), l.refreshView()) : (t.toggleMode("up" === n ? 1 : -1), c())
        }
            ...
            link: function(e, n, r, i) {
                ...
                function a(t, e) {
                    var n = new Array(e),
                        r = new Date(t),
                        i = 0;
                    for (r.setHours(12); i < e;) n[i++] = new Date(r), r.setDate(r.getDate() + 1);
                    return n
                }
                ...
                e.showWeeks = i.showWeeks, i.step = {
                    months: 1
                }, i.element = n;
                ...
                i._refreshView = function() {
                    var n = i.activeDate.getFullYear(),
                        ...
                        c = new Date(o);
                    u > 0 && c.setDate(-u + 1);
                    for (var f = a(c, 42), p = 0; p < 42; p++) f[p] = angular.extend(i.createDateObject(f[p], i.formatDay), {
                        secondary: f[p].getMonth() !== r,
                        uid: e.uniqueId + "-" + p
                    });
                    e.labels = new Array(7);
                    for (var d = 0; d < 7; d++) e.labels[d] = {
                        abbr: t(f[d].date, i.formatDayHeader),
                        full: t(f[d].date, "EEEE")
                    };
                    if (e.title = t(i.activeDate, i.formatDayTitle), e.rows = i.split(f, 7), e.showWeeks) {
                        e.weekNumbers = [];
                        for (var h = (11 - i.startingDay) % 7, m = e.rows.length, g = 0; g < m; g++) e.weekNumbers.push(s(e.rows[g][h].date))
                    }
                    ...
                    } else "home" === t ? e = 1 : "end" === t && (e = o(i.activeDate.getFullYear(), i.activeDate.getMonth()));
        ...
        return {
            ...
            link: function(t, e, n, r) {
                ...
                r.step = {
                    years: o
                }, r.element = e, r._refreshView = function() {
                    for (var e = new Array(o), n = 0, a = i(r.activeDate.getFullYear()); n < o; n++) e[n] = angular.extend(r.createDateObject(new Date(a + n, 0, 1), r.formatYear), {
                        uid: t.uniqueId + "-" + n
                    });
        ...
        appendToBody: !1,
        showButtonBar: !0
    }).directive("datepickerPopup", ["$compile", "$parse", "$document", "$position", "dateFilter", "dateParser", "datepickerPopupConfig", function(t, e, n, r, i, o, a) {
        return {
            restrict: "EA",
            require: "ngModel",
            scope: {
            ...
            link: function(s, l, u, c) {
                ...
                function p(t) {
                    angular.isNumber(t) && (t = new Date(t)); {
                        ...
                        if (angular.isString(t)) {
                            var e = o.parse(t, h, s.date) || new Date(t);
                ...
                var h, m = angular.isDefined(u.closeOnDateSelection) ? s.$parent.$eval(u.closeOnDateSelection) : a.closeOnDateSelection,
                    g = angular.isDefined(u.datepickerAppendToBody) ? s.$parent.$eval(u.datepickerAppendToBody) : a.appendToBody;
                s.showButtonBar = angular.isDefined(u.showButtonBar) ? s.$parent.$eval(u.showButtonBar) : a.showButtonBar, s.getText = function(t) {
                    return s[t + "Text"] || a[t + "Text"]
                };
                var v = !1;
                if (a.html5Types[u.type] ? (h = a.html5Types[u.type], v = !0) : (h = u.datepickerPopup || a.datepickerPopup, u.$observe("datepickerPopup", function(t) {
                        var e = t || a.datepickerPopup;
                        if (e !== h && (h = e, c.$modelValue = null, !h)) throw new Error("datepickerPopup must have a date format specified.")
                ...
                var $ = angular.element(y.children()[0]);
                if (v && "month" == u.type && ($.attr("datepicker-mode", '"month"'), $.attr("min-mode", "month")), u.datepickerOptions) {
                    var b = s.$parent.$eval(u.datepickerOptions);
                    b.initDate && (s.initDate = b.initDate, $.attr("init-date", "initDate"), delete b.initDate), angular.forEach(b, function(t, e) {
                        $.attr(f(e), t)
                    })
                }
                s.watchData = {}, angular.forEach(["minDate", "maxDate", "datepickerMode", "initDate", "shortcutPropagation"], function(t) {
                    if (u[t]) {
                        ...
                        if (s.$parent.$watch(n, function(e) {
                                s.watchData[t] = e
                            }), $.attr(f(t), "watchData." + t), "datepickerMode" === t) {
                            var r = n.assign;
                ...
                }), u.dateDisabled && $.attr("date-disabled", "dateDisabled({ date: date, mode: mode })"), u.showWeeks && $.attr("show-weeks", u.showWeeks), u.customClass && $.attr("custom-class", "customClass({ date: date, mode: mode })"), v ? c.$formatters.push(function(t) {
                    return s.date = t, t
                }) : (c.$$parserName = "date", c.$validators.date = d, c.$parsers.unshift(p), c.$formatters.push(function(t) {
                    return s.date = t, c.$isEmpty(t) ? t : i(t, h)
                })), s.dateSelection = function(t) {
                    angular.isDefined(t) && (s.date = t);
                    var e = s.date ? i(s.date, h) : "";
                    l.val(e), c.$setViewValue(e), m && (s.isOpen = !1, l[0].focus())
                ...
                l.bind("keydown", x), s.keydown = function(t) {
                    ...
                    t ? (s.$broadcast("datepicker.focus"), s.position = g ? r.offset(l) : r.position(l), s.position.top = s.position.top + l.prop("offsetHeight"), n.bind("click", w)) : n.unbind("click", w)
                }), s.select = function(t) {
                    if ("today" === t) {
                        var e = new Date;
                ...
                y.remove(), g ? n.find("body").append(k) : l.after(k), s.$on("$destroy", function() {
                    k.remove(), l.unbind("keydown", x), n.unbind("click", w)
                })
            }
        }
        ...
        this.open = function(e) {
            n || (t.bind("click", r), t.bind("keydown", i)), n && n !== e && (n.isOpen = !1), n = e
        }, this.close = function(e) {
            n === e && (n = null, t.unbind("click", r), t.unbind("keydown", i))
        };
        var r = function(t) {
                if (n && (!t || "disabled" !== n.getAutoClose())) {
                    var r = n.getToggleElement();
                    if (!(t && r && r[0].contains(t.target))) {
                        var i = n.getElement();
                        t && "outsideClick" === n.getAutoClose() && i && i[0].contains(t.target) || (n.isOpen = !1, e.$$phase || n.$apply())
                    }
                }
            },
            i = function(t) {
                27 === t.which && (n.focusToggleElement(), r())
            }
    }]).controller("DropdownController", ["$scope", "$attrs", "$parse", "dropdownConfig", "dropdownService", "$animate", "$position", "$document", function(t, e, n, r, i, o, a, s) {
        var l, u = this,
            c = t.$new(),
            f = r.openClass,
            p = angular.noop,
            d = e.onToggle ? n(e.onToggle) : angular.noop,
            h = !1;
        this.init = function(r) {
            u.$element = r, e.isOpen && (l = n(e.isOpen), p = l.assign, t.$watch(l, function(t) {
                c.isOpen = !!t
            })), h = angular.isDefined(e.dropdownAppendToBody), h && u.dropdownMenu && (s.find("body").append(u.dropdownMenu), r.on("$destroy", function() {
                u.dropdownMenu.remove()
            }))
        }, this.toggle = function(t) {
            return c.isOpen = arguments.length ? !!t : !c.isOpen
        ...
        }, c.$watch("isOpen", function(e, n) {
            if (h && u.dropdownMenu) {
                var r = a.positionElements(u.$element, u.dropdownMenu, "bottom-left", !0);
                u.dropdownMenu.css({
                    top: r.top + "px",
                    left: r.left + "px",
            ...
            o[e ? "addClass" : "removeClass"](u.$element, f), e ? (c.focusToggleElement(), i.open(c)) : i.close(c), p(t, e), angular.isDefined(e) && e !== n && d(t, {
                open: !!e
            })
        ...
        return {
            ...
            link: function(n, r, i) {
                r.addClass(i.windowClass || ""), n.size = i.size, n.close = function(e) {
                    var n = t.getTop();
                ...
                var o = e.defer();
                i.$observe("modalRender", function(t) {
                    "true" == t && o.resolve()
                }), o.promise.then(function() {
                    n.animate = !0;
                    var e = r[0].querySelectorAll("[autofocus]");
                    e.length ? e[0].focus() : r[0].focus();
                    var i = t.getTop();
                    i && t.modalRendered(i.key)
                })
            }
        }
    ...
    }).factory("$modalStack", ["$animate", "$timeout", "$document", "$compile", "$rootScope", "$$stackedMap", function(t, e, n, r, i, o) {
        function a() {
        ...
        function s(t) {
            var e = n.find("body").eq(0),
                r = h.get(t).value;
            h.remove(t), u(r.modalDomEl, r.modalScope, function() {
                e.toggleClass(d, h.length() > 0), l()
            })
        }
        ...
        function u(n, r, o) {
            ...
            r.animate = !1, n.attr("modal-animation") && t.enabled() ? n.one("$animate:close", function() {
                i.$evalAsync(a)
            }) : e(a)
        }
        ...
        return i.$watch(a, function(t) {
            ...
            var e;
            27 === t.which && (e = h.top(), e && e.value.keyboard && (t.preventDefault(), i.$apply(function() {
            ...
            if (l >= 0 && !f) {
                ...
                u.attr("backdrop-class", e.backdropClass), e.animation && u.attr("modal-animation", "true"), f = r(u)(p), s.append(f)
            }
            ...
            c.attr({
                ...
                index: h.length() - 1,
                animate: "animate"
            }).html(e.content), e.animation && c.attr("modal-animation", "true");
            var m = r(c)(e.scope);
            h.top().value.modalDomEl = m, h.top().value.modalOpener = o, s.append(m), s.addClass(d)
        }, m.close = function(t, e) {
            var n = h.get(t);
            return n && c(n, e, !0) ? (n.value.deferred.resolve(e),
                s(t), n.value.modalOpener.focus(), !0) : !n
        }, m.dismiss = function(t, e) {
            var n = h.get(t);
            return n && c(n, e, !1) ? (n.value.deferred.reject(e), s(t), n.value.modalOpener.focus(), !0) : !n
        ...
        var t = {
            ...
            $get: ["$injector", "$rootScope", "$q", "$templateRequest", "$controller", "$modalStack", function(e, n, r, i, o, a) {
                function s(t) {
                    return t.template ? r.when(t.template) : i(angular.isFunction(t.templateUrl) ? t.templateUrl() : t.templateUrl)
                }
                ...
                return u.open = function(e) {
                    ...
                    var p = r.all([s(e)].concat(l(e.resolve)));
                    return p.then(function(t) {
                        var r = (e.scope || n).$new();
                        r.$close = f.close, r.$dismiss = f.dismiss;
                        var s, l = {},
                            u = 1;
                        e.controller && (l.$scope = r, l.$modalInstance = f, angular.forEach(e.resolve, function(e, n) {
                            l[n] = t[u++]
                        }), s = o(e.controller, l), e.controllerAs && (r[e.controllerAs] = s)), a.open(f, {
                            scope: r,
                            deferred: i,
                            renderDeferred: c,
                            content: t[0],
        ...
        var r = this,
            ...
            o = e.numPages ? n(e.numPages).assign : angular.noop;
        this.init = function(a, s) {
            ...
            t.page !== e && e > 0 && e <= t.totalPages && (n && n.target && n.target.blur(), i.$setViewValue(e), i.$render())
        ...
        return {
            ...
            link: function(n, r, i, o) {
                ...
                var l = o[0],
                    u = o[1];
                if (u) {
                    var c = angular.isDefined(i.maxSize) ? n.$parent.$eval(i.maxSize) : e.maxSize,
                        f = angular.isDefined(i.rotate) ? n.$parent.$eval(i.rotate) : e.rotate;
                    n.boundaryLinks = angular.isDefined(i.boundaryLinks) ? n.$parent.$eval(i.boundaryLinks) : e.boundaryLinks, n.directionLinks = angular.isDefined(i.directionLinks) ? n.$parent.$eval(i.directionLinks) : e.directionLinks, l.init(u, e), i.maxSize && n.$parent.$watch(t(i.maxSize), function(t) {
                        c = parseInt(t, 10), l.render()
                    });
                    var p = l.render;
                    l.render = function() {
        ...
        this.options = function(t) {
            ...
            angular.extend(n, t)
        }, this.$get = ["$window", "$compile", "$timeout", "$document", "$position", "$interpolate", function(i, o, a, s, l, u) {
            return function(i, c, f, p) {
                ...
                p = angular.extend({}, e, r, p);
                var h = t(i),
                    m = u.startSymbol(),
                    g = u.endSymbol(),
                    v = "<div " + h + '-popup title="' + m + "title" + g + '" ' + (p.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + m + "content" + g + '" ') + 'placement="' + m + "placement" + g + '" popup-class="' + m + "popupClass" + g + '" animation="animation" is-open="isOpen"origin-scope="origScope" ></div>';
                return {
                    restrict: "EA",
                    compile: function() {
                        var t = o(v);
                        return function(e, n, r) {
                            ...
                            function u() {
                                A && !e.$eval(r[c + "Enable"]) || (y(), D.popupDelay ? E || (E = a(h, D.popupDelay, !1), E.then(function(t) {
                                    t()
                                })) : h()())
                            }
                            ...
                            function h() {
                                return E = null, T && (a.cancel(T), T = null), (p.useContentExp ? D.contentExp() : D.content) ? (g(), k.css({
                                    top: 0,
                                    left: 0,
                                    display: "block"
                                }), D.$digest(), O(), D.isOpen = !0, D.$apply(), O) : angular.noop
                            }

                            function m() {
                                D.isOpen = !1, a.cancel(E), E = null, D.animation ? T || (T = a(v, 500)) : v()
                            }

                            function g() {
                                k && v(), C = D.$new(), k = t(C, function(t) {
                                    S ? s.find("body").append(t) : n.after(t)
                                }), C.$watch(function() {
                                    a(O, 0, !1)
                                }), p.useContentExp && C.$watch("contentExp()", function(t) {
                                    !t && D.isOpen && m()
                                })
                            }

                            function v() {
                                T = null, k && (k.remove(), k = null), C && (C.$destroy(), C = null)
                            }
                            ...
                            function $() {
                                D.popupClass = r[c + "Class"]
                            }

                            function b() {
                                var t = r[c + "Placement"];
                                D.placement = angular.isDefined(t) ? t : p.placement
                            }

                            function w() {
                                var t = r[c + "PopupDelay"],
                                    e = parseInt(t, 10);
                                D.popupDelay = isNaN(e) ? p.popupDelay : e
                            }

                            function x() {
                                var t = r[c + "Trigger"];
                                M(), _ = d(t), _.show === _.hide ? n.bind(_.show, o) : (n.bind(_.show, u), n.bind(_.hide, f))
                            }
                            var k, C, T, E, S = !!angular.isDefined(p.appendToBody) && p.appendToBody,
                                _ = d(void 0),
                                A = angular.isDefined(r[c + "Enable"]),
                                D = e.$new(!0),
                                O = function() {
                                    if (k) {
                                        var t = l.positionElements(n, k, D.placement, S);
                                        t.top += "px", t.left += "px", k.css(t)
                                    }
                                };
                            D.origScope = e, D.isOpen = !1, D.contentExp = function() {
                                return e.$eval(r[i])
                            }, p.useContentExp || r.$observe(i, function(t) {
                                D.content = t, !t && D.isOpen && m()
                            ...
                            var M = function() {
                                n.unbind(_.show, u), n.unbind(_.hide, f)
                            };
                            x();
                            var N = e.$eval(r[c + "Animation"]);
                            D.animation = angular.isDefined(N) ? !!N : p.animation;
                            var j = e.$eval(r[c + "AppendToBody"]);
                            S = angular.isDefined(j) ? j : S, S && e.$on("$locationChangeSuccess", function() {
                                D.isOpen && m()
                            }), e.$on("$destroy", function() {
                                a.cancel(T), a.cancel(E), M(), v(), D = null
                            })
                        }
                    }
                }
    ...
    }).directive("tooltipTemplateTransclude", ["$animate", "$sce", "$compile", "$templateRequest", function(t, e, n, r) {
        return {
            link: function(i, o, a) {
                ...
                i.$watch(e.parseAsResourceUrl(a.tooltipTemplateTransclude), function(e) {
                    ...
                    e ? (r(e, !0).then(function(r) {
                        if (a === f) {
                            ...
                            s = i, u = d, s.$emit("$includeContentLoaded", e)
                        }
                    }, function() {
                        a === f && (p(), i.$emit("$includeContentError", e))
                    }), i.$emit("$includeContentRequested", e)) : p()
                }), i.$on("$destroy", p)
            }
        }
        ...
        var r = this,
            i = angular.isDefined(e.animate) ? t.$parent.$eval(e.animate) : n.animate;
        ...
        this.init = function(i) {
            r = i, r.$render = this.render, r.$formatters.push(function(t) {
            ...
            for (var e = 0, n = t.length; e < n; e++) t[e] = angular.extend({
                index: e
            }, {
        ...
        return {
            ...
            link: function(t, e, n) {
                t.vertical = !!angular.isDefined(n.vertical) && t.$parent.$eval(n.vertical), t.justified = !!angular.isDefined(n.justified) && t.$parent.$eval(n.justified)
            }
        }
            ...
            compile: function(n, r, i) {
                return function(n, r, o, a) {
                    n.$watch("active", function(t) {
                        t && a.select(n)
                    }), n.disabled = !1, o.disable && n.$parent.$watch(t(o.disable), function(t) {
                        n.disabled = !!t
                    }), o.disabled && (e.warn('Use of "disabled" attribute has been deprecated, please use "disable"'), n.$parent.$watch(t(o.disabled), function(t) {
                        n.disabled = !!t
                    })), n.select = function() {
        ...
        mousewheel: !0,
        arrowkeys: !0
    }).controller("TimepickerController", ["$scope", "$attrs", "$parse", "$log", "$locale", "timepickerConfig", function(t, e, n, r, i, o) {
        function a() {
            var e = parseInt(t.hours, 10),
                n = t.showMeridian ? e > 0 && e < 13 : e >= 0 && e < 24;
            if (n) return t.showMeridian && (12 === e && (e = 0), t.meridian === m[1] && (e += 12)), e
        }

        function s() {
            var e = parseInt(t.minutes, 10);
            return e >= 0 && e < 60 ? e : void 0
        }
        ...
        function u(t) {
            c(), h.$setViewValue(new Date(d)), f(t)
        }
        ...
        function f(e) {
            var n = d.getHours(),
                r = d.getMinutes();
            t.showMeridian && (n = 0 === n || 12 === n ? 12 : n % 12), t.hours = "h" === e ? n : l(n), "m" !== e && (t.minutes = l(r)), t.meridian = d.getHours() < 12 ? m[0] : m[1]
        }

        function p(t) {
            var e = new Date(d.getTime() + 6e4 * t);
            d.setHours(e.getHours(), e.getMinutes()), u()
        }
        var d = new Date,
            h = {
                $setViewValue: angular.noop
            },
            m = angular.isDefined(e.meridians) ? t.$parent.$eval(e.meridians) : o.meridians || i.DATETIME_FORMATS.AMPMS;
        this.init = function(n, r) {
            ...
            var l = angular.isDefined(e.arrowkeys) ? t.$parent.$eval(e.arrowkeys) : o.arrowkeys;
            l && this.setupArrowkeyEvents(i, a), t.readonlyInput = angular.isDefined(e.readonlyInput) ? t.$parent.$eval(e.readonlyInput) : o.readonlyInput, this.setupInputEvents(i, a)
        };
        var g = o.hourStep;
        ...
        e.minuteStep && t.$parent.$watch(n(e.minuteStep), function(t) {
            ...
            if (t.showMeridian = !!e, h.$error.time) {
                var n = a(),
                    r = s();
                angular.isDefined(n) && angular.isDefined(r) && (d.setHours(n), u())
            } else f()
            ...
            t.updateHours = function() {
                var t = a();
                angular.isDefined(t) ? (d.setHours(t), u("h")) : r(!0)
                ...
                var t = s();
                angular.isDefined(t) ? (d.setMinutes(t), u("m")) : r(void 0, !0)
            ...
            var t = h.$viewValue;
            isNaN(t) ? (h.$setValidity("time", !1), r.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')) : (t && (d = t), c(), f())
    ...
    }), angular.module("ui.bootstrap.transition", []).value("$transitionSuppressDeprecated", !1).factory("$transition", ["$q", "$timeout", "$rootScope", "$log", "$transitionSuppressDeprecated", function(t, e, n, r, i) {
        function o(t) {
            for (var e in t)
        ...
        var a = function(r, i, o) {
                ...
                return l && r.bind(l, u), e(function() {
        ...
        return {
            require: "ngModel",
            link: function(l, u, c, f) {
                var p, d = l.$eval(c.typeaheadMinLength) || 1,
                    h = l.$eval(c.typeaheadWaitMs) || 0,
                    m = l.$eval(c.typeaheadEditable) !== !1,
                    g = e(c.typeaheadLoading).assign || angular.noop,
                    v = e(c.typeaheadOnSelect),
                    y = c.typeaheadInputFormatter ? e(c.typeaheadInputFormatter) : void 0,
                    $ = !!c.typeaheadAppendToBody && l.$eval(c.typeaheadAppendToBody),
                    b = l.$eval(c.typeaheadFocusFirst) !== !1,
                    w = e(c.ngModel).assign,
                    x = a.parse(c.typeahead),
                    k = l.$new();
                ...
                k.$watch("activeIdx", function(t) {
                    t < 0 ? u.removeAttr("aria-activedescendant") : u.attr("aria-activedescendant", S(t))
                });
                var _ = function(t) {
                    var e = {
                        $viewValue: t
                    ...
                    g(l, !0), n.when(x.source(l, e)).then(function(n) {
                        ...
                        if (r && p)
                            if (n && n.length > 0) {
                                ...
                                for (var i = 0; i < n.length; i++) e[x.itemName] = n[i], k.matches.push({
                                    id: S(i),
                                    label: x.viewMapper(k, e),
                                    model: n[i]
                                });
                                k.query = t, k.position = $ ? o.offset(u) : o.position(u), k.position.top = k.position.top + u.prop("offsetHeight"), u.attr("aria-expanded", !0)
                            } else E();
                        r && g(l, !1)
                    }, function() {
                        E(), g(l, !1)
                ...
                f.$parsers.unshift(function(t) {
                    return p = !0, t && t.length >= d ? h > 0 ? (O(), D(t)) : _(t) : (g(l, !1), O(), E()), m ? t : t ? void f.$setValidity("editable", !1) : (f.$setValidity("editable", !0), t)
                }), f.$formatters.push(function(t) {
                    var e, n, r = {};
                    return m || f.$setValidity("editable", !0), y ? (r.$model = t, y(l, r)) : (r[x.itemName] = t, e = x.viewMapper(l, r), r[x.itemName] = void 0, n = x.viewMapper(l, r), e !== n ? e : t)
                }), k.select = function(t) {
                    var e, n, i = {};
                    i[x.itemName] = n = k.matches[t].model, e = x.modelMapper(l, i), w(l, e), f.$setValidity("editable", !0), f.$setValidity("parse", !0), v(l, {
                        $item: n,
                        $model: e,
                ...
                }, u.bind("keydown", function(t) {
                    0 !== k.matches.length && s.indexOf(t.which) !== -1 && (k.activeIdx != -1 || 13 !== t.which && 9 !== t.which) && (t.preventDefault(), 40 === t.which ? (k.activeIdx = (k.activeIdx + 1) % k.matches.length, k.$digest()) : 38 === t.which ? (k.activeIdx = (k.activeIdx > 0 ? k.activeIdx : k.matches.length) - 1, k.$digest()) : 13 === t.which || 9 === t.which ? k.$apply(function() {
                        k.select(k.activeIdx)
                    }) : 27 === t.which && (t.stopPropagation(), E(), k.$digest()))
                }), u.bind("blur", function() {
                    p = !1
                });
                var M = function(t) {
                    u[0] !== t.target && (E(), k.$digest())
                };
                i.bind("click", M), l.$on("$destroy", function() {
                    i.unbind("click", M), $ && N.remove(), T.remove()
                });
                var N = t(T)(k);
                $ ? i.find("body").append(N) : u.after(N)
            }
        }
    ...
    function() {
        ...
        function e(t, e, n, r) {
            var i, o, a = Math.pow(10, e);
            return o = (n(t * a) / a).toFixed(e), r && (i = new RegExp("0{1," + r + "}$"), o = o.replace(i, "")), o
        }

        function n(t, e, n) {
            var r;
            return r = e.indexOf("$") > -1 ? i(t, e, n) : e.indexOf("%") > -1 ? o(t, e, n) : e.indexOf(":") > -1 ? a(t, e) : l(t._value, e, n)
        }
        ...
        function r(t, e) {
            var n, r, i, o, a, l = e,
                ...
                c = !1;
            if (e.indexOf(":") > -1) t._value = s(e);
            else if (e === g) t._value = 0;
            else {
                for ("." !== h[m].delimiters.decimal && (e = e.replace(/\./g, "").replace(h[m].delimiters.decimal, ".")), n = new RegExp("[^a-zA-Z]" + h[m].abbreviations.thousand + "(?:\\)|(\\" + h[m].currency.symbol + ")?(?:\\))?)?$"), r = new RegExp("[^a-zA-Z]" + h[m].abbreviations.million + "(?:\\)|(\\" + h[m].currency.symbol + ")?(?:\\))?)?$"), i = new RegExp("[^a-zA-Z]" + h[m].abbreviations.billion + "(?:\\)|(\\" + h[m].currency.symbol + ")?(?:\\))?)?$"), o = new RegExp("[^a-zA-Z]" + h[m].abbreviations.trillion + "(?:\\)|(\\" + h[m].currency.symbol + ")?(?:\\))?)?$"), a = 0; a <= u.length && !(c = e.indexOf(u[a]) > -1 && Math.pow(1024, a + 1)); a++);
                t._value = (c ? c : 1) * (l.match(n) ? Math.pow(10, 3) : 1) * (l.match(r) ? Math.pow(10, 6) : 1) * (l.match(i) ? Math.pow(10, 9) : 1) * (l.match(o) ? Math.pow(10, 12) : 1) * (e.indexOf("%") > -1 ? .01 : 1) * ((e.split("-").length + Math.min(e.split("(").length - 1, e.split(")").length - 1)) % 2 ? 1 : -1) * Number(e.replace(/[^0-9\.]+/g, "")), t._value = c ? Math.ceil(t._value) : t._value
            }
            return t._value
        }
        ...
        function i(t, e, n) {
            var r, i, o = e.indexOf("$"),
                ...
                s = e.indexOf("-"),
                u = "";
            return e.indexOf(" $") > -1 ? (u = " ", e = e.replace(" $", "")) : e.indexOf("$ ") > -1 ? (u = " ", e = e.replace("$ ", "")) : e = e.replace("$", ""), i = l(t._value, e, n), o <= 1 ? i.indexOf("(") > -1 || i.indexOf("-") > -1 ? (i = i.split(""), r = 1, (o < a || o < s) && (r = 0), i.splice(r, 0, h[m].currency.symbol + u), i = i.join("")) : i = h[m].currency.symbol + u + i : i.indexOf(")") > -1 ? (i = i.split(""), i.splice(-1, 0, u + h[m].currency.symbol), i = i.join("")) : i = i + u + h[m].currency.symbol, i
        }

        function o(t, e, n) {
            var r, i = "",
                o = 100 * t._value;
            return e.indexOf(" %") > -1 ? (i = " ", e = e.replace(" %", "")) : e = e.replace("%", ""), r = l(o, e, n), r.indexOf(")") > -1 ? (r = r.split(""), r.splice(-1, 0, i + "%"), r = r.join("")) : r = r + i + "%", r
        }

        function a(t) {
            var e = Math.floor(t._value / 60 / 60),
                n = Math.floor((t._value - 60 * e * 60) / 60),
                r = Math.round(t._value - 60 * e * 60 - 60 * n);
            return e + ":" + (n < 10 ? "0" + n : n) + ":" + (r < 10 ? "0" + r : r)
        }
        ...
        function l(t, n, r) {
            ...
            if (n.indexOf("(") > -1 ? (c = !0, n = n.slice(1, -1)) : n.indexOf("+") > -1 && (f = !0, n = n.replace(/\+/g, "")), n.indexOf("a") > -1 && (v = n.indexOf("aK") >= 0, y = n.indexOf("aM") >= 0, $ = n.indexOf("aB") >= 0, b = n.indexOf("aT") >= 0, w = v || y || $ || b, n.indexOf(" a") > -1 ? (d = " ", n = n.replace(" a", "")) : n = n.replace("a", ""), C >= Math.pow(10, 12) && !w || b ? (d += h[m].abbreviations.trillion, t /= Math.pow(10, 12)) : C < Math.pow(10, 12) && C >= Math.pow(10, 9) && !w || $ ? (d += h[m].abbreviations.billion, t /= Math.pow(10, 9)) : C < Math.pow(10, 9) && C >= Math.pow(10, 6) && !w || y ? (d += h[m].abbreviations.million, t /= Math.pow(10, 6)) : (C < Math.pow(10, 6) && C >= Math.pow(10, 3) && !w || v) && (d += h[m].abbreviations.thousand, t /= Math.pow(10, 3))), n.indexOf("b") > -1)
                for (n.indexOf(" b") > -1 ? (x = " ", n = n.replace(" b", "")) : n = n.replace("b", ""), a = 0; a <= T.length; a++)
                    if (i = Math.pow(1024, a), o = Math.pow(1024, a + 1), t >= i && t < o) {
                        x += T[a], i > 0 && (t /= i);
                        break
                    }
            return n.indexOf("o") > -1 && (n.indexOf(" o") > -1 ? (k = " ", n = n.replace(" o", "")) : n = n.replace("o", ""), k += h[m].ordinal(t)), n.indexOf("[.]") > -1 && (p = !0, n = n.replace("[.]", ".")), s = t.toString().split(".")[0], l = n.split(".")[1], u = n.indexOf(","), l ? (l.indexOf("[") > -1 ? (l = l.replace("]", ""), l = l.split("["), E = e(t, l[0].length + l[1].length, r, l[1].length)) : E = e(t, l.length, r), s = E.split(".")[0], E = E.split(".")[1].length ? h[m].delimiters.decimal + E.split(".")[1] : "", p && 0 === Number(E.slice(1)) && (E = "")) : s = e(t, null, r), s.indexOf("-") > -1 && (s = s.slice(1), S = !0), u > -1 && (s = s.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + h[m].delimiters.thousands)), 0 === n.indexOf(".") && (s = ""), (c && S ? "(" : "") + (!c && S ? "-" : "") + (!S && f ? "+" : "") + s + E + (k ? k : "") + (d ? d : "") + (x ? x : "") + (c && S ? ")" : "")
        }
        ...
        p = function(e) {
        ...
        }, p.version = d, p.isNumeral = function(e) {
            return e instanceof t
        }, p.language = function(t, e) {
            if (!t) return m;
            if (t && !e) {
                if (!h[t]) throw new Error("Unknown language : " + t);
                m = t
            }
            return !e && h[t] || u(t, e), p
        }, p.languageData = function(t) {
            if (!t) return h[m];
            if (!h[t]) throw new Error("Unknown language : " + t);
            return h[t]
        }, p.language("en", {
        ...
        }), p.zeroFormat = function(t) {
            g = "string" == typeof t ? t : null
        }, p.defaultFormat = function(t) {
            ...
            var n, r, i = this.length >>> 0,
                o = !1;
            for (1 < arguments.length && (r = e, o = !0), n = 0; i > n; ++n) this.hasOwnProperty(n) && (o ? r = t(r, this[n], n, this) : (r = this[n], o = !0));
            ...
            unformat: function(t) {
                return "[object Number]" === Object.prototype.toString.call(t) ? t : r(this, t ? t : v)
            },
            value: function() {
                return this._value
            },
            ...
            difference: function(t) {
                return Math.abs(p(this._value).subtract(t).value())
            }
        }, y && (module.exports = p), "undefined" == typeof ender && (this.numeral = p), "function" == typeof define && define.amd && define([], function() {
            return p
        })
    }.call(this), angular.module("ngNumeraljs", []).provider("$numeraljsConfig", function() {
        var t = {};
        this.setFormat = function(e, n) {
            t[e] = n
        }, this.setDefaultFormat = function(t) {
            numeral.defaultFormat(t)
        }, this.setLanguage = function(t, e) {
            numeral.language(t, e)
    ...
    }).filter("numeraljs", ["$numeraljsConfig", function(t) {
        return function(e, n) {
            return null == e ? e : (n = t.customFormat(n), numeral(e).format(n))
        }
    }]),
    function() {
        function t(t, e) {
        ...
        function l(e, n, r) {
            for (var i = -1, o = e.criteria, a = n.criteria, s = o.length, l = r.length; ++i < s;) {
                var u = t(o[i], a[i]);
                if (u) {
                    if (i >= l) return u;
                    var c = r[i];
        ...
        function w(m) {
            ...
            function Bt() {
                var t = this.__wrapped__.value(),
                    ...
                    f = c.length,
                    p = 0,
                    d = ka(l, this.__takeCount__);
                if (!n || i < P || i == l && d == l) return nn(t, this.__actions__);
                var h = [];
                t: for (; l-- && p < d;) {
                    u += e;
            ...
            function Jt(t, e) {
                var n = t.data,
                    r = "string" == typeof e || ji(e) ? n.set.has(e) : n.hash[e];
                return r ? 0 : -1
            }

            function Qt(t) {
                var e = this.data;
                "string" == typeof t || ji(t) ? e.set.add(t) : e.hash[t] = !0
            }
            ...
            function ge(t, e, n) {
                for (var r = -1, i = qs(e), o = i.length; ++r < o;) {
                    var a = i[r],
                        s = t[a],
                        l = n(s, e[a], a, t, e);
                    (l === l ? l === s : s !== s) && (s !== x || a in t) || (t[a] = l)
                }
                return t
            }

            function ve(t, e) {
                return null == e ? t : $e(e, qs(e), t)
            }

            function ye(t, e) {
                for (var n = -1, r = null == t, i = !r && Jn(t), o = i ? t.length : 0, a = e.length, s = Ho(a); ++n < a;) {
                    var l = e[n];
                    i ? s[n] = Qn(l, o) ? t[l] : x : s[n] = r ? x : t[l]
                }
                return s
            }
            ...
            function be(t, e, n) {
                var r = typeof t;
                return "function" == r ? e === x ? t : an(t, e, n) : null == t ? _o : "object" == r ? Fe(t) : e === x ? jo(t) : qe(t, e)
            }

            function we(t, e, n, r, i, o, a) {
                var s;
                if (n && (s = i ? n(t, r, i) : n(t)), s !== x) return s;
                if (!ji(t)) return t;
                var l = As(t);
                if (l) {
                    ...
                    var u = ra.call(t),
                        c = u == Y;
                    if (u != K && u != V && (!c || i)) return qt[u] ? Xn(t, u, e) : i ? t : {};
                    if (s = Gn(c ? {} : t), !e) return ve(s, t)
                }
                o || (o = []), a || (a = []);
                for (var f = o.length; f--;)
                    if (o[f] == t) return a[f];
                return o.push(t), a.push(s), (l ? re : Oe)(t, function(r, i) {
                    s[i] = we(r, e, n, i, t, o, a)
                }), s
            }

            function xe(t, e, n) {
                if ("function" != typeof t) throw new Ko(q);
                return pa(function() {
                    t.apply(x, n)
                }, e)
            }
            ...
            function Ee(t, e, n, r) {
                var i = t.length;
                for (n = null == n ? 0 : +n || 0, n < 0 && (n = -n > i ? 0 : i + n), r = r === x || r > i ? i : +r || 0, r < 0 && (r += i), i = n > r ? 0 : r >>> 0, n >>>= 0; n < i;) t[n++] = e;
                return t
            }
            ...
            function Ae(t, e, n, r) {
                ...
                for (var i = -1, o = t.length; ++i < o;) {
                    var a = t[i];
                    h(a) && Jn(a) && (n || As(a) || Ti(a)) ? e ? Ae(a, e, n, r) : ue(r, a) : n || (r[r.length] = a)
                }
                return r
            }
            ...
            function Ie(t, e, n, r, i, o) {
                return t === e || (null == t || null == e || !ji(t) && !h(e) ? t !== t && e !== e : Re(t, e, Ie, n, r, i, o))
            }
            ...
            function Re(t, e, n, r, i, o, a) {
                var s = As(t),
                    ...
                    u = U,
                    c = U;
                s || (u = ra.call(t), u == V ? u = K : u != K && (s = Ui(t))), l || (c = ra.call(e), c == V ? c = K : c != K && (l = Ui(e)));
                var f = u == K,
                    p = c == K,
                    d = u == c;
                if (d && !s && !f) return Fn(t, e, u);
                if (!i) {
                    var h = f && ea.call(t, "__wrapped__"),
                        m = p && ea.call(e, "__wrapped__");
                    if (h || m) return n(h ? t.value() : t, m ? e.value() : e, r, i, o, a)
                }
                if (!d) return !1;
                o || (o = []), a || (a = []);
            ...
            function Pe(t, e, n) {
                ...
                for (; ++r < i;) {
                    ...
                    var s = a[0],
                        ...
                        u = a[1];
                    if (o && a[2]) {
                        if (l === x && !(s in t)) return !1
                    } else {
                        var c = n ? n(l, u, s) : x;
                        if (!(c === x ? Ie(u, l, n, !0) : c)) return !1
                    }
                }
                return !0
            }
            ...
            function Fe(t) {
                ...
                if (1 == e.length && e[0][2]) {
                    var n = e[0][0],
                        r = e[0][1];
                    return function(t) {
                        return null != t && (t[n] === r && (r !== x || n in fr(t)))
                    }
                }
                return function(t) {
                    return Pe(t, e)
                ...
                return t = pr(t),
                    function(o) {
                        ...
                        if (o = fr(o), (n || !r) && !(a in o)) {
                            if (o = 1 == t.length ? o : je(o, Ge(t, 0, -1)), null == o) return !1;
                            a = Er(t), o = fr(o)
                        }
                        return o[a] === e ? e !== x || a in o : Ie(e, o[a], x, !0)
                    }
            }

            function He(t, e, n, r, i) {
                if (!ji(t)) return t;
                var o = Jn(e) && (As(e) || Ui(e)),
                    a = o ? x : qs(e);
                return re(a || e, function(s, l) {
                    if (a && (l = s, s = e[l]), h(s)) r || (r = []), i || (i = []), Ve(t, e, l, He, n, r, i);
                    else {
                        var u = t[l],
                            c = n ? n(u, s, l, t, e) : x,
                            f = c === x;
                        f && (c = s), c === x && (!o || l in t) || !f && (c === c ? c === u : u !== u) || (t[l] = c)
                    }
                }), t
            }
            ...
            function Ve(t, e, n, r, i, o, a) {
                ...
                var u = t[n],
                    c = i ? i(u, l, n, t, e) : x,
                    f = c === x;
                f && (c = l, Jn(l) && (As(l) || Ui(l)) ? c = As(u) ? u : Jn(u) ? ne(u) : [] : qi(l) || Ti(l) ? c = Ti(u) ? Gi(u) : qi(u) ? u : {} : f = !1), o.push(l), a.push(c), f ? t[n] = r(c, l, i, o, a) : (c === c ? c !== u : u === u) && (t[n] = c)
            }
            ...
            function Ge(t, e, n) {
                var r = -1,
                    i = t.length;
                e = null == e ? 0 : +e || 0, e < 0 && (e = -e > i ? 0 : i + e), n = n === x || n > i ? i : +n || 0, n < 0 && (n += i), i = e > n ? 0 : n - e >>> 0, e >>>= 0;
                ...
                t: for (; ++r < o;) {
                    ...
                    if (a && c === c) {
                        for (var p = l.length; p--;)
                            if (l[p] === f) continue t;
                        e && l.push(f), u.push(c)
                    } else i(l, f, 0) < 0 && ((e || s) && l.push(f), u.push(c))
                }
                return u
            }
            ...
            function on(t, e, n, r) {
                e = n(e);
                for (var i = 0, o = t ? t.length : 0, a = e !== e, s = null === e, l = e === x; i < o;) {
                    var u = ya((i + o) / 2),
                        c = n(t[u]),
                        f = c !== x,
                        p = c === c;
                    if (a) var d = p || r;
                    else d = s ? p && f && (r || null != c) : l ? p && (r || f) : null != c && (r ? c <= e : c < e);
                    d ? i = u + 1 : o = u
                }
                return ka(o, Da)
            }
            ...
            function ln(t, e, n) {
                for (var r = n.length, i = -1, o = xa(t.length - r, 0), a = -1, s = e.length, l = Ho(s + o); ++a < s;) l[a] = e[a];
                for (; ++i < r;) l[n[i]] = t[i];
                for (; o--;) l[a++] = t[i++];
                return l
            }
            ...
            function un(t, e, n) {
                for (var r = -1, i = n.length, o = -1, a = xa(t.length - i, 0), s = -1, l = e.length, u = Ho(a + l); ++o < a;) u[o] = t[o];
            ...
            function fn(t) {
                return vi(function(e, n) {
                    var r = -1,
                        i = null == e ? 0 : n.length,
                        o = i > 2 ? n[i - 2] : x,
                        a = i > 2 ? n[2] : x,
                        s = i > 1 ? n[i - 1] : x;
                    for ("function" == typeof o ? (o = an(o, s, 5), i -= 2) : (o = "function" == typeof s ? s : x, i -= o ? 1 : 0), a && Zn(n[0], n[1], a) && (o = i < 3 ? x : o, i = 1); ++r < i;) {
                        var l = n[r];
                        l && t(e, l, o)
                    }
                    return e
            ...
            function mn(t) {
                return va && fa ? new Kt(t) : null
            }

            function gn(t) {
                return function(e) {
                    for (var n = -1, r = To(co(e)), i = r.length, o = ""; ++n < i;) o = t(o, r[n], n);
                    return o
                }
            }
            ...
            function $n(t, e) {
                return vi(function(n) {
                    var r = n[0];
                    return null == r ? r : (n.push(e), t.apply(x, n))
                })
            }

            function bn(t, e) {
                return function(n, r, i) {
                    if (i && Zn(n, r, i) && (r = x), r = Hn(r, i, 3), 1 == r.length) {
                        n = As(n) ? n : cr(n);
                        var o = ae(n, r, t, e);
            ...
            function xn(t) {
                return function(n, r, i) {
                    return n && n.length ? (r = Hn(r, i, 3), e(n, r, t)) : -1
                }
            }

            function kn(t) {
                return function(e, n, r) {
                    return n = Hn(n, r, 3), _e(e, n, t, !0)
                }
            }
            ...
            function Cn(t) {
                return function() {
                    for (var e, n = arguments.length, r = t ? n : -1, i = 0, o = Ho(n); t ? r-- : ++r < n;) {
                        ...
                        if ("function" != typeof a) throw new Ko(q);
                        !e && tt.prototype.thru && "wrapper" == Vn(a) && (e = new tt([], !0))
                    }
                    for (r = e ? -1 : n; ++r < n;) {
                        a = o[r];
                        var s = Vn(a),
                            l = "wrapper" == s ? Ha(a) : x;
                        e = l && er(l[0]) && l[1] == (O | S | A | M) && !l[4].length && 1 == l[9] ? e[Vn(l[0])].apply(e, l[3]) : 1 == a.length && er(a) ? e[s]() : e.thru(a)
                    }
                    return function() {
                        var t = arguments,
                            r = t[0];
                        if (e && 1 == t.length && As(r) && r.length >= P) return e.plant(r).value();
            ...
            function Tn(t, e) {
                return function(n, r, i) {
                    return "function" == typeof r && i === x && As(n) ? t(n, r) : e(n, an(r, i, 3))
                }
            }

            function En(t) {
                return function(e, n, r) {
                    return "function" == typeof n && r === x || (n = an(n, r, 3)), t(e, n, to)
                }
            }

            function Sn(t) {
                return function(e, n, r) {
                    return "function" == typeof n && r === x || (n = an(n, r, 3)), t(e, n)
                }
            }
            ...
            function _n(t) {
                return function(e, n, r) {
                    var i = {};
                    return n = Hn(n, r, 3), Oe(e, function(e, r, o) {
                        var a = n(e, r, o);
            ...
            function An(t) {
                return function(e, n, r) {
                    return e = i(e), (t ? e : "") + Nn(e, n, r) + (t ? "" : e)
                }
            }

            function Dn(t) {
                var e = vi(function(n, r) {
            ...
            function On(t, e) {
                return function(n, r, i, o) {
                    ...
                    return "function" == typeof r && o === x && As(n) ? t(n, r, i, a) : Ye(n, Hn(r, o, 4), i, a, e)
                }
            }

            function Mn(t, e, n, r, i, o, a, s, l, u) {
                function c() {
                    for (var $ = arguments.length, b = $, w = Ho($); b--;) w[b] = arguments[b];
                    if (r && (w = ln(w, r, i)), o && (w = un(w, o, a)), h || v) {
                        var k = c.placeholder,
                            E = g(w, k);
                        if ($ -= E.length, $ < u) {
                            var S = s ? ne(s) : x,
                                ...
                                N = h ? w : x,
                                j = h ? x : w;
                            e |= h ? A : D, e &= ~(h ? D : A), m || (e &= ~(C | T));
                            var I = [t, e, n, N, O, j, M, S, l, _],
                                R = Mn.apply(x, I);
                            return er(t) && Ua(R, I), R.placeholder = k, R
                        }
                    }
                    var P = p ? n : this,
                        L = d ? P[t] : t;
                    return s && (w = lr(w, s)), f && l < w.length && (w.length = l), this && this !== Zt && this instanceof c && (L = y || vn(t)), L.apply(P, w)
                }
                var f = e & O,
                    p = e & C,
                    d = e & T,
            ...
            function In(t) {
                var e = Wo[t];
                return function(t, n) {
                    return n = n === x ? 0 : +n || 0, n ? (n = ua(10, n), e(t * n) / n) : e(t)
                }
            }
            ...
            function Pn(t, e, n, r, i, o, a, s) {
                var l = e & T;
                if (!l && "function" != typeof t) throw new Ko(q);
                var u = r ? r.length : 0;
                if (u || (e &= ~(A | D), r = i = x), u -= i ? i.length : 0, e & D) {
                    var c = r,
                        f = i;
                    r = i = x
                }
                ...
                if (p && (ir(d, p), e = d[1], s = d[9]), d[9] = null == s ? l ? 0 : t.length : xa(s - u, 0) || 0, e == C) var h = hn(d[0], d[2]);
                else h = e != A && e != (C | A) || d[4].length ? Mn.apply(x, d) : jn.apply(x, d);
                var m = p ? qa : Ua;
                return m(h, d)
            }
            ...
            function qn(t, e, n, r, i, o, a) {
                ...
                for (var d = i; ++f < l;) {
                    ...
                    var h = t[p],
                        m = e[p],
                        g = r ? r(i ? m : h, i ? h : m, p) : x;
                    if (!(g === x ? n(h, m, r, i, o, a) : g)) return !1;
                    d || (d = "constructor" == p)
                }
                if (!d) {
                    var v = t.constructor,
            ...
            function Hn(t, e, n) {
                var r = G.callback || Eo;
                return r = r === Eo ? be : r, n ? r(t, e, n) : r
            }

            function Vn(t) {
                for (var e = t.name + "", n = ja[e], r = n ? n.length : 0; r--;) {
                    var i = n[r],
                        o = i.func;
            ...
            function Kn(t, e, n) {
                null == t || tr(e, t) || (e = pr(e), t = 1 == e.length ? t : je(t, Ge(e, 0, -1)), e = Er(e));
                var r = null == t ? t : t[e];
                return null == r ? x : r.apply(t, n)
            }
            ...
            function Qn(t, e) {
                return t = "number" == typeof t || Mt.test(t) ? +t : -1, e = null == e ? Ma : e, t > -1 && t % 1 == 0 && t < e
            }
            ...
            function tr(t, e) {
                var n = typeof t;
                if ("string" == n && xt.test(t) || "number" == n) return !0;
                if (As(t)) return !1;
                var r = !wt.test(t);
            ...
            function ir(t, e) {
                var n = t[1],
                    ...
                    i = n | r,
                    o = i < O,
                    a = r == O && n == S || r == O && n == M && t[7].length <= e[8] || r == (O | M) && n == S;
                if (!o && !a) return t;
                r & C && (t[2] = e[2], i |= n & C ? 0 : E);
                var s = e[3];
                if (s) {
                    var l = t[3];
                    t[3] = l ? ln(l, s, e[4]) : ne(s), t[4] = l ? g(t[3], H) : ne(e[4])
                }
                return s = e[5], s && (l = t[5], t[5] = l ? un(l, s, e[6]) : ne(s), t[6] = l ? g(t[5], H) : ne(e[6])), s = e[7], s && (t[7] = ne(s)), r & O && (t[8] = null == t[8] ? e[8] : ka(t[8], e[8])), null == t[9] && (t[9] = e[9]), t[0] = e[0], t[1] = i, t
            }

            function or(t, e) {
                return t === x ? e : Ds(t, e, or)
            }
            ...
            function lr(t, e) {
                for (var n = t.length, r = ka(e.length, n), i = ne(t); r--;) {
                    var o = e[r];
                    t[r] = Qn(o, n) ? i[o] : x
                }
                return t
            ...
            function ur(t) {
                for (var e = to(t), n = e.length, r = n && t.length, i = !!r && nr(r) && (As(t) || Ti(t)), o = -1, a = []; ++o < n;) {
                    var s = e[o];
            ...
            function cr(t) {
                return null == t ? [] : Jn(t) ? ji(t) ? t : Yo(t) : oo(t)
            }
            ...
            function pr(t) {
                if (As(t)) return t;
                var e = [];
                return i(t).replace(kt, function(t, n, r, i) {
                    e.push(r ? i.replace(St, "$1") : n || t)
                }), e
            }

            function dr(t) {
                return t instanceof Ht ? t.clone() : new tt(t.__wrapped__, t.__chain__, ne(t.__actions__))
            }

            function hr(t, e, n) {
                e = (n ? Zn(t, e, n) : null == e) ? 1 : xa(ya(e) || 1, 1);
                for (var r = 0, i = t ? t.length : 0, o = -1, a = Ho(ga(i / e)); r < i;) a[++o] = Ge(t, r, r += e);
                return a
            }
            ...
            function gr(t, e, n) {
                var r = t ? t.length : 0;
                return r ? ((n ? Zn(t, e, n) : null == e) && (e = 1), Ge(t, e < 0 ? 0 : e)) : []
            }

            function vr(t, e, n) {
                var r = t ? t.length : 0;
                return r ? ((n ? Zn(t, e, n) : null == e) && (e = 1), e = r - (+e || 0), Ge(t, 0, e < 0 ? 0 : e)) : []
            }

            function yr(t, e, n) {
                return t && t.length ? en(t, Hn(e, n, 3), !0, !0) : []
            }

            function $r(t, e, n) {
                return t && t.length ? en(t, Hn(e, n, 3), !0) : []
            }

            function br(t, e, n, r) {
                var i = t ? t.length : 0;
                return i ? (n && "number" != typeof n && Zn(t, e, n) && (n = 0, r = i), Ee(t, e, n, r)) : []
            }
            ...
            function Cr(t, e, r) {
                var i = t ? t.length : 0;
                if (!i) return -1;
                if ("number" == typeof r) r = r < 0 ? xa(i + r, 0) : r;
                else if (r) {
                    var o = rn(t, e);
                    return o < i && (e === e ? e === t[o] : t[o] !== t[o]) ? o : -1
                }
                return n(t, e, r || 0)
            }
            ...
            function Sr(t, e, n) {
                ...
                if (!r) return -1;
                var i = r;
                if ("number" == typeof n) i = (n < 0 ? xa(r + n, 0) : ka(n || 0, r - 1)) + 1;
                else if (n) {
                    i = rn(t, e, !0) - 1;
                    var o = t[i];
                    return (e === e ? e === o : o !== o) ? i : -1
                }
                if (e !== e) return d(t, i, !0);
                for (; i--;)
                    if (t[i] === e) return i;
                return -1
            }
            ...
            function Or(t, e, n) {
                var r = t ? t.length : 0;
                return r ? (n && "number" != typeof n && Zn(t, e, n) && (e = 0, n = r), Ge(t, e, n)) : []
            }

            function Mr(t, e, n) {
                var r = t ? t.length : 0;
                return r ? ((n ? Zn(t, e, n) : null == e) && (e = 1), Ge(t, 0, e < 0 ? 0 : e)) : []
            }

            function Nr(t, e, n) {
                var r = t ? t.length : 0;
                return r ? ((n ? Zn(t, e, n) : null == e) && (e = 1), e = r - (+e || 0), Ge(t, e < 0 ? 0 : e)) : []
            }

            function jr(t, e, n) {
                return t && t.length ? en(t, Hn(e, n, 3), !1, !0) : []
            }
            ...
            function Rr(t, e, r, i) {
                var o = t ? t.length : 0;
                if (!o) return [];
                null != e && "boolean" != typeof e && (i = r, r = Zn(t, e, i) ? x : e, e = !1);
                var a = Hn();
                return null == r && a === be || (r = a(r, i, 3)), e && Un() === n ? v(t, r) : Ze(t, r)
            }
            ...
            function Pr(t) {
                ...
                var e = -1,
                    n = 0;
                t = se(t, function(t) {
                    if (Jn(t)) return n = xa(t.length, n), !0
                });
                for (var r = Ho(n); ++e < n;) r[e] = le(t, Ue(e));
                return r
            }
            ...
            function Lr(t, e, n) {
                ...
                if (!r) return [];
                var i = Pr(t);
                return null == e ? i : (e = an(e, n, 4), le(i, function(t) {
                    return ce(t, e, x, !0)
                }))
            }
            ...
            function Fr() {
                for (var t = -1, e = arguments.length; ++t < e;) {
                    var n = arguments[t];
                    if (Jn(n)) var r = r ? ue(ke(r, n), ke(n, r)) : n
                }
                return r ? Ze(r) : []
            }
            ...
            function Kr(t, e, n) {
                var r = As(t) ? oe : Ce;
                return n && Zn(t, e, n) && (e = x), "function" == typeof e && n === x || (e = Hn(e, n, 3)), r(t, e)
            }
            ...
            function Zr(t, e, n, r) {
                var i = t ? Va(t) : 0;
                return nr(i) || (t = oo(t), i = t.length), n = "number" != typeof n || r && Zn(e, n, r) ? 0 : n < 0 ? xa(i + n, 0) : n || 0, "string" == typeof t || !As(t) && Vi(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && Un(t, e, n) > -1
            }
            ...
            function ri(t, e, n) {
                if (n ? Zn(t, e, n) : null == e) {
                    t = cr(t);
                    var r = t.length;
                    return r > 0 ? t[ze(0, r - 1)] : x
                }
                var i = -1,
                    o = Yi(t),
                    r = o.length,
                    a = r - 1;
                for (e = ka(e < 0 ? 0 : +e || 0, r); ++i < e;) {
                    var s = ze(i, a),
                        l = o[s];
                    o[s] = o[i], o[i] = l
                }
            ...
            function li(t, e, n, r) {
                return null == t ? [] : (r && Zn(e, n, r) && (n = x), As(e) || (e = null == e ? [] : [e]), As(n) || (n = null == n ? [] : [n]), Je(t, e, n))
            }
            ...
            function fi(t, e, n) {
                return n && Zn(t, e, n) && (e = x), e = t && null == e ? t.length : xa(+e || 0, 0), Pn(t, O, x, x, x, x, e)
            }
            ...
            function di(t, e, n) {
                function r() {
                    d && sa(d), u && sa(u), m = 0, u = d = h = x
                }

                function i(e, n) {
                    n && sa(n), u = d = h = x, e && (m = ms(), c = t.apply(p, l), d || u || (l = p = x))
                }

                function o() {
                    var t = e - (ms() - f);
                    t <= 0 || t > e ? i(h, u) : d = pa(o, t)
                }
                ...
                function s() {
                    if (l = arguments, f = ms(), p = this, h = v && (d || !y), g === !1) var n = y && !d;
                    else {
                        u || y || (m = f);
                        var r = g - (f - m),
                            i = r <= 0 || r > g;
                        i ? (u && (u = sa(u)), m = f, c = t.apply(p, l)) : u || (u = pa(a, r))
                    }
                    return i && d ? d = sa(d) : d || e === g || (d = pa(o, e)), n && (i = !0, c = t.apply(p, l)), !i || d || u || (l = p = x), c
                }
                var l, u, c, f, p, d, h, m = 0,
                    g = !1,
                    v = !0;
                if ("function" != typeof t) throw new Ko(q);
                if (e = e < 0 ? 0 : +e || 0, n === !0) {
                    var y = !0;
                    v = !1
                } else ji(n) && (y = !!n.leading, g = "maxWait" in n && xa(+n.maxWait || 0, e), v = "trailing" in n ? !!n.trailing : v);
                return s.cancel = r, s
            }

            function hi(t, e) {
                if ("function" != typeof t || e && "function" != typeof e) throw new Ko(q);
                var n = function() {
                    var r = arguments,
            ...
            function vi(t, e) {
                if ("function" != typeof t) throw new Ko(q);
                return e = xa(e === x ? t.length - 1 : +e || 0, 0),
                    function() {
                        for (var n = arguments, r = -1, i = xa(n.length - e, 0), o = Ho(i); ++r < i;) o[r] = n[e + r];
                        switch (e) {
                            case 0:
            ...
            function $i(t, e, n) {
                var r = !0,
                    i = !0;
                if ("function" != typeof t) throw new Ko(q);
                return n === !1 ? r = !1 : ji(n) && (r = "leading" in n ? !!n.leading : r, i = "trailing" in n ? !!n.trailing : i), di(t, e, {
                    leading: r,
                    maxWait: +e,
                    trailing: i
                })
            ...
            function bi(t, e) {
                return e = null == e ? _o : e, Pn(e, A, x, [t], [])
            }

            function wi(t, e, n, r) {
                return e && "boolean" != typeof e && Zn(t, e, n) ? e = !1 : "function" == typeof e && (r = n, n = e, e = !1), "function" == typeof n ? we(t, e, an(n, r, 3)) : we(t, e)
            }
            ...
            function Ti(t) {
                return h(t) && Jn(t) && ea.call(t, "callee") && !ca.call(t, "callee")
            }

            function Ei(t) {
                return t === !0 || t === !1 || h(t) && ra.call(t) == B
            }

            function Si(t) {
                return h(t) && ra.call(t) == W
            }

            function _i(t) {
                return !!t && 1 === t.nodeType && h(t) && !qi(t)
            }

            function Ai(t) {
                return null == t || (Jn(t) && (As(t) || Vi(t) || Ti(t) || h(t) && Ni(t.splice)) ? !t.length : !qs(t).length)
            }

            function Di(t, e, n, r) {
                n = "function" == typeof n ? an(n, r, 3) : x;
                var i = n ? n(t, e) : x;
                return i === x ? Ie(t, e, n) : !!i
            }

            function Oi(t) {
                return h(t) && "string" == typeof t.message && ra.call(t) == z
            }
            ...
            function Ii(t, e, n, r) {
                return n = "function" == typeof n ? an(n, r, 3) : x, Pe(t, Bn(e), n)
            }
            ...
            function Pi(t) {
                return null != t && (Ni(t) ? oa.test(ta.call(t)) : h(t) && Ot.test(t))
            }
            ...
            function Fi(t) {
                return "number" == typeof t || h(t) && ra.call(t) == X
            }

            function qi(t) {
                var e;
                if (!h(t) || ra.call(t) != K || Ti(t) || !ea.call(t, "constructor") && (e = t.constructor, "function" == typeof e && !(e instanceof e))) return !1;
                var n;
            ...
            function Hi(t) {
                return ji(t) && ra.call(t) == J
            }

            function Vi(t) {
                return "string" == typeof t || h(t) && ra.call(t) == Z
            }

            function Ui(t) {
                return h(t) && nr(t.length) && !!Ft[ra.call(t)]
            }
            ...
            function Xi(t, e, n) {
                var r = Ia(t);
                return n && Zn(t, e, n) && (e = x), e ? ve(r, e) : r
            }
            ...
            function Qi(t, e) {
                ...
                var n = ea.call(t, e);
                if (!n && !tr(e)) {
                    if (e = pr(e), t = 1 == e.length ? t : je(t, Ge(e, 0, -1)), null == t) return !1;
                    e = Er(e), n = ea.call(t, e)
                }
                return n || nr(t.length) && Qn(e, t.length) && (As(t) || Ti(t))
            }
            ...
            function no(t, e, n) {
                var r = null == t ? x : t[e];
                return r === x && (null == t || tr(e, t) || (e = pr(e), t = 1 == e.length ? t : je(t, Ge(e, 0, -1)), r = null == t ? x : t[Er(e)]), r = r === x ? n : r), Ni(r) ? r.call(t) : r
            }
            ...
            function ro(t, e, n) {
                ...
                for (var i = -1, o = e.length, a = o - 1, s = t; null != s && ++i < o;) {
                    var l = e[i];
                    ji(s) && (i == a ? s[l] = n : null == s[l] && (s[l] = Qn(e[i + 1]) ? [] : {})), s = s[l]
                }
                return t
            }
            ...
            function io(t, e, n, r) {
                ...
                if (e = Hn(e, r, 4), null == n)
                    if (i || ji(t)) {
                        var o = t.constructor;
                        n = i ? As(t) ? new o : [] : Ia(Ni(o) ? o.prototype : x)
                    } else n = {};
                return (i ? re : Oe)(t, function(t, r, i) {
                    return e(n, t, r, i)
                }), n
            }
            ...
            function so(t, e, n) {
                return e = +e || 0, n === x ? (n = e, e = 0) : n = +n || 0, t >= ka(e, n) && t < xa(e, n)
            }
            ...
            function lo(t, e, n) {
                ...
                if (null == n && (i && "boolean" == typeof t ? (n = t, t = 1) : "boolean" == typeof e && (n = e, i = !0)), r && i && (e = 1, i = !1), t = +t || 0, i ? (e = t, t = 0) : e = +e || 0, n || t % 1 || e % 1) {
                    var o = Ea();
                    return ka(t + o * (e - t + la("1e-" + ((o + "").length - 1))), e)
                }
                return ze(t, e)
            }
            ...
            function co(t) {
                return t = i(t), t && t.replace(Nt, u).replace(Et, "")
            }

            function fo(t, e, n) {
                t = i(t), e += "";
                var r = t.length;
                return n = n === x ? r : ka(n < 0 ? 0 : +n || 0, r), n -= e.length, n >= 0 && t.indexOf(e, n) == n
            }

            function po(t) {
                return t = i(t), t && vt.test(t) ? t.replace(mt, c) : t
            }

            function ho(t) {
                return t = i(t), t && Tt.test(t) ? t.replace(Ct, f) : t || "(?:)"
            }
            ...
            function mo(t, e, n) {
                ...
                var o = (e - r) / 2,
                    a = ya(o),
                    s = ga(o);
                return n = Nn("", s, n), n.slice(0, a) + t + n
            }

            function go(t, e, n) {
                return (n ? Zn(t, e, n) : null == e) ? e = 0 : e && (e = +e), t = bo(t), Ta(t, e || (Dt.test(t) ? 16 : 10))
            }

            function vo(t, e) {
                var n = "";
                if (t = i(t), e = +e, e < 1 || !t || !ba(e)) return n;
                do e % 2 && (n += t), e = ya(e / 2), t += t; while (e);
                return n
            }

            function yo(t, e, n) {
                return t = i(t), n = null == n ? 0 : ka(n < 0 ? 0 : +n || 0, t.length), t.lastIndexOf(e, n) == n
            }

            function $o(t, e, n) {
                var r = G.templateSettings;
                n && Zn(t, e, n) && (e = n = x), t = i(t), e = ge(ve({}, n || e), r, me);
                var o, a, s = ge(ve({}, e.imports), r.imports, me),
                    l = qs(s),
                    u = tn(s, l),
                    c = 0,
                    f = e.interpolate || jt,
                    d = "__p += '",
                    h = Go((e.escape || jt).source + "|" + f.source + "|" + (f === bt ? _t : jt).source + "|" + (e.evaluate || jt).source + "|$", "g"),
                    m = "//# sourceURL=" + ("sourceURL" in e ? e.sourceURL : "lodash.templateSources[" + ++Lt + "]") + "\n";
                t.replace(h, function(e, n, r, i, s, l) {
                    return r || (r = i), d += t.slice(c, l).replace(It, p), n && (o = !0, d += "' +\n__e(" + n + ") +\n'"), s && (a = !0, d += "';\n" + s + ";\n__p += '"), r && (d += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"), c = l + e.length, e
                }), d += "';\n";
                var g = e.variable;
                g || (d = "with (obj) {\n" + d + "\n}\n"), d = (a ? d.replace(ft, "") : d).replace(pt, "$1").replace(dt, "$1;"), d = "function(" + (g || "obj") + ") {\n" + (g ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (o ? ", __e = _.escape" : "") + (a ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + d + "return __p\n}";
                var v = Js(function() {
                    return Bo(l, m + "return " + d).apply(x, u)
                });
                if (v.source = d, Oi(v)) throw v;
                return v
            }
            ...
            function ko(t, e, n) {
                ...
                if (Hi(a)) {
                    if (t.slice(s).search(a)) {
                        var u, c, f = t.slice(0, s);
                        for (a.global || (a = Go(a.source, (At.exec(a) || "") + "g")), a.lastIndex = 0; u = a.exec(f);) c = u.index;
            ...
            function Co(t) {
                return t = i(t), t && gt.test(t) ? t.replace(ht, b) : t
            }

            function To(t, e, n) {
                return n && Zn(t, e, n) && (e = x), t = i(t), t.match(e || Rt) || []
            }

            function Eo(t, e, n) {
                return n && Zn(t, e, n) && (e = x), h(t) ? Ao(t) : be(t, e)
            }
            ...
            function Ro(t, e, n) {
                n && Zn(t, e, n) && (e = n = x), t = +t || 0, n = null == n ? 1 : +n || 0, null == e ? (e = t, t = 0) : e = +e || 0;
                for (var r = -1, i = xa(ga((e - t) / (n || 1)), 0), o = Ho(i); ++r < i;) o[r] = t, t += n;
                return o
            }
            ...
            function Po(t, e, n) {
                ...
                var r = -1,
                    i = Ho(ka(t, Aa));
                for (e = an(e, n, 1); ++r < t;) r < Aa ? i[r] = e(r) : e(r);
                return i
            }
            ...
            function qo(t, e, n) {
                return n && Zn(t, e, n) && (e = x), e = Hn(e, n, 3), 1 == e.length ? de(As(t) ? t : cr(t), e) : Qe(t, e)
            }
            ...
            var Ho = m.Array,
                ...
                Qo = Yo.prototype,
                Zo = Xo.prototype,
                ta = Bo.prototype.toString,
                ea = Qo.hasOwnProperty,
                na = 0,
                ra = Qo.toString,
                ia = Zt._,
                oa = Go("^" + ta.call(ea).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                aa = m.ArrayBuffer,
                sa = m.clearTimeout,
                la = m.parseFloat,
                ua = Wo.pow,
                ca = Qo.propertyIsEnumerable,
                fa = Wn(m, "Set"),
                pa = m.setTimeout,
                da = Jo.splice,
                ha = m.Uint8Array,
                ...
                Ta = m.parseInt,
                Ea = Wo.random,
                Sa = zo.NEGATIVE_INFINITY,
                _a = zo.POSITIVE_INFINITY,
                Aa = 4294967295,
                Da = Aa - 1,
                Oa = Aa >>> 1,
                Ma = 9007199254740991,
            ...
            var Ia = function() {
                ...
                Ba = vi(function(t, e) {
                    return h(t) && Jn(t) ? ke(t, Ae(e, !1, !0)) : []
                }),
                Wa = xn(),
                za = xn(!0),
                Ya = vi(function(t) {
                    for (var e = t.length, r = e, i = Ho(f), o = Un(), a = o === n, s = []; r--;) {
                        var l = t[r] = Jn(l = t[r]) ? l : [];
                        i[r] = a && l.length >= 120 ? mn(r && l) : null
                    }
                    var u = t[0],
                        c = -1,
                        f = u ? u.length : 0,
                        p = i[0];
                    t: for (; ++c < f;)
                        if (l = u[c], (p ? Jt(p, l) : o(s, l, 0)) < 0) {
                            for (var r = e; --r;) {
                                var d = i[r];
                                if ((d ? Jt(d, l) : o(t[r], l, 0)) < 0) continue t
                            }
                            p && p.push(l), s.push(l)
                        }
                    return s
                ...
                ts = vi(function(t) {
                    var e = t.length,
                        n = e > 2 ? t[e - 2] : x,
                        r = e > 1 ? t[e - 1] : x;
                    return e > 2 && "function" == typeof n ? e -= 2 : (n = e > 1 && "function" == typeof r ? (--e, r) : x, r = x), t.length = e, Lr(t, n, r)
                }),
                es = vi(function(t) {
                    return t = Ae(t), this.thru(function(e) {
                        return ee(As(e) ? e : [fr(e)], t)
                    })
                }),
                ns = vi(function(t, e) {
                    return ye(t, Ae(e))
                ...
                cs = vi(function(t, e, n) {
                    var r = -1,
                        i = "function" == typeof e,
                        o = tr(e),
                        a = Jn(t) ? Ho(t.length) : [];
                    return Ra(t, function(t) {
                        var s = i ? e : o && null != t ? t[e] : x;
                ...
                hs = vi(function(t, e) {
                    if (null == t) return [];
                    var n = e[2];
                    return n && Zn(e[0], e[1], n) && (e.length = 1), Je(t, Ae(e), [])
                }),
                ms = Ca || function() {
                    return (new Vo).getTime()
                },
                gs = vi(function(t, e, n) {
                    var r = C;
                    if (n.length) {
                ...
                xs = vi(function(t, e, n) {
                    return xe(t, e, n)
                }),
                ks = Cn(),
                Cs = Cn(!0),
                Ts = vi(function(t, e) {
                    if (e = Ae(e), "function" != typeof t || !oe(e, r)) throw new Ko(q);
                    var n = e.length;
                ...
                Ss = Dn(D),
                _s = vi(function(t, e) {
                    return Pn(t, M, x, x, x, Ae(e))
                }),
                As = $a || function(t) {
                    return h(t) && nr(t.length) && ra.call(t) == U
                },
                Ds = fn(He),
                Os = fn(function(t, e, n) {
                ...
                qs = wa ? function(t) {
                    ...
                    return "function" == typeof e && e.prototype === t || "function" != typeof t && Jn(t) ? ur(t) : ji(t) ? wa(t) : []
                } : ur,
                Hs = _n(!0),
                Vs = _n(),
                Us = vi(function(t, e) {
                ...
                rl = bn(Wi, _a),
                il = In("round");
            return G.prototype = Q.prototype, tt.prototype = Ia(Q.prototype), tt.prototype.constructor = tt, Ht.prototype = Ia(Q.prototype), Ht.prototype.constructor = Ht, Wt.prototype["delete"] = zt, Wt.prototype.get = Yt, Wt.prototype.has = Gt, Wt.prototype.set = Xt, Kt.prototype.push = Qt, hi.Cache = Wt, G.after = ci, G.ary = fi, G.assign = Os, G.at = ns, G.before = pi, G.bind = gs, G.bindAll = vs, G.bindKey = ys, G.callback = Eo, G.chain = Hr, G.chunk = hr, G.compact = mr, G.constant = So, G.countBy = rs, G.create = Xi, G.curry = $s, G.curryRight = bs, G.debounce = di, G.defaults = Ms, G.defaultsDeep = Ns, G.defer = ws, G.delay = xs, G.difference = Ba, G.drop = gr, G.dropRight = vr, G.dropRightWhile = yr, G.dropWhile = $r, G.fill = br, G.filter = Jr, G.flatten = xr, G.flattenDeep = kr, G.flow = ks, G.flowRight = Cs, G.forEach = as, G.forEachRight = ss, G.forIn = Rs, G.forInRight = Ps, G.forOwn = Ls, G.forOwnRight = Fs, G.functions = Ki, G.groupBy = ls, G.indexBy = us, G.initial = Tr, G.intersection = Ya, G.invert = Zi, G.invoke = cs, G.keys = qs, G.keysIn = to, G.map = ti, G.mapKeys = Hs, G.mapValues = Vs, G.matches = Ao, G.matchesProperty = Do, G.memoize = hi, G.merge = Ds, G.method = Qs, G.methodOf = Zs, G.mixin = Oo, G.modArgs = Ts, G.negate = mi, G.omit = Us, G.once = gi, G.pairs = eo, G.partial = Es, G.partialRight = Ss, G.partition = fs, G.pick = Bs, G.pluck = ei, G.property = jo, G.propertyOf = Io, G.pull = _r, G.pullAt = Ga, G.range = Ro, G.rearg = _s, G.reject = ni, G.remove = Ar, G.rest = Dr, G.restParam = vi, G.set = ro, G.shuffle = ii, G.slice = Or, G.sortBy = si, G.sortByAll = hs, G.sortByOrder = li, G.spread = yi, G.take = Mr, G.takeRight = Nr, G.takeRightWhile = jr, G.takeWhile = Ir, G.tap = Vr, G.throttle = $i, G.thru = Ur, G.times = Po, G.toArray = Yi, G.toPlainObject = Gi, G.transform = io, G.union = Ja, G.uniq = Rr, G.unzip = Pr, G.unzipWith = Lr, G.values = oo, G.valuesIn = ao, G.where = ui, G.without = Qa, G.wrap = bi, G.xor = Fr, G.zip = Za, G.zipObject = qr, G.zipWith = ts, G.backflow = Cs, G.collect = ti, G.compose = Cs, G.each = as, G.eachRight = ss, G.extend = Os, G.iteratee = Eo, G.methods = Ki, G.object = qr, G.select = Jr, G.tail = Dr, G.unique = Rr, Oo(G, G), G.add = Fo, G.attempt = Js, G.camelCase = Ws, G.capitalize = uo, G.ceil = tl, G.clone = wi, G.cloneDeep = xi, G.deburr = co, G.endsWith = fo, G.escape = po, G.escapeRegExp = ho, G.every = Kr, G.find = is, G.findIndex = Wa, G.findKey = js, G.findLast = os, G.findLastIndex = za, G.findLastKey = Is, G.findWhere = Qr, G.first = wr, G.floor = el, G.get = Ji, G.gt = ki, G.gte = Ci, G.has = Qi, G.identity = _o, G.includes = Zr, G.indexOf = Cr, G.inRange = so, G.isArguments = Ti, G.isArray = As, G.isBoolean = Ei, G.isDate = Si, G.isElement = _i, G.isEmpty = Ai, G.isEqual = Di, G.isError = Oi, G.isFinite = Mi, G.isFunction = Ni, G.isMatch = Ii, G.isNaN = Ri, G.isNative = Pi, G.isNull = Li, G.isNumber = Fi, G.isObject = ji, G.isPlainObject = qi, G.isRegExp = Hi, G.isString = Vi, G.isTypedArray = Ui, G.isUndefined = Bi, G.kebabCase = zs, G.last = Er, G.lastIndexOf = Sr, G.lt = Wi, G.lte = zi, G.max = nl, G.min = rl, G.noConflict = Mo, G.noop = No, G.now = ms, G.pad = mo, G.padLeft = Ys, G.padRight = Gs, G.parseInt = go, G.random = lo, G.reduce = ps, G.reduceRight = ds, G.repeat = vo, G.result = no, G.round = il, G.runInContext = w, G.size = oi, G.snakeCase = Xs, G.some = ai, G.sortedIndex = Xa, G.sortedLastIndex = Ka, G.startCase = Ks, G.startsWith = yo, G.sum = qo, G.template = $o, G.trim = bo, G.trimLeft = wo, G.trimRight = xo, G.trunc = ko, G.unescape = Co, G.uniqueId = Lo, G.words = To, G.all = Kr, G.any = ai, G.contains = Zr, G.eq = Di, G.detect = is, G.foldl = ps, G.foldr = ds, G.head = wr, G.include = Zr, G.inject = ps, Oo(G, function() {
                var t = {};
                return Oe(G, function(e, n) {
                    G.prototype[n] || (t[n] = e)
                }), t
            }(), !1), G.sample = ri, G.prototype.sample = function(t) {
                return this.__chain__ || null != t ? this.thru(function(e) {
                    return ri(e, t)
                }) : ri(this.value())
            }, G.VERSION = k, re(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(t) {
                G[t].placeholder = G
                ...
                t = null == t ? 0 : +t || 0;
                var n = this;
                return n.__filtered__ && (t > 0 || e < 0) ? new Ht(n) : (t < 0 ? n = n.takeRight(-t) : t && (n = n.drop(t)), e !== x && (e = +e || 0, n = e < 0 ? n.dropRight(-e) : n.take(e - t)), n)
            }, Ht.prototype.takeRightWhile = function(t, e) {
                return this.reverse().takeWhile(t, e).reverse()
            }, Ht.prototype.toArray = function() {
                return this.take(_a)
            }, Oe(Ht.prototype, function(t, e) {
                var n = /^(?:filter|map|reject)|While$/.test(e),
                    r = /^(?:first|last)$/.test(e),
                    i = G[r ? "take" + ("last" == e ? "Right" : "") : e];
                i && (G.prototype[e] = function() {
                    ...
                    var f = function(t) {
                            return r && o ? i(t, 1)[0] : i.apply(x, ue([t], e))
                        },
                        p = {
                            func: Ur,
                            args: [f],
                        ...
                        d = l && !s;
                    if (r && !o) return d ? (a = a.clone(), a.__actions__.push(p), t.call(a)) : i.call(x, this.value())[0];
                    if (!r && c) {
                        a = d ? a : new Ht(this);
                        var h = t.apply(a, e);
                ...
                name: "wrapper",
                func: x
            }], Ht.prototype.clone = Vt, Ht.prototype.reverse = Ut, Ht.prototype.value = Bt, G.prototype.chain = Br, G.prototype.commit = Wr, G.prototype.concat = es, G.prototype.plant = zr, G.prototype.reverse = Yr, G.prototype.toString = Gr, G.prototype.run = G.prototype.toJSON = G.prototype.valueOf = G.prototype.value = Xr, G.prototype.collect = G.prototype.map, G.prototype.head = G.prototype.first, G.prototype.select = G.prototype.filter, G.prototype.tail = G.prototype.rest, G
        }
        var x, k = "3.10.1",
            C = 1,
            T = 2,
            ...
            Lt = -1,
            Ft = {};
        Ft[nt] = Ft[rt] = Ft[it] = Ft[ot] = Ft[at] = Ft[st] = Ft[lt] = Ft[ut] = Ft[ct] = !0, Ft[V] = Ft[U] = Ft[et] = Ft[B] = Ft[W] = Ft[z] = Ft[Y] = Ft[G] = Ft[X] = Ft[K] = Ft[J] = Ft[Q] = Ft[Z] = Ft[tt] = !1;
        var qt = {};
        qt[V] = qt[U] = qt[et] = qt[B] = qt[W] = qt[nt] = qt[rt] = qt[it] = qt[ot] = qt[at] = qt[X] = qt[K] = qt[J] = qt[Z] = qt[st] = qt[lt] = qt[ut] = qt[ct] = !0, qt[z] = qt[Y] = qt[G] = qt[Q] = qt[tt] = !1;
        var Ht = {
                "\xc0": "A",
                "\xc1": "A",
                "\xc2": "A",
            ...
            Yt = Bt[typeof exports] && exports && !exports.nodeType && exports,
            Gt = Bt[typeof module] && module && !module.nodeType && module,
            Xt = Yt && Gt && "object" == typeof global && global && global.Object && global,
            Kt = Bt[typeof self] && self && self.Object && self,
            Jt = Bt[typeof window] && window && window.Object && window,
            Qt = Gt && Gt.exports === Yt && Yt,
            Zt = Xt || Jt !== (this && this.window) && Jt || Kt || this,
            te = w();
        "function" == typeof define && "object" == typeof define.amd && define.amd ? (Zt._ = te, define(function() {
            return te
        })) : Yt && Gt ? Qt ? (Gt.exports = te)._ = te : Yt._ = te : Zt._ = te
    }.call(this),
    function() {
        angular.module("app", ["controllers", "ui.bootstrap", "ngNumeraljs"]), angular.module("controllers", [])
    }.call(this),
    function(t, e) {
        ...
        function r(t, e, n) {
            if (dt.isFunction(e)) return dt.grep(t, function(t, r) {
            ...
            if ("string" == typeof e) {
                if (kt.test(e)) return dt.filter(e, t, n);
                e = dt.filter(e, t)
            }
        ...
        function o(t) {
            var e = {};
            return dt.each(t.match(At) || [], function(t, n) {
                e[n] = !0
            }), e
        }
        ...
        function s() {
            (rt.addEventListener || "load" === t.event.type || "complete" === rt.readyState) && (a(), dt.ready())
        }

        function l(t, e, n) {
            if (void 0 === n && 1 === t.nodeType) {
                var r = "data-" + e.replace(jt, "-$1").toLowerCase();
                if (n = t.getAttribute(r), "string" == typeof n) {
                    try {
                        n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : Nt.test(n) ? dt.parseJSON(n) : n)
                    } catch (t) {}
                    dt.data(t, e, n)
                } else n = void 0
            }
        ...
        function c(t, e, n, r) {
            if (Mt(t)) {
                var i, o, a = dt.expando,
                    ...
                    l = s ? dt.cache : t,
                    u = s ? t[a] : t[a] && a;
                if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof e) return u || (u = s ? t[a] = nt.pop() || dt.guid++ : a), l[u] || (l[u] = s ? {} : {
                    toJSON: dt.noop
                }), "object" != typeof e && "function" != typeof e || (r ? l[u] = dt.extend(l[u], e) : l[u].data = dt.extend(l[u].data, e)), o = l[u], r || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[dt.camelCase(e)] = n), "string" == typeof e ? (i = o[e], null == i && (i = o[dt.camelCase(e)])) : i = o, i
            }
        }
        ...
        function f(t, e, n) {
            if (Mt(t)) {
                var r, i, o = t.nodeType,
                    a = o ? dt.cache : t,
                    s = o ? t[dt.expando] : dt.expando;
                if (a[s]) {
                    if (e && (r = n ? a[s] : a[s].data)) {
                        dt.isArray(e) ? e = e.concat(dt.map(e, dt.camelCase)) : e in r ? e = [e] : (e = dt.camelCase(e), e = e in r ? [e] : e.split(" ")), i = e.length;
                        for (; i--;) delete r[e[i]];
                        if (n ? !u(r) : !dt.isEmptyObject(r)) return
                    }(n || (delete a[s].data, u(a[s]))) && (o ? dt.cleanData([t], !0) : ft.deleteExpando || a != a.window ? delete a[s] : a[s] = void 0)
                }
            }
        }
        ...
        function p(t, e, n, r) {
            var i, o = 1,
                ...
                c = (dt.cssNumber[e] || "px" !== u && +l) && Rt.exec(dt.css(t, e));
            if (c && c[3] !== u) {
                u = u || c[3], n = n || [], c = +l || 1;
                do o = o || ".5", c /= o, dt.style(t, e, c + u); while (o !== (o = s() / l) && 1 !== o && --a)
            }
        ...
        function h(t, e) {
            ...
            if (!o)
                for (o = [], n = t.childNodes || t; null != (r = n[i]); i++) !e || dt.nodeName(r, e) ? o.push(r) : dt.merge(o, h(r, e));
        ...
        function v(t, e, n, r, i) {
            for (var o, a, s, l, u, c, f, p = t.length, v = d(e), y = [], $ = 0; $ < p; $++)
                if (a = t[$], a || 0 === a)
                    if ("object" === dt.type(a)) dt.merge(y, a.nodeType ? [a] : a);
                    else if (zt.test(a)) {
                for (l = l || v.appendChild(e.createElement("div")), u = (Ht.exec(a) || ["", ""])[1].toLowerCase(), f = Wt[u] || Wt._default, l.innerHTML = f[1] + dt.htmlPrefilter(a) + f[2], o = f[0]; o--;) l = l.lastChild;
                if (!ft.leadingWhitespace && Ut.test(a) && y.push(e.createTextNode(Ut.exec(a)[0])), !ft.tbody)
                    for (a = "table" !== u || Yt.test(a) ? "<table>" !== f[1] || Yt.test(a) ? 0 : l : l.firstChild, o = a && a.childNodes.length; o--;) dt.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
                for (dt.merge(y, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
                l = v.lastChild
            } else y.push(e.createTextNode(a));
            for (l && v.removeChild(l), ft.appendChecked || dt.grep(h(y, "input"), g), $ = 0; a = y[$++];)
                if (r && dt.inArray(a, r) > -1) i && i.push(a);
                else if (s = dt.contains(a.ownerDocument, a), l = h(v.appendChild(a), "script"), s && m(l), n)
                for (o = 0; a = l[o++];) Vt.test(a.type || "") && n.push(a);
            return l = null, v
        }
        ...
        function w(t, e, n, r, i, o) {
            ...
            }, i.guid = a.guid || (a.guid = dt.guid++)), t.each(function() {
        ...
        function T(t, e) {
            if (1 === e.nodeType && dt.hasData(t)) {
                ...
                if (s) {
                    ...
                    for (n in s)
                        for (r = 0, i = s[n].length; r < i; r++) dt.event.add(e, n, s[n][r])
                }
        ...
        function E(t, e) {
            ...
            if (1 === e.nodeType) {
                if (n = e.nodeName.toLowerCase(), !ft.noCloneEvent && e[dt.expando]) {
                    i = dt._data(e);
                    for (r in i.events) dt.removeEvent(e, r, i.handle);
                    e.removeAttribute(dt.expando)
                }
                "script" === n && e.text !== t.text ? (k(e).text = t.text, C(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), ft.html5Clone && t.innerHTML && !dt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && qt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : "input" !== n && "textarea" !== n || (e.defaultValue = t.defaultValue)
            }
        }
        ...
        function S(t, e, n, r) {
            ...
            var i, o, a, s, l, u, c = 0,
                ...
                d = e[0],
                m = dt.isFunction(d);
            if (m || f > 1 && "string" == typeof d && !ft.checkClone && re.test(d)) return t.each(function(i) {
                var o = t.eq(i);
                m && (e[0] = d.call(this, i, o.html())), S(o, e, n, r)
            });
            if (f && (u = v(e, t[0].ownerDocument, !1, t, r), i = u.firstChild, 1 === u.childNodes.length && (u = i), i || r)) {
                for (s = dt.map(h(u, "script"), k), a = s.length; c < f; c++) o = u, c !== p && (o = dt.clone(o, !0, !0), a && dt.merge(s, h(o, "script"))), n.call(t[c], o, c);
                if (a)
                    for (l = s[s.length - 1].ownerDocument, dt.map(s, C), c = 0; c < a; c++) o = s[c], Vt.test(o.type || "") && !dt._data(o, "globalEval") && dt.contains(l, o) && (o.src ? dt._evalUrl && dt._evalUrl(o.src) : dt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(oe, "")));
                u = i = null
            }
            return t
        }
        ...
        function _(t, e, n) {
            for (var r, i = e ? dt.filter(e, t) : t, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || dt.cleanData(h(r)), r.parentNode && (n && dt.contains(r.ownerDocument, r) && m(h(r, "script")), r.parentNode.removeChild(r));
            return t
        }
        ...
        function D(t) {
            var e = rt,
                n = ue[t];
            return n || (n = A(t, e), "none" !== n && n || (le = (le || dt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (le[0].contentWindow || le[0].contentDocument).document, e.write(), e.close(), n = A(t, e), le.detach()), ue[t] = n), n
        }
        ...
        function N(t, e) {
            for (var n, r, i, o = [], a = 0, s = t.length; a < s; a++) r = t[a], r.style && (o[a] = dt._data(r, "olddisplay"), n = r.style.display, e ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Lt(r) && (o[a] = dt._data(r, "olddisplay", D(r.nodeName)))) : (i = Lt(r), (n && "none" !== n || !i) && dt._data(r, "olddisplay", i ? n : dt.css(r, "display"))));
        ...
        function I(t, e, n, r, i) {
            for (var o = n === (r ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += dt.css(t, n + Pt[o], !0, i)), r ? ("content" === n && (a -= dt.css(t, "padding" + Pt[o], !0, i)), "margin" !== n && (a -= dt.css(t, "border" + Pt[o] + "Width", !0, i))) : (a += dt.css(t, "padding" + Pt[o], !0, i), "padding" !== n && (a += dt.css(t, "border" + Pt[o] + "Width", !0, i)));
            return a
        }
        ...
        function R(t, e, n) {
            ...
            if (i <= 0 || null == i) {
                if (i = me(t, e, o), (i < 0 || null == i) && (i = t.style[e]), fe.test(i)) return i;
                r = a && (ft.boxSizingReliable() || i === t.style[e]), i = parseFloat(i) || 0
            }
            return i + I(t, e, n || (a ? "border" : "content"), r, o) + "px"
        }
        ...
        function F(t, e) {
            var n, r = {
                ...
                i = 0;
            for (e = e ? 1 : 0; i < 4; i += 2 - e) n = Pt[i], r["margin" + n] = r["padding" + n] = t;
        ...
        function H(t, e, n) {
            var r, i, o, a, s, l, u, c, f = this,
                ...
                h = t.nodeType && Lt(t),
                m = dt._data(t, "fxshow");
            n.queue || (s = dt._queueHooks(t, "fx"), null == s.unqueued && (s.unqueued = 0, l = s.empty.fire, s.empty.fire = function() {
                s.unqueued || l()
            }), s.unqueued++, f.always(function() {
                f.always(function() {
                    s.unqueued--, dt.queue(t, "fx").length || s.empty.fire()
                })
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], u = dt.css(t, "display"), c = "none" === u ? dt._data(t, "olddisplay") || D(t.nodeName) : u, "inline" === c && "none" === dt.css(t, "float") && (ft.inlineBlockNeedsLayout && "inline" !== D(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")), n.overflow && (d.overflow = "hidden", ft.shrinkWrapBlocks() || f.always(function() {
            ...
            for (r in e)
                if (i = e[r], Se.exec(i)) {
                    ...
                    p[r] = m && m[r] || dt.style(t, r)
                } else u = void 0;
            if (dt.isEmptyObject(p)) "inline" === ("none" === u ? D(t.nodeName) : u) && (d.display = u);
            else {
                m ? "hidden" in m && (h = m.hidden) : m = dt._data(t, "fxshow", {}), o && (m.hidden = !h), h ? dt(t).show() : f.done(function() {
                    dt(t).hide()
                }), f.done(function() {
                    var e;
                    dt._removeData(t, "fxshow");
                    for (e in p) dt.style(t, e, p[e])
                });
                for (r in p) a = q(h ? m[r] : 0, r, f), r in m || (m[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
            }
        }
        ...
        function V(t, e) {
            var n, r, i, o, a;
            for (n in t)
                if (r = dt.camelCase(n), i = e[r], o = t[n], dt.isArray(o) && (i = o[1], o = t[n] = o[0]), n !== r && (t[r] = o, delete t[n]), a = dt.cssHooks[r], a && "expand" in a) {
        ...
        function U(t, e, n) {
            var r, i, o = 0,
                ...
                l = function() {
                    if (i) return !1;
                    for (var e = Te || L(), n = Math.max(0, u.startTime + u.duration - e), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; a < l; a++) u.tweens[a].run(o);
            ...
            for (V(c, u.opts.specialEasing); o < a; o++)
                if (r = U.prefilters[o].call(u, t, c, u.opts)) return dt.isFunction(r.stop) && (dt._queueHooks(u.elem, u.opts.queue).stop = dt.proxy(r.stop, r)), r;
        ...
        function z(t, e, n, r) {
            function i(s) {
                var l;
                return o[s] = !0, dt.each(t[s] || [], function(t, s) {
                    var u = s(e, n, r);
        ...
        function Q(t, e, n, r) {
            var i;
            if (dt.isArray(e)) dt.each(e, function(e, i) {
                n || rn.test(t) ? r(t, i) : Q(t + "[" + ("object" == typeof i && null != i ? e : "") + "]", i, n, r)
            });
            else if (n || "object" !== dt.type(e)) r(t, e);
            else
        ...
        dt.fn = dt.prototype = {
            ...
            var t, e, n, r, i, o, a = arguments[0] || {},
                ...
                l = arguments.length,
                u = !1;
            for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || dt.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
                if (null != (i = arguments[s]))
                    for (r in i) t = a[r], n = i[r], a !== n && (u && n && (dt.isPlainObject(n) || (e = dt.isArray(n))) ? (e ? (e = !1, o = t && dt.isArray(t) ? t : []) : o = t && dt.isPlainObject(t) ? t : {}, a[r] = dt.extend(u, o, n)) : void 0 !== n && (a[r] = n));
            return a
        }, dt.extend({
            ...
            makeArray: function(t, e) {
                var r = e || [];
                return null != t && (n(Object(t)) ? dt.merge(r, "string" == typeof t ? [t] : t) : at.call(r, t)), r
            },
            ...
            proxy: function(t, e) {
                var n, r, i;
                if ("string" == typeof e && (i = t[e], e = t, t = i), dt.isFunction(t)) return n = it.call(arguments, 2), r = function() {
        ...
        var yt = function(t) {
            function e(t, e, n, r) {
                var i, o, a, s, l, u, f, d, h = e && e.ownerDocument,
                    m = e ? e.nodeType : 9;
                if (n = n || [], "string" != typeof t || !t || 1 !== m && 9 !== m && 11 !== m) return n;
                if (!r && ((e ? e.ownerDocument || e : q) !== M && O(e), e = e || M, j)) {
                    if (11 !== m && (u = vt.exec(t)))
                        if (i = u[1]) {
                            if (9 === m) {
                            ...
                            if ((i = u[3]) && w.getElementsByClassName && e.getElementsByClassName) return Q.apply(n, e.getElementsByClassName(i)), n
                        }
                    if (w.qsa && !W[t + " "] && (!I || !I.test(t))) {
                        if (1 !== m) h = e, d = t;
                        else if ("object" !== e.nodeName.toLowerCase()) {
                            for ((s = e.getAttribute("id")) ? s = s.replace($t, "\\$&") : e.setAttribute("id", s = F), f = T(t), o = f.length, l = pt.test(s) ? "#" + s : "[id='" + s + "']"; o--;) f[o] = l + " " + p(f[o]);
            ...
            function d(t, e, n) {
                ...
                return e.first ? function(e, n, o) {
                    ...
                    if (a) {
                        ...
                        for (; e = e[r];)
                            if (1 === e.nodeType || i) {
                                if (u = e[F] || (e[F] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (s = l[r]) && s[0] === H && s[1] === o) return c[2] = s[2];
            ...
            function v(t, e, n, i, o, a) {
                return i && !i[F] && (i = v(i)), o && !o[F] && (o = v(o, a)), r(function(r, a, s, l) {
                    var u, c, f, p = [],
                        ...
                        y = !t || !r && e ? v : g(v, p, t, s, l),
                        $ = n ? o || (r ? t : h || i) ? [] : a : y;
                    if (n && n(y, $, s, l), i)
                        for (u = g($, d), i(u, [], s, l), c = u.length; c--;)(f = u[c]) && ($[d[c]] = !(y[d[c]] = f));
                    if (r) {
                        if (o || t) {
                            if (o) {
                                for (u = [], c = $.length; c--;)(f = $[c]) && u.push(y[c] = f);
                                o(null, $ = [], u, l)
                            }
                            for (c = $.length; c--;)(f = $[c]) && (u = o ? tt(r, f) : p[c]) > -1 && (r[u] = !(a[u] = f))
                        }
                    } else $ = g($ === a ? $.splice(h, $.length) : $), o ? o(null, a, $, l) : Q.apply(a, $)
                })
            }

            function y(t) {
                for (var e, n, r, i = t.length, o = x.relative[t[0].type], a = o || x.relative[" "], s = o ? 1 : 0, l = d(function(t) {
                        return t === e
                    }, a, !0), u = d(function(t) {
                        return tt(e, t) > -1
                    }, a, !0), c = [function(t, n, r) {
                        var i = !o && (r || n !== _) || ((e = n).nodeType ? l(t, n, r) : u(t, n, r));
                        return e = null, i
                    }]; s < i; s++)
                    if (n = x.relative[t[s].type]) c = [d(h(c), n)];
                    else {
                        if (n = x.filter[t[s].type].apply(null, t[s].matches), n[F]) {
                            for (r = ++s; r < i && !x.relative[t[r].type]; r++);
                            return v(s > 1 && h(c), s > 1 && p(t.slice(0, s - 1).concat({
                                value: " " === t[s - 2].type ? "*" : ""
                ...
                var i = n.length > 0,
                    ...
                    a = function(r, a, s, l, u) {
                        var c, f, p, d = 0,
                            ...
                            w = $.length;
                        for (u && (_ = a === M || a || u); h !== w && null != (c = $[h]); h++) {
                            if (o && c) {
                                for (f = 0, a || c.ownerDocument === M || (O(c), s = !j); p = t[f++];)
                                    if (p(c, a || M, s)) {
                                        l.push(c);
                                        break
                                    }
                        ...
                        if (d += h, i && h !== d) {
                            ...
                            Q.apply(l, v), u && !r && v.length > 0 && d + n.length > 1 && e.uniqueSort(l)
                        }
                        return u && (H = b, _ = y), m
                    };
                return i ? r(a) : a
            }
            var b, w, x, k, C, T, E, S, _, A, D, O, M, N, j, I, R, P, L, F = "sizzle" + 1 * new Date,
                q = t.document,
                H = 0,
                V = 0,
                U = n(),
            ...
            try {
                Q.apply(X = Z.call(q.childNodes), q.childNodes), X[q.childNodes.length].nodeType
            } catch (t) {
                Q = {
            ...
            w = e.support = {}, C = e.isXML = function(t) {
                ...
                return r !== M && 9 === r.nodeType && r.documentElement ? (M = r, N = M.documentElement, j = !C(M), (n = M.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xt, !1) : n.attachEvent && n.attachEvent("onunload", xt)), w.attributes = i(function(t) {
                    return t.className = "i", !t.getAttribute("className")
                }), w.getElementsByTagName = i(function(t) {
                    return t.appendChild(M.createComment("")), !t.getElementsByTagName("*").length
                }), w.getElementsByClassName = gt.test(M.getElementsByClassName), w.getById = i(function(t) {
                ...
                }, R = [], I = [], (w.qsa = gt.test(M.querySelectorAll)) && (i(function(t) {
                ...
                })), (w.matchesSelector = gt.test(P = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && i(function(t) {
                    w.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), R.push("!=", ot)
                }), I = I.length && new RegExp(I.join("|")), R = R.length && new RegExp(R.join("|")), e = gt.test(N.compareDocumentPosition), L = e || gt.test(N.contains) ? function(t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === M || t.ownerDocument === q && L(q, t) ? -1 : e === M || e.ownerDocument === q && L(q, e) ? 1 : A ? tt(A, t) - tt(A, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return D = !0, 0;
                    var n, r = 0,
                        i = t.parentNode,
                        ...
                        s = [t],
                        l = [e];
                    if (!i || !o) return t === M ? -1 : e === M ? 1 : i ? -1 : o ? 1 : A ? tt(A, t) - tt(A, e) : 0;
                    if (i === o) return a(t, e);
                ...
                if ((t.ownerDocument || t) !== M && O(t), n = n.replace(ct, "='$1']"), w.matchesSelector && j && !W[n + " "] && (!R || !R.test(n)) && (!I || !I.test(n))) try {
                    var r = P.call(t, n);
                    if (r || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return r
                } catch (t) {}
                return e(n, M, null, [t]).length > 0
            }, e.contains = function(t, e) {
                return (t.ownerDocument || t) !== M && O(t), L(t, e)
            }, e.attr = function(t, e) {
                (t.ownerDocument || t) !== M && O(t);
                var n = x.attrHandle[e.toLowerCase()],
                    r = n && G.call(x.attrHandle, e.toLowerCase()) ? n(t, e, !j) : void 0;
                ...
                var e, n = [],
                    r = 0,
                    i = 0;
                if (D = !w.detectDuplicates, A = !w.sortStable && t.slice(0), t.sort(z), D) {
                        ...
                        return 1 === r && 0 === i ? function(t) {
                            ...
                            if (g) {
                                ...
                                if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                    for (p = g, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[t] || [], d = u[0] === H && u[1], $ = d && u[2], p = d && g.childNodes[d]; p = ++d && p && p[m] || ($ = d = 0) || h.pop();)
                                        if (1 === p.nodeType && ++$ && p === e) {
                                            c[t] = [H, d, $];
                                            break
                                        }
                                } else if (y && (p = e, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[t] || [], d = u[0] === H && u[1], $ = d), $ === !1)
                                    for (;
                                        (p = ++d && p && p[m] || ($ = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++$ || (y && (f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[t] = [H, $]), p !== e)););
                                return $ -= i, $ === r || $ % r === 0 && $ / r >= 0
                            }
                        }
                    },
            ...
            return f.prototype = x.filters = x.pseudos, x.setFilters = new f, T = e.tokenize = function(t, n) {
                ...
                for (s = t, l = [], u = x.preFilter; s;) {
                    ...
                    for (a in x.filter) !(i = dt[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i.shift(), o.push({
                        value: r,
                        type: a,
                        matches: i
                    }), s = s.slice(r.length));
                ...
                if (!o) {
                    ...
                    o = W(t, $(i, r)), o.selector = t
                }
                return o
            }, S = e.select = function(t, e, n, r) {
                var i, o, a, s, l, u = "function" == typeof t && t,
                    f = !r && T(t = u.selector || t);
                if (n = n || [], 1 === f.length) {
                    if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === e.nodeType && j && x.relative[o[1].type]) {
                        if (e = (x.find.ID(a.matches[0].replace(bt, wt), e) || [])[0], !e) return n;
                        u && (e = e.parentNode), t = t.slice(o.shift().value.length)
                    }
                    for (i = dt.needsContext.test(t) ? 0 : o.length; i-- && (a = o[i], !x.relative[s = a.type]);)
                        if ((l = x.find[s]) && (r = l(a.matches[0].replace(bt, wt), yt.test(o[0].type) && c(e.parentNode) || e))) {
                            if (o.splice(i, 1), t = r.length && p(o), !t) return Q.apply(n, r), n;
                            break
                        }
                }
                return (u || E(t, f))(r, e, !j, n, !e || yt.test(t) && c(e.parentNode) || e), n
            }, w.sortStable = F.split("").sort(z).join("") === F, w.detectDuplicates = !!D, O(), w.sortDetached = i(function(t) {
        ...
        dt.filter = function(t, e, n) {
            ...
            find: function(t) {
                ...
                return n = this.pushStack(i > 1 ? dt.unique(n) : n), n.selector = this.selector ? this.selector + " " + t : t, n
            },
            filter: function(t) {
        ...
        var Ct, Tt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
            Et = dt.fn.init = function(t, e, n) {
                ...
                if (n = n || Ct, "string" == typeof t) {
                    ...
                    if (r[1]) {
                        if (e = e instanceof dt ? e[0] : e, dt.merge(this, dt.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : rt, !0)), xt.test(r[1]) && dt.isPlainObject(e))
        ...
        dt.fn.extend({
            ...
            closest: function(t, e) {
                for (var n, r = 0, i = this.length, o = [], a = wt.test(t) || "string" != typeof t ? dt(t, e || this.context) : 0; r < i; r++)
                    for (n = this[r]; n && n !== e; n = n.parentNode)
                        if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && dt.find.matchesSelector(n, t))) {
                            o.push(n);
                            break
                        }
            ...
            dt.fn[t] = function(n, r) {
                var i = dt.map(this, e, n);
                return "Until" !== t.slice(-5) && (r = n), r && "string" == typeof r && (i = dt.filter(r, i)), this.length > 1 && (_t[t] || (i = dt.uniqueSort(i)), St.test(t) && (i = i.reverse())), this.pushStack(i)
            }
        });
        var At = /\S+/g;
        dt.Callbacks = function(t) {
                ...
                c = {
                    add: function() {
                        return a && (n && !e && (l = a.length - 1, s.push(n)), function e(n) {
                            dt.each(n, function(n, r) {
                                dt.isFunction(r) ? t.unique && c.has(r) || a.push(r) : r && r.length && "string" !== dt.type(r) && e(r)
                            })
                    ...
                    remove: function() {
                        return dt.each(arguments, function(t, e) {
                            for (var n;
                                (n = dt.inArray(e, a, n)) > -1;) a.splice(n, 1), n <= l && l--
                        }), this
                    },
                    has: function(t) {
            ...
            Deferred: function(t) {
                var e = [
                        ...
                        then: function() {
                            ...
                            return dt.Deferred(function(n) {
                                dt.each(e, function(e, o) {
                                    var a = dt.isFunction(t[e]) && t[e];
                                    i[o[1]](function() {
                                        var t = a && a.apply(this, arguments);
                                        t && dt.isFunction(t.promise) ? t.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[o[0] + "With"](this === r ? n.promise() : this, a ? [t] : arguments)
                                    })
                                }), t = null
                            }).promise()
                        },
                    ...
                    i = {};
                return r.pipe = r.then, dt.each(e, function(t, o) {
                    var a = o[2],
                        s = o[3];
            ...
            when: function(t) {
                var e, n, r, i = 0,
                    ...
                    u = function(t, n, r) {
                        return function(i) {
                            n[t] = this, r[t] = arguments.length > 1 ? it.call(arguments) : i, r === e ? l.notifyWith(n, r) : --s || l.resolveWith(n, r)
                        }
                    };
                if (a > 1)
                    for (e = new Array(a), n = new Array(a), r = new Array(a); i < a; i++) o[i] && dt.isFunction(o[i].promise) ? o[i].promise().progress(u(i, n, e)).done(u(i, r, o)).fail(l.reject) : --s;
        ...
        dt.fn.ready = function(t) {
            ...
            ready: function(t) {
                (t === !0 ? --dt.readyWait : dt.isReady) || (dt.isReady = !0, t !== !0 && --dt.readyWait > 0 || (Dt.resolveWith(rt, [dt]), dt.fn.triggerHandler && (dt(rt).triggerHandler("ready"), dt(rt).off("ready"))))
            }
        }), dt.ready.promise = function(e) {
            if (!Dt)
                if (Dt = dt.Deferred(), "complete" === rt.readyState || "loading" !== rt.readyState && !rt.documentElement.doScroll) t.setTimeout(dt.ready);
        ...
        var Ot;
        for (Ot in dt(ft)) break;
        ft.ownFirst = "0" === Ot, ft.inlineBlockNeedsLayout = !1, dt(function() {
                var t, e, n, r;
        ...
        dt.extend({
                ...
                promise: function(t, e) {
                    ...
                    for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;) n = dt._data(o[a], t + "queueHooks"), n && n.empty && (r++, n.empty.add(s));
        ...
        var It = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            Ft = function(t, e, n, r, i, o, a) {
                ...
                } else if (void 0 !== r && (i = !0, dt.isFunction(r) || (a = !0), u && (a ? (e.call(t, r), e = null) : (u = e, e = function(t, e, n) {
        ...
        dt.event = {
            ...
            add: function(t, e, n, r, i) {
                var o, a, s, l, u, c, f, p, d, h, m, g = dt._data(t);
                if (g) {
                    for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = dt.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                            return "undefined" == typeof dt || t && dt.event.triggered === t.type ? void 0 : dt.event.dispatch.apply(c.elem, arguments)
                        }, c.elem = t), e = (e || "").match(At) || [""], s = e.length; s--;) o = Qt.exec(e[s]) || [], d = m = o[1], h = (o[2] || "").split(".").sort(), d && (u = dt.event.special[d] || {}, d = (i ? u.delegateType : u.bindType) || d, u = dt.event.special[d] || {}, f = dt.extend({
                        type: d,
                        origType: m,
                        data: r,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, l), (p = a[d]) || (p = a[d] = [], p.delegateCount = 0, u.setup && u.setup.call(t, r, h, c) !== !1 || (t.addEventListener ? t.addEventListener(d, c, !1) : t.attachEvent && t.attachEvent("on" + d, c))), u.add && (u.add.call(t, f), f.handler.guid || (f.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, f) : p.push(f), dt.event.global[d] = !0);
                    t = null
                }
            },
            remove: function(t, e, n, r, i) {
                var o, a, s, l, u, c, f, p, d, h, m, g = dt.hasData(t) && dt._data(t);
                if (g && (c = g.events)) {
                    for (e = (e || "").match(At) || [""], u = e.length; u--;)
                        if (s = Qt.exec(e[u]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
                            for (f = dt.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = p.length; o--;) a = p[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(t, a));
                            l && !p.length && (f.teardown && f.teardown.call(t, h, g.handle) !== !1 || dt.removeEvent(t, d, g.handle), delete c[d])
                        } else
                            for (d in c) dt.event.remove(t, d + e[u], n, r, !0);
                    dt.isEmptyObject(c) && (delete g.handle, dt._removeData(t, "events"))
                }
            },
            trigger: function(e, n, r, i) {
                var o, a, s, l, u, c, f, p = [r || rt],
                    d = ct.call(e, "type") ? e.type : e,
                    h = ct.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = c = r = r || rt, 3 !== r.nodeType && 8 !== r.nodeType && !Jt.test(d + dt.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), a = d.indexOf(":") < 0 && "on" + d, e = e[dt.expando] ? e : new dt.Event(d, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : dt.makeArray(n, [e]), u = dt.event.special[d] || {}, i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                    if (!i && !u.noBubble && !dt.isWindow(r)) {
                        for (l = u.delegateType || d, Jt.test(l + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), c = s;
                        c === (r.ownerDocument || rt) && p.push(c.defaultView || c.parentWindow || t)
                    }
                    for (f = 0;
                        (s = p[f++]) && !e.isPropagationStopped();) e.type = f > 1 ? l : u.bindType || d, o = (dt._data(s, "events") || {})[e.type] && dt._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && Mt(s) && (e.result = o.apply(s, n), e.result === !1 && e.preventDefault());
                    if (e.type = d, !i && !e.isDefaultPrevented() && (!u._default || u._default.apply(p.pop(), n) === !1) && Mt(r) && a && r[d] && !dt.isWindow(r)) {
            ...
            dispatch: function(t) {
                ...
                if (s[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                    for (a = dt.event.handlers.call(this, t, l), e = 0;
                        (i = a[e++]) && !t.isPropagationStopped();)
                        for (t.currentTarget = i.elem, n = 0;
                            (o = i.handlers[n++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(o.namespace) || (t.handleObj = o, t.data = o.data, r = ((dt.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s), void 0 !== r && (t.result = r) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                if (s && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
                    for (; l != this; l = l.parentNode || this)
                        if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                            for (r = [], n = 0; n < s; n++) o = e[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? dt(i, this).index(l) > -1 : dt.find(i, this, null, [l]).length), r[i] && r.push(o);
                            r.length && a.push({
                                elem: l,
                                handlers: r
                            })
            ...
            fix: function(t) {
                ...
                var e, n, r, i = t.type,
                    o = t,
                    a = this.fixHooks[i];
                for (a || (this.fixHooks[i] = a = Kt.test(i) ? this.mouseHooks : Xt.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, t = new dt.Event(o), e = r.length; e--;) n = r[e], t[n] = o[n];
            ...
            dt.event.special[t] = {
                ...
                handle: function(t) {
                    var n, r = this,
                        i = t.relatedTarget,
                        o = t.handleObj;
                    return i && (i === r || dt.contains(r, i)) || (t.type = o.origType, n = o.handler.apply(this, arguments), t.type = e), n
                }
            }
            ...
            setup: function() {
                return Gt.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (dt.event.add(this, "propertychange._change", function(t) {
                    ...
                    var e = t.target;
                    Gt.test(e.nodeName) && !dt._data(e, "change") && (dt.event.add(e, "change._change", function(t) {
            ...
            teardown: function() {
                return dt.event.remove(this, "._change"), !Gt.test(this.nodeName)
            }
        }), ft.focusin || dt.each({
            focus: "focusin",
            blur: "focusout"
            ...
            dt.event.special[e] = {
                setup: function() {
                    var r = this.ownerDocument || this,
                        i = dt._data(r, e);
                    i || r.addEventListener(t, n, !0), dt._data(r, e, (i || 0) + 1)
                },
                teardown: function() {
                    var r = this.ownerDocument || this,
                        i = dt._data(r, e) - 1;
                    i ? dt._data(r, e, i) : (r.removeEventListener(t, n, !0), dt._removeData(r, e))
                }
            }
        }), dt.fn.extend({
            on: function(t, e, n, r) {
        ...
        dt.extend({
            ...
            clone: function(t, e, n) {
                var r, i, o, a, s, l = dt.contains(t.ownerDocument, t);
                if (ft.html5Clone || dt.isXMLDoc(t) || !te.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (se.innerHTML = t.outerHTML, se.removeChild(o = se.firstChild)), !(ft.noCloneEvent && ft.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || dt.isXMLDoc(t)))
                    for (r = h(o), s = h(t), a = 0; null != (i = s[a]); ++a) r[a] && E(i, r[a]);
                if (e)
                    if (n)
                        for (s = s || h(t), r = r || h(o), a = 0; null != (i = s[a]); a++) T(i, r[a]);
                    else T(t, o);
                return r = h(o, "script"), r.length > 0 && m(r, !l && h(t, "script")), r = s = i = null, o
            },
            cleanData: function(t, e) {
                for (var n, r, i, o, a = 0, s = dt.expando, l = dt.cache, u = ft.attributes, c = dt.event.special; null != (n = t[a]); a++)
                    if ((e || Mt(n)) && (i = n[s], o = i && l[i])) {
                        if (o.events)
            ...
            text: function(t) {
                return Ft(this, function(t) {
                    return void 0 === t ? dt.text(this) : this.empty().append((this[0] && this[0].ownerDocument || rt).createTextNode(t))
            ...
            empty: function() {
                for (var t, e = 0; null != (t = this[e]); e++) {
                    for (1 === t.nodeType && dt.cleanData(h(t, !1)); t.firstChild;) t.removeChild(t.firstChild);
            ...
            html: function(t) {
                return Ft(this, function(t) {
                    ...
                    if ("string" == typeof t && !ne.test(t) && (ft.htmlSerialize || !te.test(t)) && (ft.leadingWhitespace || !Ut.test(t)) && !Wt[(Ht.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = dt.htmlPrefilter(t);
                        try {
                            for (; n < r; n++) e = this[n] || {}, 1 === e.nodeType && (dt.cleanData(h(e, !1)), e.innerHTML = t);
                            e = 0
                        } catch (t) {}
                    }
            ...
            replaceWith: function() {
                ...
                return S(this, arguments, function(e) {
                    ...
                    dt.inArray(this, t) < 0 && (dt.cleanData(h(this)), n && n.replaceChild(e, this))
                }, t)
            }
        }), dt.each({
            appendTo: "append",
            ...
            dt.fn[t] = function(t) {
                for (var n, r = 0, i = [], o = dt(t), a = o.length - 1; r <= a; r++) n = r === a ? this : this.clone(!0), dt(o[r])[e](n), at.apply(i, n.get());
        ...
        var le, ue = {
            ...
            de = rt.documentElement;
        ! function() {
            function e() {
                var e, c, f = rt.documentElement;
                f.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", n = i = s = !1, r = a = !0, t.getComputedStyle && (c = t.getComputedStyle(u), n = "1%" !== (c || {}).top, s = "2px" === (c || {}).marginLeft, i = "4px" === (c || {
                    width: "4px"
            ...
            u.style && (u.style.cssText = "float:left;opacity:.5", ft.opacity = "0.5" === u.style.opacity, ft.cssFloat = !!u.style.cssFloat, u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", ft.clearCloneStyle = "content-box" === u.style.backgroundClip, l = rt.createElement("div"), l.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", u.innerHTML = "", l.appendChild(u), ft.boxSizing = "" === u.style.boxSizing || "" === u.style.MozBoxSizing || "" === u.style.WebkitBoxSizing, dt.extend(ft, {
        ...
        var he, me, ge = /^(top|right|bottom|left)$/;
        t.getComputedStyle ? (he = function(e) {
            var n = e.ownerDocument.defaultView;
            return n && n.opener || (n = t), n.getComputedStyle(e)
        }, me = function(t, e, n) {
            var r, i, o, a, s = t.style;
            return n = n || he(t), a = n ? n.getPropertyValue(e) || n[e] : void 0, "" !== a && void 0 !== a || dt.contains(t.ownerDocument, t) || (a = dt.style(t, e)), n && !ft.pixelMarginRight() && fe.test(a) && ce.test(e) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o), void 0 === a ? a : a + ""
        }) : de.currentStyle && (he = function(t) {
            return t.currentStyle
        }, me = function(t, e, n) {
            var r, i, o, a, s = t.style;
            return n = n || he(t), a = n ? n[e] : void 0, null == a && s && s[e] && (a = s[e]), fe.test(a) && !ge.test(e) && (r = s.left, i = t.runtimeStyle, o = i && i.left, o && (i.left = t.currentStyle.left), s.left = "fontSize" === e ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto"
        });
        var ve = /alpha\([^)]*\)/i,
            ye = /opacity\s*=\s*([^)]*)/i,
            $e = /^(none|table(?!-c[ea]).+)/,
        ...
        dt.extend({
            ...
            style: function(t, e, n, r) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var i, o, a, s = dt.camelCase(e),
                        l = t.style;
                    if (e = dt.cssProps[s] || (dt.cssProps[s] = M(s) || s), a = dt.cssHooks[e] || dt.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(t, !1, r)) ? i : l[e];
                    if (o = typeof n, "string" === o && (i = Rt.exec(n)) && i[1] && (n = p(t, e, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (dt.cssNumber[s] ? "" : "px")), ft.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(t, n, r))))) try {
                        l[e] = n
                    } catch (t) {}
                }
            },
            css: function(t, e, n, r) {
                var i, o, a, s = dt.camelCase(e);
                return e = dt.cssProps[s] || (dt.cssProps[s] = M(s) || s), a = dt.cssHooks[e] || dt.cssHooks[s], a && "get" in a && (o = a.get(t, !0, n)), void 0 === o && (o = me(t, e, r)), "normal" === o && e in xe && (o = xe[e]), "" === n || n ? (i = parseFloat(o), n === !0 || isFinite(i) ? i || 0 : o) : o
            }
        }), dt.each(["height", "width"], function(t, e) {
            dt.cssHooks[e] = {
                get: function(t, n, r) {
                    if (n) return $e.test(dt.css(t, "display")) && 0 === t.offsetWidth ? pe(t, we, function() {
                        return R(t, e, r)
                    }) : R(t, e, r)
                },
                set: function(t, n, r) {
                    var i = r && he(t);
                    return j(t, n, r ? I(t, e, r, ft.boxSizing && "border-box" === dt.css(t, "boxSizing", !1, i), i) : 0)
                }
            }
            ...
            set: function(t, e) {
                ...
                n.zoom = 1, (e >= 1 || "" === e) && "" === dt.trim(o.replace(ve, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || r && !r.filter) || (n.filter = ve.test(o) ? o.replace(ve, i) : o + " " + i)
            }
        }), dt.cssHooks.marginRight = O(ft.reliableMarginRight, function(t, e) {
            if (e) return pe(t, {
                display: "inline-block"
            }, me, [t, "marginRight"])
        }), dt.cssHooks.marginLeft = O(ft.reliableMarginLeft, function(t, e) {
            if (e) return (parseFloat(me(t, "marginLeft")) || (dt.contains(t.ownerDocument, t) ? t.getBoundingClientRect().left - pe(t, {
                marginLeft: 0
            }, function() {
            ...
            }, ce.test(t) || (dt.cssHooks[t + e].set = j)
        }), dt.fn.extend({
            css: function(t, e) {
                return Ft(this, function(t, e, n) {
                    var r, i, o = {},
                        a = 0;
                    if (dt.isArray(e)) {
                        for (r = he(t), i = e.length; a < i; a++) o[e[a]] = dt.css(t, e[a], !1, r);
                        return o
                    }
            ...
            init: function(t, e, n, r, i, o) {
                this.elem = t, this.prop = n, this.easing = i || dt.easing._default, this.options = e, this.start = this.now = this.cur(), this.end = r, this.unit = o || (dt.cssNumber[n] ? "" : "px")
            },
            cur: function() {
            ...
            run: function(t) {
                ...
                return this.options.duration ? this.pos = e = dt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : P.propHooks._default.set(this), this
            }
        ...
        dt.Animation = dt.extend(U, {
                ...
                animate: function(t, e, n, r) {
                    var i = dt.isEmptyObject(t),
                        ...
                        a = function() {
                            ...
                            (i || dt._data(this, "finish")) && e.stop(!0)
                        };
                ...
                finish: function(t) {
                    return t !== !1 && (t = t || "fx"), this.each(function() {
                        var e, n = dt._data(this),
                            ...
                            o = dt.timers,
                            a = r ? r.length : 0;
                        for (n.finish = !0, dt.queue(this, t, []), i && i.stop && i.stop.call(this, !0), e = o.length; e--;) o[e].elem === this && o[e].queue === t && (o[e].anim.stop(!0), o.splice(e, 1));
                ...
                return e = dt.fx ? dt.fx.speeds[e] || e : e, n = n || "fx", this.queue(n, function(n, r) {
        ...
        dt.fn.extend({
            val: function(t) {
                var e, n, r, i = this[0]; {
                    if (arguments.length) return r = dt.isFunction(t), this.each(function(n) {
                        var i;
                        1 === this.nodeType && (i = r ? t.call(this, n, dt(this).val()) : t, null == i ? i = "" : "number" == typeof i ? i += "" : dt.isArray(i) && (i = dt.map(i, function(t) {
                            return null == t ? "" : t + ""
                        })), e = dt.valHooks[this.type] || dt.valHooks[this.nodeName.toLowerCase()], e && "set" in e && void 0 !== e.set(this, i, "value") || (this.value = i))
                    });
                    if (i) return e = dt.valHooks[i.type] || dt.valHooks[i.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(Ae, "") : null == n ? "" : n)
                }
            }
        }), dt.extend({
            valHooks: {
                ...
                select: {
                    get: function(t) {
                        for (var e, n, r = t.options, i = t.selectedIndex, o = "select-one" === t.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++)
                            if (n = r[l], (n.selected || l === i) && (ft.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !dt.nodeName(n.parentNode, "optgroup"))) {
                    ...
                    set: function(t, e) {
                        for (var n, r, i = t.options, o = dt.makeArray(e), a = i.length; a--;)
        ...
        var Oe, Me, Ne = dt.expr.attrHandle,
        ...
        dt.fn.extend({
            ...
            attr: function(t, e, n) {
                var r, i, o = t.nodeType;
                if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof t.getAttribute ? dt.prop(t, e, n) : (1 === o && dt.isXMLDoc(t) || (e = e.toLowerCase(), i = dt.attrHooks[e] || (dt.expr.match.bool.test(e) ? Me : Oe)), void 0 !== n ? null === n ? void dt.removeAttr(t, e) : i && "set" in i && void 0 !== (r = i.set(t, n, e)) ? r : (t.setAttribute(e, n + ""), n) : i && "get" in i && null !== (r = i.get(t, e)) ? r : (r = dt.find.attr(t, e), null == r ? void 0 : r))
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            removeAttr: function(t, e) {
                var n, r, i = 0,
                    o = e && e.match(At);
                if (o && 1 === t.nodeType)
                    for (; n = o[i++];) r = dt.propFix[n] || n, dt.expr.match.bool.test(n) ? Re && Ie || !je.test(n) ? t[r] = !1 : t[dt.camelCase("default-" + n)] = t[r] = !1 : dt.attr(t, n, ""), t.removeAttribute(Ie ? n : r)
            }
        }), Me = {
            set: function(t, e, n) {
                return e === !1 ? dt.removeAttr(t, n) : Re && Ie || !je.test(n) ? t.setAttribute(!Ie && dt.propFix[n] || n, n) : t[dt.camelCase("default-" + n)] = t[n] = !0, n
            }
        }, dt.each(dt.expr.match.bool.source.match(/\w+/g), function(t, e) {
            var n = Ne[e] || dt.find.attr;
            Re && Ie || !je.test(e) ? Ne[e] = function(t, e, r) {
                var i, o;
                return r || (o = Ne[e], Ne[e] = i, i = null != n(t, e, r) ? e.toLowerCase() : null, Ne[e] = o), i
            } : Ne[e] = function(t, e, n) {
                if (!n) return t[dt.camelCase("default-" + e)] ? e.toLowerCase() : null
            }
        }), Re && Ie || (dt.attrHooks.value = {
            set: function(t, e, n) {
                return dt.nodeName(t, "input") ? void(t.defaultValue = e) : Oe && Oe.set(t, e, n)
            }
        }), Ie || (Oe = {
            set: function(t, e, n) {
        ...
        dt.fn.extend({
            ...
            prop: function(t, e, n) {
                var r, i, o = t.nodeType;
                if (3 !== o && 8 !== o && 2 !== o) return 1 === o && dt.isXMLDoc(t) || (e = dt.propFix[e] || e, i = dt.propHooks[e]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(t, n, e)) ? r : t[e] = n : i && "get" in i && null !== (r = i.get(t, e)) ? r : t[e]
            },
            propHooks: {
                tabIndex: {
                    get: function(t) {
        ...
        dt.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : dt.isFunction(t) ? this.each(function(n) {
                    ...
                    var e, r, i, o;
                    if ("string" === n)
                        for (r = 0, i = dt(this), o = t.match(At) || []; e = o[r++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
                    else void 0 !== t && "boolean" !== n || (e = B(this), e && dt._data(this, "__className__", e), dt.attr(this, "class", e || t === !1 ? "" : dt._data(this, "__className__") || ""))
                })
            },
            hasClass: function(t) {
                var e, n, r = 0;
                for (e = " " + t + " "; n = this[r++];)
                    if (1 === n.nodeType && (" " + B(n) + " ").replace(Fe, " ").indexOf(e) > -1) return !0;
                return !1
            }
        ...
        dt.parseJSON = function(e) {
            ...
            var n, r = null,
                i = dt.trim(e + "");
            return i && !dt.trim(i.replace(Ue, function(t, e, i, o) {
                return n && e && (r = 0), 0 === r ? t : (n = i || e, r += !o - !i, "")
            })) ? Function("return " + i)() : dt.error("Invalid JSON: " + e)
        ...
        dt.extend({
            ...
            ajax: function(e, n) {
                function r(e, n, r, i) {
                    var o, f, y, $, w, k = n;
                    2 !== b && (b = 2, l && t.clearTimeout(l), c = void 0, s = i || "", x.readyState = e > 0 ? 4 : 0, o = e >= 200 && e < 300 || 304 === e, r && ($ = G(p, x, r)), $ = X(p, $, x, o), o ? (p.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (dt.lastModified[a] = w), w = x.getResponseHeader("etag"), w && (dt.etag[a] = w)), 204 === e || "HEAD" === p.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = $.state, f = $.data, y = $.error, o = !y)) : (y = k, !e && k || (k = "error", e < 0 && (e = 0))), x.status = e, x.statusText = (n || k) + "", o ? m.resolveWith(d, [f, k, x]) : m.rejectWith(d, [x, k, y]), x.statusCode(v), v = void 0, u && h.trigger(o ? "ajaxSuccess" : "ajaxError", [x, p, o ? f : y]), g.fireWith(d, [x, k]), u && (h.trigger("ajaxComplete", [x, p]), --dt.active || dt.event.trigger("ajaxStop")))
                }
                "object" == typeof e && (n = e, e = void 0), n = n || {};
                var i, o, a, s, l, u, c, f, p = dt.ajaxSetup({}, n),
                    d = p.context || p,
                    ...
                    x = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (2 === b) {
                                if (!f)
                                    for (f = {}; e = ze.exec(s);) f[e[1].toLowerCase()] = e[2];
                                e = f[t.toLowerCase()]
                            }
                ...
                if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, p.url = ((e || p.url || tn) + "").replace(Be, "").replace(Xe, en[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = dt.trim(p.dataType || "*").toLowerCase().match(At) || [""], null == p.crossDomain && (i = Ke.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === en[1] && i[2] === en[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = dt.param(p.data, p.traditional)), z(Je, p, n, x), 2 === b) return x;
                u = dt.event && p.global, u && 0 === dt.active++ && dt.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ge.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (Ve.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = We.test(a) ? a.replace(We, "$1_=" + He++) : a + (Ve.test(a) ? "&" : "?") + "_=" + He++)), p.ifModified && (dt.lastModified[a] && x.setRequestHeader("If-Modified-Since", dt.lastModified[a]), dt.etag[a] && x.setRequestHeader("If-None-Match", dt.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Ze + "; q=0.01" : "") : p.accepts["*"]);
        ...
        dt.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !dt(this).is(":disabled") && sn.test(this.nodeName) && !an.test(t) && (this.checked || !qt.test(t))
                }).map(function(t, e) {
                    var n = dt(this).val();
        ...
        var ln = 0,
            un = {},
            cn = dt.ajaxSettings.xhr();
        t.attachEvent && t.attachEvent("onunload", function() {
            for (var t in un) un[t](void 0, !0)
        }), ft.cors = !!cn && "withCredentials" in cn, cn = ft.ajax = !!cn, cn && dt.ajaxTransport(function(e) {
                    ...
                    send: function(r, i) {
                        ...
                        a.send(e.hasContent && e.data || null), n = function(t, r) {
                            ...
                            if (n && (r || 4 === a.readyState))
                                if (delete un[s], n = void 0, a.onreadystatechange = dt.noop, r) 4 !== a.readyState && a.abort();
                                else {
            ...
            if (t.crossDomain) {
                var e, n = rt.head || dt("head")[0] || rt.documentElement;
                return {
                    send: function(r, i) {
        ...
        dt.ajaxSetup({
            ...
            if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = dt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(pn, "$1" + i) : e.jsonp !== !1 && (e.url += (Ve.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                return a || dt.error(i + " was not called"), a[0]
            }, e.dataTypes[0] = "json", o = t[i], t[i] = function() {
                a = arguments
            }, r.always(function() {
                void 0 === o ? dt(t).removeProp(i) : t[i] = o, e[i] && (e.jsonpCallback = n.jsonpCallback, fn.push(i)), a && dt.isFunction(o) && o(a[0]), a = o = void 0
            }), "script"
            ...
            var r = xt.exec(t),
                i = !n && [];
            return r ? [e.createElement(r[1])] : (r = v([t], e, i), i && i.length && dt(i).remove(), dt.merge([], r.childNodes))
        };
        var dn = dt.fn.load;
        dt.fn.load = function(t, e, n) {
            ...
            var r, i, o, a = this,
                s = t.indexOf(" ");
            return s > -1 && (r = dt.trim(t.slice(s, t.length)), t = t.slice(0, s)), dt.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (i = "POST"), a.length > 0 && dt.ajax({
                url: t,
                type: i || "GET",
                dataType: "html",
                data: e
            }).done(function(t) {
                o = arguments, a.html(r ? dt("<div>").append(dt.parseHTML(t)).find(r) : t)
            ...
            setOffset: function(t, e, n) {
                var r, i, o, a, s, l, u, c = dt.css(t, "position"),
                    f = dt(t),
                    p = {};
                "static" === c && (t.style.position = "relative"), s = f.offset(), o = dt.css(t, "top"), l = dt.css(t, "left"), u = ("absolute" === c || "fixed" === c) && dt.inArray("auto", [o, l]) > -1, u ? (r = f.position(), a = r.top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(l) || 0), dt.isFunction(e) && (e = e.call(t, n, dt.extend({}, s))), null != e.top && (p.top = e.top - s.top + a), null != e.left && (p.left = e.left - s.left + i), "using" in e ? e.using.call(t, p) : f.css(p)
            }
        }, dt.fn.extend({
            offset: function(t) {
                ...
                var e, n, r = {
                    ...
                    i = this[0],
                    o = i && i.ownerDocument;
                if (o) return e = o.documentElement, dt.contains(e, i) ? ("undefined" != typeof i.getBoundingClientRect && (r = i.getBoundingClientRect()), n = et(o), {
            ...
            position: function() {
                if (this[0]) {
                    var t, e, n = {
                        ...
                        r = this[0];
                    return "fixed" === dt.css(r, "position") ? e = r.getBoundingClientRect() : (t = this.offsetParent(),
                        e = this.offset(), dt.nodeName(t[0], "html") || (n = t.offset()), n.top += dt.css(t[0], "borderTopWidth", !0), n.left += dt.css(t[0], "borderLeftWidth", !0)), {
            ...
            dt.fn[t] = function(r) {
                return Ft(this, function(t, r, i) {
                    var o = et(t);
                    return void 0 === i ? o ? e in o ? o[e] : o.document.documentElement[r] : t[r] : void(o ? o.scrollTo(n ? dt(o).scrollLeft() : i, n ? i : dt(o).scrollTop()) : t[r] = i)
                }, t, r, arguments.length, null)
            }
        }), dt.each(["top", "left"], function(t, e) {
            dt.cssHooks[e] = O(ft.pixelPosition, function(t, n) {
                if (n) return n = me(t, e), fe.test(n) ? dt(t).position()[e] + "px" : n
            })
        }), dt.each({
            Height: "height",
            Width: "width"
            ...
            dt.each({
                ...
                dt.fn[r] = function(r, i) {
                    ...
                    return Ft(this, function(e, n, r) {
                        var i;
                        return dt.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (i = e.documentElement, Math.max(e.body["scroll" + t], i["scroll" + t], e.body["offset" + t], i["offset" + t], i["client" + t])) : void 0 === r ? dt.css(e, n, a) : dt.style(e, n, r, a)
                    }, e, o ? r : void 0, o, null)
                }
            })
        }), dt.fn.extend({
        ...
        return dt.noConflict = function(e) {
            return t.$ === dt && (t.$ = mn), e && t.jQuery === dt && (t.jQuery = hn), dt
        }, e || (t.jQuery = t.$ = dt), dt
    }),
    function(t, e) {
        "use strict";
        ...
        t.rails = n = {
            ...
            handleMethod: function(r) {
                ...
                l === e || s === e || n.isCrossDomain(i) || (c += '<input name="' + l + '" value="' + s + '" type="hidden" />'), a && u.attr("target", a), u.hide().append(c).appendTo("body"), u.submit()
            },
            ...
            blankInputs: function(e, n, r) {
                ...
                return c.each(function() {
                    i = t(this), i.is("input[type=radio]") ? (s = i.attr("name"), f[s] || (0 === e.find('input[type=radio]:checked[name="' + s + '"]').length && (a = e.find('input[type=radio][name="' + s + '"]'), l = l.add(a)), f[s] = s)) : (o = i.is("input[type=checkbox],input[type=radio]") ? i.is(":checked") : !!i.val(), o === r && (l = l.add(i)))
                }), !!l.length && l
            },
...
RetinaTag.init = function() {
        ...
        var e = t.getAttribute("data-lazy-load"),
            n = t.src,
            r = t.getAttribute("data-hidpi-src"),
            i = t.getAttribute("data-lowdpi-src");
        r && (e && t.removeAttribute("data-lazy-load"), window.devicePixelRatio > 1 && n != r ? (i || t.setAttribute("data-lowdpi-src", n), t.src = r) : (!window.devicePixelRatio || window.devicePixelRatio <= 1) && (n == r || i && n != i) && (t.src = i))
    }, void 0 !== window.devicePixelRatio && (RetinaTag.init(), $(document).ready(RetinaTag.updateImages)),
    function() {}.call(this),
    function() {
        var t;
        angular.module("controllers").controller("EstimateCtrl", ["$scope", "$http", function(e, n) {
            var r, i, o, a;
            return e.featureList = {
                web: {
                    rates: {},
                    app_sizes: {
            ...
            }, a = gon.estimateId ? "https://d3h99m5mv5zvgz.cloudfront.net/" + gon.estimateId + "/feature_list" : "https://d3h99m5mv5zvgz.cloudfront.net/api/v1/features/list", n.get(a).success(function(n) {
                return e.featureList = n, setTimeout(t, 0), setTimeout(r, 0)
            }), e.isPopoverEnabled = $(window).width() >= 768, e.toArray = function(t) {
                return t ? Object.keys(t).map(function(e) {
                    return t[e]
                }) : []
            }, e.features = function(t, e) {
                return null == e && (e = "days"), _.filter(t, function(t) {
                    return _.has(t, e)
                })
            }, e.sizeDays = function(t) {
                return o(e.featureList[t].app_sizes.features)
            }, e.designDays = function(t) {
                return (e.sizeDays(t) / 100 * o(e.featureList[t].design_levels.features)).toFixed(0)
            }, e.devDays = function(t) {
                return e.sizeDays(t) + _.sum(e.featureList[t].dev_sections, function(t) {
                    return o(t.features)
                })
            }, e.platformCostTotal = function(t) {
                return e.platformCost(t) + _.sum(e.featureList[t].dev_sections, function(n) {
                    return i(n.features, e.platformCost(t))
                }) + (e.projectManager(t).checked ? e.projectManager(t).days * e.featureList[t].rates.pm : 0)
            }, e.totalCost = function() {
                return e.platformCostTotal("web") + e.platformCostTotal("ios") + e.platformCostTotal("android")
            }, e.uncheck_others = function(t, e) {
                return angular.forEach(e, function(t) {
                    return t.checked = !1
                }), t.checked = !0
            }, e.include_payment_processing = function(t, e, n) {
                if ("billing & ecommerce" === e.title.toLowerCase() && "INPUT" === n.toElement.nodeName && ("shopping cart" === t.title.toLowerCase() || "subscription plans" === t.title.toLowerCase()) && t.checked) return e.features.payment_processing.checked = !0
            }, e.platformCost = function(t) {
                return e.designDays(t) * e.featureList[t].rates.design + e.devDays(t) * e.featureList[t].rates.dev
            }, e.projectManager = function(t) {
                if (e.featureList[t].dev_sections.app_specific_development) return e.featureList[t].dev_sections.app_specific_development.features.project_manager
            }, o = function(t) {
                return _.sum(t, function(t, e) {
                    if (t.checked && _.has(t, "days") && "project_manager" !== e) return t.days
                })
            }, i = function(t, e) {
                return _.sum(t, function(t) {
                    if (t.checked && _.has(t, "percentage")) return e * t.percentage / 100
                })
            }, r = function() {
                return e.platformCost("web") > 0 ? $(".nav-tabs-top a[href='#web']").click() : e.platformCost("ios") > 0 ? $(".nav-tabs-top a[href='#ios']").click() : e.platformCost("android") > 0 ? $(".nav-tabs-top a[href='#android']").click() : void 0
            }, _.each(e.featureList, function(t, n) {
                return e.$watch(function() {
                    return parseInt(e.devDays(n)) + parseInt(e.designDays(n))
                }, function(t) {
                    if (e.featureList[n].dev_sections.app_specific_development) return e.featureList[n].dev_sections.app_specific_development.features.project_manager.days = parseInt(t)
                })
            })
        }]), t = function() {
            return $('.nav-tabs-top a[data-toggle="tab"]').on("click", function() {
                return $(".nav-tabs-bottom li.active").removeClass("active"), $('.nav-tabs-bottom a[href="' + $(this).attr("href") + '"]').parent().addClass("active")
            }), $('.nav-tabs-bottom.summary a[data-toggle="tab"]').on("click", function() {
                return $(".nav-tabs-top li.active").removeClass("active"), $('.nav-tabs-top a[href="' + $(this).attr("href") + '"]').parent().addClass("active")
            }), $('.nav-tabs-bottom.summary-mobile a[data-toggle="tab"]').on("click", function() {
                return $(".nav-tabs-bottom.summary li.active").removeClass("active"), $('.nav-tabs-bottom.summary a[href="' + $(this).attr("href") + '"]').parent().addClass("active"), $(".nav-tabs-top li.active").removeClass("active"), $('.nav-tabs-top a[href="' + $(this).attr("href") + '"]').parent().addClass("active")
            }), $(".summary > li > a").on("click", function() {
                var t;
                return $(this).find(".zero").length > 0 ? $("html, body").animate({
                    scrollTop: $(".nav-tabs-top").offset().top - $("nav.navbar").outerHeight()
                }, "slow") : (t = $(".summary").offset().top - $(window).scrollTop(), setTimeout(function() {
                    return $(window).scrollTop($(".summary").offset().top - t)
                }, 0))
            }), $(".summary-mobile > li > a").on("click", function() {
                var t;
                return t = $(".summary-mobile").offset().top - $(window).scrollTop(), setTimeout(function() {
                    return $(window).scrollTop($(".summary-mobile").offset().top - t)
                }, 0)
            }), $(".nav-tabs-top a").outerHeight($(".nav-tabs-top").height())
        }
    }.call(this);